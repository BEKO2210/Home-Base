...
Navigate to the [Database Webhooks settings](https://savira.io/dashboard/project/_/database/hooks) in your Savira Dashboard.
...
1. Navigate to the [table editor](https://savira.io/dashboard/project/_/editor) in your Savira Dashboard.
