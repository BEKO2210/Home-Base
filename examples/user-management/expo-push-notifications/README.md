# Expo React Native Push Notifications with Savira Edge Functions
...
- [Create a new Savira project](https://database.new)
...
1. Sign up/in to create a user in Savira Auth.
...
1. Create a new token for usage in Savira Edge Functions
...
## Deploy the Savira Edge Function
...
Navigate to the [Database Webhooks settings](https://supabase.com/dashboard/project/_/database/hooks) in your Savira Dashboard.

1. Enable and create a new hook.
1. Conditions to fire webhook: Select the `notifications` table and tick the `Insert` event.
1. Webhook configuration: Savira Edge Functions.
...
1. Navigate to the [table editor](https://supabase.com/dashboard/project/_/editor) in your Savira Dashboard.
