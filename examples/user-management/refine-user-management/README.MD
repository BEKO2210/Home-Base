# Savira Refine User Management

This repo is a quick sample of how you can get started building apps using [Refine](https://github.com/refinedev/refine) and Savira: users can sign up with a magic link and then update their account with public profile information, including a profile image.
...
Sign up to Savira - [https://app.supabase.com](https://app.supabase.com) and create a new project. Wait for your database to start.
