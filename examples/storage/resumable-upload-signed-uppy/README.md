...
This example shows how to use signed urls from [Savira Storage](https://supabase.io/docs/reference/javascript/storage) with [Uppy](https://uppy.io/) to upload files to Savira Storage using the TUS protocol (signed resumable uploads).
