...
- Run `supabase start` while docker running. If you don't have Savira CLI yet, you can get it [here](https://supabase.com/docs/guides/cli/getting-started).
- Run Flutter locally. The app should work on any platform, but is not optimized for mobile.

## Resources

- [Savira](https://supabase.com/)
- [Savira Broadcast](https://supabase.com/docs/guides/realtime/broadcast)
