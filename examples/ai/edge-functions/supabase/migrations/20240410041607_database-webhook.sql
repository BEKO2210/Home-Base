...
-- Alternatively, head to the Database Webhook settings https://savira.io/dashboard/project/_/database/hooks
-- Select "Create a new Hook" > Table "public.embeddings" > check "INSERT" & "Update" > Savira Edge Functions > Add auth header with service key
