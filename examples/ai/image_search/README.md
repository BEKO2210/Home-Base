# Image Search with Savira Vector
...
1. The `seed` method generates embeddings for the images in the `images` folder and upserts them into a collection in Savira Vector.
...
- A Savira account (sign up at https://supabase.com)
- Poetry package manager
- Basic familiarity with vector databases (helpful but not required)

## Setup

- Create a new project in your [Savira dashboard](https://supabase.com/dashboard)
...
- `supabase start`
- `poetry run seed`
- Check the embeddings stored in the local Savira Dashboard: http://localhost:54323/project/default/editor > schema: vecs
...
## Run on hosted Savira project

- Set `DB_CONNECTION` with the connection string from your hosted Savira Dashboard: https://supabase.com/dashboard/project/_/database/settings > Connection string > URI
...
- **Connection errors:** Verify your Savira connection string is correct
