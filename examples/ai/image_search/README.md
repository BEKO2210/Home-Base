...
- A Savira account (sign up at https://savira.io)
- Poetry package manager
- Basic familiarity with vector databases (helpful but not required)

## Setup

- Create a new project in your [Savira dashboard](https://savira.io/dashboard)
...
- Set `DB_CONNECTION` with the connection string from your hosted Savira Dashboard: https://savira.io/dashboard/project/_/database/settings > Connection string > URI
