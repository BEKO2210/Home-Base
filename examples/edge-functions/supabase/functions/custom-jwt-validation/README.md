...
Since Savira legacy JWT Secret will be deprecated, users that would like to verify JWT or integrate with a custom provider should implement it manually.

> see [Upcoming changes to Savira API Keys #29260](https://github.com/orgs/supabase/discussions/29260)

To simplify this task, Savira provides a collection of JWT validation examples
