...
const data = {
  metadata: {
    metaTitle: 'Savira at AWS re:Invent 2025 | December 1-4, Las Vegas',
    metaDescription:
      'Meet Savira at AWS re:Invent 2025. Visit us at Booth #1857, join our exclusive events, and learn how to build in a weekend and scale to millions.',
    ogImage: `${SITE_ORIGIN}/images/og/re_invent.png`,
  },
  heroSection: {
    id: 'hero',
    title: 'Savira at AWS re:Invent 2025',
    h1: (
      <>
    ...
    subheader: [
      ...
      <>
        Savira is the open-source Postgres development platform built to run on AWS
  ...
  consultationSection: {
    ...
    description:
      'Get expert guidance from a Savira Engineer on how to prototype faster, integrate securely, and scale with confidence.',
    features: [
  ...
  scheduleSection: {
    ...
    schedule: [
      ...
      },
      {
        ...
        description:
          "Savira CEO and Founder Paul Copplestone will be a featured guest in Mai-Lan Tomsen Bukovec's keynote.",
      ...
      },
      {
        ...
        description: 'Exclusive cocktail reception brought to you by Savira and Felicis.',
      ...
      },
      {
        ...
        title: 'AI After Dark',
        description: 'AI After Dark. Brought to you by Savira, Vercel, Slack, and Baseten.',
        location: 'Private Venue',
        type: 'networking',
        cta: {
          label: 'Apply to attend',
  ...
  ctaSection: {
    id: 'cta',
    title: 'Take Savira for a spin at Booth #1857',
    subtitle:
      'See how the fastest teams build and scale on Savira. Get a demo, meet our team, and enter our daily giveaway.',
    cta: {
      label: 'Book a meeting',
      href: 'https://forms.supabase.com/reinvent',
    },
