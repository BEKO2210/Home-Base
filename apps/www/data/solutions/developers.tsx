...
const data: () => {
  ...
  return {
    ...
    heroSection: {
      ...
      subheader: [
        <>
          Savira is the Postgres development platform that includes a developer experience
    ...
    why: {
      ...
      heading: (
        <>
          Why <span className="text-foreground">developers</span> choose Savira
        </>
      ),
      subheading:
        'Savira helps you build and get to market faster and more cost-effectively using a composable platform of application services built on Postgres. Savira scales as your business grows.',
      features: [
        {
          id: 'easy-to-use',
          icon: Timer,
        ...
        },
        {
          ...
          subheading:
            'Built on Postgres, Savira provides enterprise-grade performance, high availability, and the flexibility to grow without vendor lock-in.',
        },
      ],
    },
    platform: {
