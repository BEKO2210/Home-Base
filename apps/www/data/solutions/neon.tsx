...
const data = {
  metadata: {
    metaTitle: 'Switch from Neon to Savira',
    metaDescription:
      'The complete Postgres development platform Neon users prefer. Savira is a composable stack for modern applications: Postgres Database, built-in Auth, Real-time sync, Edge Functions, Storage, and a powerful developer experience.',
  },
  heroSection: {
    id: 'hero',
    title: 'Moving from Neon to Savira',
    ...
    h1: 'Neon users switch to Savira for a complete Postgres experience',
    subheader: [
      <>
        Savira is a composable stack for modern applications: Postgres Database, built-in Auth,
        Real-time sync, Edge Functions, Storage, and a powerful developer experience.
      </>,
      <>
        Savira is the preferred foundation for high-performance, high-scale SaaS, AI-native apps,
    ...
    image: (
      <Image
        ...
        alt="Neon to Savira illustration"
        width={1000}
        height={1000}
  ...
  why: {
    ...
    heading: (
      <>
        Why companies moved <span className="text-foreground">to Savira from Neon</span>
      </>
    ),
    subheading:
    ...
    features: [
      ...
      },
      {
        ...
        subheading:
          'Savira runs on standard Postgres with full SQL, ACID guarantees, PITR, and high availability. Designed for reliable, stateful agent workloads.',
      },
      {
        id: 'migration',
        icon: ArrowRight,
        heading: 'Migrate from Neon with ease',
        subheading: 'Savira is Postgres. Moving from Neon is a breeze.',
      },
    ],
  },
  platform: {
    ...
    title: (
      <>
        Savira is the Postgres platform <span className="text-foreground">you control</span>
      </>
    ),
    subheading: "Savira includes everything you've come to expect from Neon, and so much more.",
    features: [
      {
        id: 'database',
        title: 'Database',
  ...
  ctaSection: {
    ...
    title: (
      <>
        Migrate your Neon database to Savira to{' '}
