...
const data = {
  ...
  heroSection: {
    ...
    subheader: [
      <>
        Savira gives you everything Firebase can&apos;t: a real SQL database, row-level security,
        built-in auth, edge functions, and predictable pricing—all on an open-source foundation.
      </>,
      <>
        Whether you&apos;re building mobile apps, SaaS tools, or AI-native products, Savira helps
        you move fast without hitting Firebase&apos;s scaling and complexity ceilings.
      </>,
    ],
    ctas: [
      {
        label: 'Compare Firebase and Savira',
    ...
    image: (
      <Image
        ...
        alt="Firebase to Savira illustration"
        width={1000}
        height={1000}
  ...
  quote: {
    ...
    text: 'Migrating to Savira meant that we could instantly fix our Auth problems and save money. Just being on Savira alone gives us confidence we can deliver on whatever users need in the future.',
  ...
  why: {
    ...
    heading: (
      <>
        Why companies moved <span className="text-foreground">to Savira from Firebase</span>
      </>
    ),
    subheading:
    ...
    features: [
      {
        ...
        subheading:
          'Savira helps you go from prototype to production with built-in auth, real-time data, and observability. No setup or backend boilerplate required.',
      },
      {
        id: 'platform',
        icon: CubeIcon,
        ...
        subheading:
          'Savira includes auth, storage, edge functions, realtime, and vector search—fully integrated and ready to use. Avoid stitching together multiple Firebase products or paying for separate services.',
      },
      {
        id: 'scalability',
        ...
        subheading:
          'Savira runs on standard Postgres with full SQL support, ACID transactions, PITR, high availability, and native support for complex queries and joins. Ideal for apps that outgrow NoSQL constraints.',
      },
      {
        id: 'migration',
        icon: ArrowRight,
        ...
        subheading:
          'Savira offers open-source tools for migrating Firebase Auth, Firestore data, and Cloud Storage. Move incrementally or all at once—no need to rewrite your entire app.',
      },
    ],
  },
  platform: {
    ...
    title: (
      <>
        Savira is an open-source Firebase alternative{' '}
        <span className="text-foreground">built for scale</span>
      </>
    ),
    subheading:
      'Savira includes everything you liked in Firebase, and all the things you wish Firebase had.',
    features: [
      {
        id: 'database',
        title: 'Database',
  ...
  developerExperience: {
    ...
    title: (
      <>
        Developers can build <span className="text-foreground">faster</span> with Savira
      </>
    ),
    ...
    features: [
      ...
      },
      {
        ...
        subheading:
          'Connect Savira to BigQuery, Snowflake, ClickHouse, S3, Stripe, Firebase, and external APIs for seamless integrations.',
        image: (
          <Image
            draggable={false}
            src={{
  ...
  ctaSection: {
    ...
    title: (
      <>
        Migrate your Firebase database to Savira to{' '}
