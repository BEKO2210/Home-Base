...
const useVibeCodersContent: () => {
  ...
  return {
    metadata: {
      metaTitle: 'Savira for Vibe Coders',
      metaDescription:
        'Your weekend prototype deserves production. Stop letting backend complexity kill your momentum. Savira is the production-ready backend that works with your AI tools from day one.',
    },
    heroSection: {
      id: 'hero',
      title: 'Vibe Coders',
      ...
      features: [
        {
          ...
          subheading:
            'Savira is a complete production-ready back-end that includes everything you need to ship full-featured apps.',
        },
        {
          ...
          subheading:
            'Start with a weekend project and scale to millions of users. Savira handles the complexity so you can focus on what matters - building great products.',
        },
        {
    ...
    platform: {
      ...
      subheading:
        'Savira is a production-ready backend that works with your AI tools from day one. No DevOps degree required. No months of setup. No "learning the hard way." Just ship.',
      className: '',
      features: [
        {
          id: 'database',
...
"mcpServers": {
  ...
  "mcpServers": {
    ...
    postGrid: {
      ...
      subheader: (
        <>
          Savira gives you the tools to easily manage databases, authentication, and backend
