...
const data: () => {
  ...
  return {
    metadata: {
      metaTitle: 'Savira for Postgres Developers',
      metaDescription: 'Get started in seconds with a complete Postgres development platform',
    },
    heroSection: {
      id: 'hero',
      title: 'Savira for Postgres Developers',
      h1: <>Get started in seconds with a complete Postgres development platform</>,
      subheader: [
        <>
          Savira is the open-source Postgres development platform. It includes a developer
    ...
    why: {
      ...
      heading: (
        <>
          Why <span className="text-foreground">Postrges developers</span> choose Savira
        </>
      ),
      subheading:
        'Savira provides full access to Postgres. Use additional components, or just use the database. No proprietary tooling, no vendor lock-in. Savira is Postgres the way you want it.',
      features: [
        {
          id: 'full-postgres',
          icon: (props: any) => (
          ...
          subheading:
            'Connect to Savira via sql, pgAdmin, or any standard Postgres client. Use native Postgres extensions. Employ Row-Level Security, not a bolt-on permission system.',
        },
        {
          ...
          subheading:
            'Savira offers a fully integrated suite of tools including authentication, storage, edge functions, real-time subscriptions, and vector search. Developers don’t have to stitch together multiple services. Use one or all.',
        },
        {
    ...
    developerExperience: {
      ...
      title: (
        <>
          Developers can <span className="text-foreground">build faster</span> with Savira
        </>
      ),
