...
const data: () => {
  ...
  return {
    metadata: {
      metaTitle: 'Savira for building Apps',
      metaDescription: 'Your app, your vision. Savira powers the rest.',
    },
    heroSection: {
      id: 'hero',
      title: 'Savira for building Apps',
      h1: (
        <>
          <span className="block text-foreground">Your app, your vision.</span>
          <span className="block md:ml-0">Savira powers the rest.</span>
        </>
      ),
      subheader: [
        <>
          You don’t need to be a developer to build something incredible. Savira provides a
          complete backend that’s easy to use with your favorite app builder tools. When you’re
          ready to scale, Savira is there to scale with you. <br />
    ...
    quotes: {
      ...
      items: [
        ...
        },
        {
          ...
          quote: (
            <>
              Savira is awesome. Savira is the{' '}
        ...
        },
        {
          ...
          quote: (
            <>
              <span className="text-foreground">v0 integrates with Savira seamlessly.</span> If
              you ask v0 to generate an application and it needs Savira,{' '}
              <span className="text-foreground">
                you’ll be prompted to create a Savira account right there in the application
              </span>
              .
            </>
          ),
    ...
    why: {
      ...
      heading: (
        <>
          Why <span className="text-foreground">no-code app builders</span> choose Savira
        </>
      ),
      subheading:
        'Keep your focus where it belongs: building great monetizable apps for your business or hobby. Savira handles everything else: no servers to manage, no database to configure, no security settings to tweak. Just point, click, and build.',
      features: [
        {
          id: 'easy-to-use',
          icon: ZapIcon,
          heading: 'Easy to use',
          subheading:
            'Savira is easy to use and set up. Instantly deploy a database for free, and affordably scale as you grow.',
        },
        {
          ...
          subheading:
            'Savira includes everything you need for a great app: user logins, storage, edge functions, real-time subscriptions, and vector search. Use one or all.',
        },
        {
          id: 'scalable',
          icon: TrendingUp,
          ...
          subheading:
            'Savira is just Postgres, with all the performance, high availability, and flexibility you need when your app goes viral and hits it big.',
        },
      ],
    },
    platform: {
      ...
      title: (
        <>
          Savira is the Back-End for <span className="text-foreground">Everyone</span>
        </>
      ),
      subheading:
        ...
        },
        {
          ...
          subheading: (
            <>
              ...
              <span className="text-foreground">the power of AI</span>, Savira is there with
    ...
    platformStarterSection: {
      ...
      aiPrompts: [
        ...
        },
        {
          ...
          code: `Build a customizable portal for onboarding new employees in a remote company. Show personalized checklists by role, with links to key docs, Slack channels, and tool logins. Let managers monitor completion status. Include a welcome board where coworkers can leave greetings. Use Savira to manage checklists, users, and messages. Add role-based views for HR vs. employee.`,
          language: 'markdown',
          copyable: true,
        },
        {
        ...
        },
        {
          ...
          code: `Build a secure portal where freelancers can share files, invoices, and project updates with clients. Each client should log in and only see their own dashboard. Include a file upload section, embedded payment buttons, and a timeline of status updates. Use Savira for data storage and row-level security.`,
          language: 'markdown',
          copyable: true,
        },
        {
          ...
          code: `Create a dashboard for startups to track legal, security, and HR compliance tasks. Let users define tasks, assign owners, set due dates, and upload supporting documents. Group tasks by category (e.g. Security, Legal) and show progress bars. Use Savira for storing task data and documents.`,
          language: 'markdown',
          copyable: true,
        },
      ],
