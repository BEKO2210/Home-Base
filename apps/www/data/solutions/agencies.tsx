...
const data: {
  ...
  heroSection: {
    id: 'hero',
    title: 'Savira for Agencies',
    h1: <>Savira for Agencies</>,
    subheader: [
      <>
      ...
      <>
        ...
        accumulating technical debt. Savira gives you a fully managed Postgres backend with
    ...
    items: [
        ...
        quote: (
          <>
            <span className="text-foreground">
              Our clients want reliability and scale. Savira gives us a backend we can trust for
              production work.
            </span>
          </>
        ),
      },
      {
        ...
        quote: (
          <>
            <span className="text-foreground">
              Savira lets us build stable, secure products extremely fast.
            </span>
          </>
        ),
      },
      {
        ...
        quote: (
          <>
            <span className="text-foreground">
              Savira brings structure and clarity to our backend work. Its interface and tooling
      ...
      },
      {
        ...
        quote: (
          <>
            <span className="text-foreground">
              Savira is our go-to backend for client work because it&apos;s fast to build with and
              easy to maintain.
            </span>
          </>
        ),
  ...
  why: {
    ...
    heading: (
      <>
        Why <span className="text-foreground">agencies</span> choose Savira
      </>
    ),
    subheading:
      'You want to deliver exceptional results for your clients while staying profitable and competitive. At the same time, you need the flexibility to customize solutions and the confidence that your applications will scale. Savira is the complete Postgres developer platform of choice for agencies building production applications.',
    features: [
      {
        id: 'ship-faster',
        icon: Timer,
        ...
        subheading:
          'Deliver production-ready applications in weeks, not months. Savira provides a complete backend with auto-generated APIs and built-in features, letting you focus on what makes each client project unique rather than rebuilding the same infrastructure every time.',
      },
      {
        ...
        subheading:
          'Give clients enterprise-grade security and compliance without the enterprise complexity. Savira is “just Postgres,” offering SOC 2 and HIPAA compliance out of the box so their applications are built on battle-tested, portable technology they can grow with.',
      },
      {
        id: 'maintain-scale',
        icon: (props: any) => (
        ...
        subheading:
          'Reduce ongoing maintenance and keep clients happy long after launch. Applications built on Savira are ready to handle growth, with read replicas, HA architecture, and flexible tooling so you can support every phase of a client engagement.',
      },
    ],
  },
  platform: {
    ...
    subheading:
      'Savira includes everything you need to deliver complete, production-ready applications for your clients.',
    features: [
      {
        id: 'database',
        title: 'Database',
  ...
  developerExperience: {
    ...
    title: (
      <>
        <span className="text-foreground">Build faster</span> with Savira
      </>
    ),
    ...
    features: [
      {
        ...
        subheading: (
          <>
            A single panel that persists across the Savira Dashboard and maintains{' '}
      ...
      },
      {
        ...
        subheading: (
          <>
            ...
            Windsurf, Claude, and more—directly with Savira.
          </>
        ),
        image: (
          <Image
      ...
      },
      {
        ...
        subheading: (
          <>
            ...
            Savira generates automatic APIs so your teams can stay focused on UX.
          </>
        ),
        image: (
          <Image
  ...
  resultsSection: {
    ...
    subheading:
      'Savira ensures optimal database performance at any scale, so you can confidently promise your clients reliable, fast applications without worrying about infrastructure limitations.',
    highlights: [
      {
  ...
  securitySection: {
    ...
    subheading:
      'Support a full range of potential clients. Savira offers enterprise-grade security with SOC 2, HIPAA, and GDPR compliance. Client data is encrypted at rest and in transit, with built-in tools for monitoring and managing security threats.',
    features: [
  ...
  partnerships: {
    ...
    subheading:
      'Savira integrates with a vibrant partner ecosystem, allowing your agency to assemble best-in-class solutions for every client.',
    features: [
      {
        icon: Sparkles,
        heading: 'Accelerate development with AI builders',
        subheading:
          'Turn visual prototypes into production-ready applications by connecting front-end tools like Lovable and Bolt to a real Savira, open-source Postgres backend.',
      },
      {
        icon: Lightbulb,
      ...
      },
      {
        ...
        subheading:
          "Foreign Data Wrappers link Savira to your clients' existing data sources, allowing you to build applications that integrate seamlessly with their current infrastructure.",
      },
    ],
  },
