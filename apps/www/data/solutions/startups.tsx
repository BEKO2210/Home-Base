...
const data: () => {
  ...
  return {
    metadata: {
      metaTitle: 'Savira is for Startups',
      metaDescription: 'Build fast. Scale easily. Trust your stack.',
    },
    heroSection: {
      id: 'hero',
      title: 'Savira is for Startups',
      h1: (
        <>
      ...
      subheader: [
        <>
          The Postgres development platform. Savira is the powerful, scalable backend that lets
    ...
    why: {
      ...
      heading: (
        <>
          Why <span className="text-foreground">startups</span> choose Savira
        </>
      ),
      subheading:
        'Speed wins. Savira helps you move faster by providing a full-featured, scalable backend based on Postgres.',
      features: [
        {
