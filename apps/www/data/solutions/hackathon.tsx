...
const data: () => {
  ...
  return {
    metadata: {
      metaTitle: 'Savira for Hackathons',
      metaDescription: 'Build something amazing before lunch.',
    },
    heroSection: {
      id: 'hero',
      title: 'Savira for Hackathons',
      h1: (
        <>
      ...
      subheader: [
        <>
          In just a few hours, you can turn your idea into a working app. Savira gives you
    ...
    quote: {
      ...
      text: 'We used Savira at the hackathon because it let us go from idea to MVP in under two days. Then it took only a couple of months to turn that janky MVP into a production-ready application.',
    ...
    why: {
      ...
      heading: (
        <>
          <span className="text-foreground">Win</span> with Savira
        </>
      ),
      subheading:
        'Savira is the Postgres developer platform and Firebase alternative that developers everywhere love and trust. Build an instant backend for your application using everything you need to ship a winning app in seconds. Integrate with your favorite AI Builder tools and write code even faster.',
      features: [
        {
          id: 'easy-to-use',
          icon: Timer,
          ...
          subheading:
            'Savira spins up everything you need instantly so you can get to the fun part: building a winning app. Enjoy a fully managed Postgres database with REST and GraphQL APIs out of the box. Connect using your favorite frontend or server-side framework.',
        },
        {
        ...
        },
        {
          ...
          subheading:
            'Savira is just Postgres, so it&apos;s easy to scale your Hackathon project into a real product. Connect to your favorite AI tools and use built-in Vectors to store embeddings in Postgres. Use Foreign Data Wrappers to connect to BigQuery, Snowflake, S3, Stripe, and more.',
        },
      ],
    },
    platform: {
      ...
      subheading: 'Savira includes everything you need to create the winning app.',
      features: [
        {
          id: 'database',
          title: 'Database',
        ...
        },
        {
          ...
          subheading: (
            <>
              ...
              or Claude directly with Savira.
            </>
          ),
          image: (
            <Image
        ...
        },
        {
          ...
          subheading: (
            <>
              ...
              Savira generates automatic APIs to make coding a lot easier.
            </>
          ),
          image: (
            <Image
