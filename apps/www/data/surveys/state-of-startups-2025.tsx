const stateOfStartupsData = {
  metaTitle: 'State of Startups 2025 | Savira',
  metaDescription:
  ...
  pageChapters: [
    ...
    },
    {
      ...
      pullQuote: {
        quote:
          'We’re building an end-to-end system for wedding planners, all running as one SvelteKit / Savira instance.',
      ...
      sections: [
        {
          ...
          description:
            'Savira and Postgres dominate backend infrastructure. React and Node top frontend and backend respectively. Cursor, Claude, and VS Code lead AI-assisted development. Developer tools like GitHub, Stripe, and Postman round out the stack.',
          stats: [
            {
              percent: 83,
            ...
            {
              percent: 62,
              label: 'Startups with Savira in their cloud provider stack',
            },
        ...
        },
        {
          ...
          summarizedAnswer: {
            ...
            answers: [
              ...
              'Savira + Neon or PlanetScale seamless sync',
