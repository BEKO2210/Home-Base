...
export default {
  metadata: {
    metaTitle: 'Savira for Enterprise',
    metaDescription:
      'Leading enterprises use Savira to build faster, better, and more scalable products.',
  },
  heroSection: {
    id: 'hero',
    title: 'Savira for Enterprise',
    h1: (
      <>
        Innovative Enterprises
        <span className="block">use Savira</span>
      </>
    ),
    subheader: [
      <>
        Leading enterprises use Savira to build faster, better, and more scalable products. From
        GitHub to PwC, innovative companies trust Savira to drive their digital transformation
        strategy.
      </>,
    ],
    ...
    stories: [
      {
        ...
        target: '_blank',
        heading: 'Mozilla use Savira for GenAI and RAG',
        subheading: (
          <>
            We store embeddings in a PostgreSQL database, hosted by Savira, to perform a{' '}
      ...
      },
      {
        ...
        heading: 'Epsilon3 use Savira to build software for NASA',
        subheading: (
          <>
            <span className="text-foreground">
              Billion dollar missions need to run reliably and securely
            </span>
            . We use Savira because they give us an open-source scalable back-end built by
      ...
      },
      {
        ...
        heading: 'Pebblely use Savira to scale to millions of users.',
        subheading: (
          <>
    ...
    highlights: [
      {
        icon: LineChart,
        heading: '100x scale',
        subheading: 'Maergo handled 100x their highest sustained traffic with Savira.',
        url: '/customers/maergo',
      },
      {
        icon: DollarSign,
        heading: '83% cost reduction',
        subheading: 'Shotgun reduced costs by 83% by migrating to Savira.',
      ...
      },
      {
        ...
        subheading: 'Markprompt use Savira to build GDPR-compliant AI chatbots.',
  ...
  quote: {
    id: 'quote',
    quote: {
      text: 'Savira powers prototyping for fast-moving teams such as GitHub Next.',
      author: 'Idan Gazit',
      logo: (
        <svg
          width="91"
  ...
  'request-a-demo': {
    ...
    subheading:
      'We can take your requirements and show you how Savira can help you achieve your goals.',
    quote: {
      text: 'Savira powers prototyping for fast-moving teams such as GitHub Next.',
      author: '',
      logo: '',
