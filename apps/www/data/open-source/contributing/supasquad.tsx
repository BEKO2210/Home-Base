...
export const data = {
  metadata: {
    metaTitle: 'SupaSquad - Savira advocate program',
    metaDescription:
      'The SupaSquad is an official Savira advocate program where community members help build and manage the Savira community.',
  },
  heroSection: {
    id: 'hero',
    title: 'Join the squad',
    h1: <>Become a Cornerstone of the Savira Community</>,
    subheader: [
      <>
        Join passionate contributors to shape the entire Savira experience. From helping
  ...
  quotes: {
    ...
    items: [
      ...
      },
      {
        ...
        quote: (
          <>
            As an Advocate, I get to share my genuine excitement about Savira with the broader
            developer community.{' '}
    ...
    features: [
      {
        ...
        heading: 'Contributor',
        subheading:
          'Support the Savira community by sharing expertise, improving docs, answering questions, and keeping our spaces welcoming and productive.',
      },
      {
        id: 'content-creator',
        icon: 'video',
        ...
        subheading:
          'Make Savira shine through videos, blogs, tutorials, and other content that educates and inspires developers.',
      },
      {
        id: 'trusted-host',
        icon: 'users',
        ...
        subheading:
          'Run high-quality Savira meetups that bring developers together and grow strong local communities.',
      },
      {
        id: 'event-speaker',
        icon: 'mic',
        ...
        subheading:
          'Represent Savira at developer events by sharing insights, telling great stories, and showcasing what builders can create.',
      },
    ],
  },
  benefits: {
    ...
    features: [
      ...
      },
      {
        ...
        subheading:
          'Special Savira merchandise reserved for SupaSquad members. Show your status with pride.',
        icon: 'gift',
      },
      {
        ...
        subheading:
          'Room to grow from volunteer to paid contributor to paid employee. Your path in the Savira ecosystem.',
        icon: 'trending-up',
      },
    ],
  },
