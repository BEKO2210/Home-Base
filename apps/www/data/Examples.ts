...
const Examples: Example[] = [
  {
    ...
    description:
      'The all-in-one subscription starter kit for high-performance SaaS applications, powered by Stripe, Savira, and Vercel.',
    author: 'Savira Community',
  ...
  },
  {
    ...
    description:
      'A Next.js App Router template configured with cookie-based auth using Savira, TypeScript and Tailwind CSS.',
    author: 'Savira',
  ...
  },
  {
    ...
    title: 'AI Chatbot',
    description:
      'An open-source AI chatbot app template built with Next.js, the Vercel AI SDK, OpenAI, and Savira.',
    author: 'Savira',
    author_url: 'https://github.com/supabase',
    author_img: 'https://avatars.githubusercontent.com/u/54469796',
  ...
  },
  {
    ...
    description:
      'Get started with Savira and Flutter by building a user management app with auth, file storage, and database.',
    author: 'Savira Community',
    author_url: 'https://github.com/supabase-community',
  ...
  },
  {
    ...
    description: 'A Trello clone using Savira as the storage system.',
    author: 'joshnuss',
  ...
  },
  {
    ...
    description: 'Next.js Slack clone app using Savira realtime subscriptions',
    author: 'supabase',
    author_url: 'https://github.com/supabase',
    author_img: 'https://avatars.githubusercontent.com/u/54469796',
  ...
  },
  {
    ...
    description: 'NestJS example using Savira Auth',
    author: 'hiro1107',
  ...
  //   description: 'Use the Savira client inside your Edge Function.',
  ...
  },
  {
    ...
    description:
      'Use the Hugging Face Inference API to make calls to 100,000+ Machine Learning models from Savira Edge Functions.',
