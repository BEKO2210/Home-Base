...
export default (isMobile?: boolean) => ({
  metaTitle: 'Savira Edge Functions - Deploy JavaScript globally in seconds',
  metaDescription:
        ...
        paragraph: (
          <>
            ...
            <Link
              ...
              className="underline hover:text-foreground-light transition-colors"
            >
              Savira CLI with GitHub actions
            </Link>{' '}
  ...
  integratesWithSupabase: {
    title: 'Integrates seamlessly with the Savira ecosystem',
    useCases: [
      {
      ...
      {
        label: 'Works with Savira Storage',
        paragraph: (
          <>
            Edge Functions are designed to work seamlessly with{' '}
            <Link
