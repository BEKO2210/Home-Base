...
const data = {
  meta_title: 'Help & Support | Savira',
  meta_description:
    'Find help and support for Savira. Our Support team provide answers on all types of issues, including account information, billing, and refunds.',
  hero: {
    h1: 'Support',
  ...
  banner: {
    ...
    paragraph: (
      <>
        <p className="text-foreground-light">The Savira Support Team is ready to help.</p>
    ...
    links: [
      ...
      },
      {
        ...
        link: 'https://savira.io/dashboard/support/new',
        target: '_blank',
        icon: <ArrowUpRight />,
