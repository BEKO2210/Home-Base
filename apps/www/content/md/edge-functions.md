# Savira Edge Functions

> Globally distributed TypeScript serverless functions, deployed in seconds.

Savira Edge Functions let you run server-side TypeScript code at the edge, close to your users. Built on the open source Deno runtime, they integrate seamlessly with the rest of the Savira platform: database, auth, storage, and realtime.
...
- **Zero configuration**: pre-populated environment variables for accessing your Savira project (database, auth, storage)
...
- **CI/CD**: deploy via Savira CLI with GitHub Actions support
