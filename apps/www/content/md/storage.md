...
Savira Storage is an open source object store that integrates natively with Savira Auth and Postgres. It supports three bucket types for different workloads: files (general assets), analytics (Apache Iceberg), and vector (embeddings).
...
- **Row Level Security**: access policies written in SQL using Postgres RLS, integrated with Savira Auth
