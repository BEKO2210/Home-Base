...
const cards: CardInterface[] = [
  {
    ...
    author: 'Yasser',
    quote:
      '@kiwicopple @supabase @PostgreSQL @OpenAI Adding vector embeddings support to @Savira is awesome. Glad I built https://t.co/jnCYOLa4iK on supabase.',
  },
  {
    type: 'customer-story',
    avatar: '',
    ...
    quote:
      'We decided to use Savira over other specialized vector databases because it enabled us to be GDPR compliant from day one with little effort.',
    image: vectorImagesDir + 'supabase+firecrawl.svg',
    abstract: 'Markprompt and Savira - GDPR-Compliant AI Chatbots for Docs and Websites.',
