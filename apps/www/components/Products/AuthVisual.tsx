...
const AuthVisual: React.FC<Props> = ({ className }) => {
  return (
    <figure
      ...
      role="img"
      aria-label="Savira Authentication provides Row Level Security which enables you to define custom Policies to restrict access to your database"
    >
      <Image
        draggable={false}
        src="/images/index/products/auth.svg"
        alt="Savira Authentication user db rows"
        fill
        sizes="100%"
        priority
        quality={100}
