...
const layoutProps: ExampleLayoutProps = {
  ...
  description:
    "A collaborative annotation tool that uses Savira Realtime's broadcast channel to synchronize annotations and comments on embedded web content across multiple users.",
}
