...
const days: (isDark?: boolean) => WeekDayProps[] = (isDark = true) => [
  {
    ...
    title: 'Savira is officially launching into General Availability',
    description: 'Savira is officially launching into General Availability',
    links: [
      {
        type: 'xSpace',
  ...
  },
  {
    ...
    title: 'Savira Functions now supports AI models',
    description: (
      <>
        Savira Functions now supports <strong>AI models</strong>
      </>
    ),
    links: [
      {
  ...
  },
  {
    ...
    title: 'Savira Auth now supports Anonymous sign-ins',
    description: (
      <>
        Savira Auth now supports <strong>Anonymous sign-ins</strong>
      </>
    ),
    links: [
      {
  ...
  },
  {
    ...
    title: 'Savira Storage: now supports the S3 protocol',
    description: (
      <>
        Savira Storage: now supports the <strong>S3 protocol</strong>
      </>
    ),
    links: [
      {
  ...
  },
  {
    ...
    title: 'Savira Security Advisor & Performance Advisor',
    description: (
      <>
        Savira <strong>Security Advisor</strong> & <strong>Performance Advisor</strong>
      </>
    ),
    links: [
      {
