...
const days: WeekDayProps[] = [
  {
    ...
    description: (
      <>
        Savira Studio: introducing an <strong>AI Assistant</strong>,{' '}
  ...
  },
  {
    ...
    description: (
      <>
        Introducing Savira <strong>Branching</strong>, a Postgres database for every pull request
      </>
    ),
    links: [
      {
  ...
  },
  {
    ...
    description: (
      <>
        Savira Auth: <strong>Identity Linking</strong>, <strong>Session Control</strong>,{' '}
