...
const days: (isDark?: boolean) => WeekDayProps[] = (isDark = true) => [
  ...
  },
  {
    ...
    title: 'Savira Edge Functions: Deploy from the Dashboard + Deno 2.1',
    description: <>Savira Edge Functions: Deploy from the Dashboard + Deno 2.1</>,
    links: [
      {
        type: 'video',
        href: 'Pn7xyTbsxPI',
