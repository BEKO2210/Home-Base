...
const days: WeekDayProps[] = [
  ...
  },
  {
    ...
    steps: [
      {
        title: 'Hugging Face now supported in Savira',
  ...
  },
  {
    ...
    steps: [
      {
        title: 'Savira Local Dev: Migrations, Branching, Observability',
  ...
  },
  {
    ...
    steps: [
      {
        title: 'Savira Integrations Marketplace',
  ...
  },
  {
    ...
    steps: [
      {
        title: 'Savira Supavisor: 1M Postgres connections',
