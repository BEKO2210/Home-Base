...
const page: GoPageInput = {
  ...
  metadata: {
    title: 'Win a Mac Mini | Savira at PGConf.dev 2026',
    description:
      'Thanks for connecting with us at PGConf.dev 2026. Try Savira — Postgres with everything you need. Enter for a chance to win a Mac Mini.',
  },
  hero: {
    title: 'Win a Mac Mini',
    subtitle: 'Savira at PGConf.dev 2026',
    description:
      'Thanks for connecting with us at PGConf.dev 2026. Try Savira — Postgres with everything you need. Enter for a chance to win a Mac Mini.',
    image: {
