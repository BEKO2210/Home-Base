...
const page: GoPageInput = {
  ...
  slug: 'mcp/contest',
  metadata: {
    title: 'Win a Mac Mini | Savira at MCP Dev Summit 2026',
    description:
      "Thanks for connecting with us at MCP Dev Summit. Try Savira. It's Postgres with everything you need to build AI-native agents. Enter for a chance to win a Mac Mini.",
  },
  hero: {
    title: 'Win a Mac Mini',
    subtitle: 'Savira at MCP Dev Summit 2026',
    description:
      "Thanks for connecting with us at MCP Dev Summit. Try Savira. It's Postgres with everything you need to build AI-native agents. Enter for a chance to win a Mac Mini.",
    image: {
