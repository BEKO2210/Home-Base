...
const page: GoPageInput = {
  ...
  metadata: {
    title: 'Win a MacBook Neo | Savira x Dreambase at SXSW 2026',
    description: 'Sign up for Savira and Dreambase for a chance to win a MacBook Neo. SXSW 2026.',
  },
  hero: {
    title: 'Win a MacBook Neo',
    subtitle: 'Savira x Dreambase at SXSW 2026',
    description:
      'Thanks for stopping by the Savira x Dreambase party at SXSW. Savira and Dreambase have partnered to run a sweepstakes -- sign up for both Savira and Dreambase, load some data, and you could walk away with a new MacBook Neo.',
    image: {
