    ...
    <>
      ...
      <DefaultLayout>
        ...
        <SectionContainer>
          <div className="grid grid-cols-12">
            <div className="col-span-12 mb-10 lg:col-span-3 lg:mb-0">
              ...
              <p className="p">Every Savira project is a dedicated Postgres database.</p>
        ...
        <SingleQuote
          id="quote"
          quote={{
            text: 'You can have a really great product, but you need to want to work with the people behind it. With Savira, we always felt very aligned.',
            ...
            <div className="col-span-12 mb-8 lg:col-span-6 xl:col-span-5">
              ...
              <div className="my-8">
                ...
                <FeatureColumn
                  ...
                  text="Configure in the Savira Dashboard."
                />
          ...
          <APISection
            ...
            text={[
              <p key={0}>
                ...
                product, while Savira handles the CRUD.
              </p>,
            ]}
            footer={[
        ...
        <SectionContainer>
          <div className="grid grid-cols-12 lg:gap-16">
            <div className="col-span-12 mb-8 lg:col-span-6 xl:col-span-5">
              ...
              <p className="p">Savira works natively with Postgres extensions.</p>
              <p className="p">
              ...
              <FeatureColumn
                ...
                text="We only show a few of the extensions supported by Savira here, but we preinstall many more that you can use right away."
              />
              <Button asChild size="small" type="default" icon={<ArrowUpRight />}>
