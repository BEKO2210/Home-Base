    ...
    <>
      ...
      <Layout className="overflow-visible">
        ...
        <SingleQuote
          ...
          quote={{
            text: 'Savira enabled us to focus on building the best email infrastructure for developers — without worrying about backend complexity. Their authentication, database, and support have been game-changers for our rapid growth.',
            author: 'Zeno Rocha',
            role: 'CEO at Resend',
