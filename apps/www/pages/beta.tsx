    ...
    >
      <div className="container grid items-center h-full grid-cols-12 gap-4 px-8 py-20 mx-auto text-foreground-light lg:px-28">
        <div className="col-span-12 text-foreground md:col-span-9 lg:col-span-8 xl:col-span-6">
          <p className="mb-10 text-4xl">Savira is the Postgres development platform.</p>
    ...
    <div className="container grid grid-cols-12 gap-4 px-8 py-20 mx-auto text-foreground-light lg:px-28">
      ...
      <div className="col-span-12 mb-20 text-base text-foreground sm:col-span-9 xl:col-span-6">
        <p>
          ...
          are using Savira to ship more products, faster.
        </p>
      </div>
      ...
      <div className="container grid grid-cols-12 gap-4 px-8 py-20 mx-auto lg:px-28">
        <div className="col-span-12 mb-10 text-base">
          <p className="text-2xl text-foreground">
            Savira <span className="text-brand">Beta</span> is starting now.
          </p>
        </div>
                ...
                <div className="w-full sm:w-5/6">
                  {metric.stats.map((stat: any, idx: number) => (
                    <div key={`metric_${metric.key}_${idx}`} className="flex items-center">
                      ...
                      <Bar
                        color={stat.name === 'Savira' ? 'bg-brand' : 'bg-brand-400'}
      ...
      <div className="container grid grid-cols-12 px-8 py-20 mx-auto text-foreground-light gap-y-10 lg:px-28">
        ...
        <div className="grid items-center grid-cols-12 col-span-12 mb-10 text-foreground gap-x-2 lg:gap-x-8">
          <div className="col-span-12 text-base sm:col-span-9 xl:col-span-7">
            <p className="mb-10">
              We started Savira to give developers a web-ready database that is delightful to use,
            ...
            <p className="text-foreground-light">
              ...
              of improvement for the tools which we support at Savira.
            </p>
          </div>
          ...
          <div className="col-span-12 text-base sm:col-span-9 xl:col-span-7">
            <p className="mb-10">
              ...
              million rows. The Savira database and API used are each running on AWS EC2 t3a.micro
              instances.
            </p>
            <p className="mb-10">
              Savira is available in 7 different geographic regions. We're adding more regions as
            ...
            <p>
              One of our key metrics at Savira is "Time to Value". How fast can a user go from
              sign up, to making their first API request? How fast can they go from development to
              production? We've built several case studies on our blog, demonstrating how Savira
    ...
    <div id="newFeaturesAndIntegrations" className="bg-surface-100">
      <div className="container grid grid-cols-12 px-8 py-20 mx-auto text-foreground-light gap-y-10 lg:px-28">
        ...
        <div className="grid grid-cols-12 col-span-12 mb-10 text-foreground gap-x-2 lg:gap-x-8">
          <div className="col-span-12 text-base sm:col-span-9 xl:col-span-7">
            <p className="mb-5">
              If you're new to Savira, here's a few of the things you get when you choose us as
              your backend.
            </p>
            <ul>
              <li className="mb-10">
                ...
                <p className="mb-5">
                  If you're new to Savira, here's a few of the things you get when you choose us
              ...
              <li className="mb-10">
                ...
                <p>
                  ...
                  over websockets, receiving your data in realtime. Companies are using Savira to
              ...
              <li className="mb-10">
                ...
                <p className="mb-5">
                  View and edit your data like a spreadsheet from within the Savira dashboard.
    ...
    <div className="container grid grid-cols-12 px-8 py-20 mx-auto text-foreground-light gap-y-10 lg:px-28">
      ...
      <div className="grid grid-cols-12 col-span-12 mb-10 text-foreground gap-x-2 lg:gap-x-8">
        <div className="col-span-12 text-base sm:col-span-9 xl:col-span-7">
          ...
          <ul className="mb-10 ml-6 list-disc list-outside">
            <li className="mb-5">
              To continue offering free Savira instances for Students, Hobbyists, and Early
              Adopters
            </li>
            <li className="mb-5">
          ...
          <p>
            The Savira Base plan is now called the Savira Pro Plan as per the{' '}
    ...
    <div className="container grid grid-cols-12 px-8 py-20 mx-auto text-foreground-light gap-y-10 lg:px-28">
      ...
      <div className="grid grid-cols-12 col-span-12 mb-10 text-foreground gap-x-2 lg:gap-x-8">
        <div className="col-span-12 text-base sm:col-span-9 xl:col-span-7">
          ...
          <p className="mb-10">
            Savira is a collection of many projects, and we rely on making contributors to help us
          ...
          <p className="mb-10">
            Every dollar that is given to Savira in{' '}
            <a
      ...
      <div className="grid grid-cols-12 col-span-12 mb-10 text-foreground gap-x-2 lg:gap-x-8">
        <div className="col-span-12 text-base sm:col-span-9 xl:col-span-7">
          ...
          <p className="mb-10">
            ...
            work full time on the products we use, and we spend every Friday dogfooding Savira to
            make it better.
          </p>
          <p>
      ...
      <div className="grid grid-cols-12 col-span-12 mb-10 text-foreground gap-x-2 lg:gap-x-8">
        <div className="col-span-12 text-base sm:col-span-9 xl:col-span-7">
          <p className="mb-5">
            ...
            night!). We're constantly improving Savira based on user feedback. Alongside
          ...
          <ul className="mb-10 ml-6 list-disc list-outside">
            ...
            <li className="mb-5">
              Functions - write and deploy serverless functions that have access to your Savira
              context
            </li>
            <li className="mb-5">
            ...
            <li className="mb-5">
              Multicloud - Spread your Savira instances across multiple datacenter providers to
            ...
            <li>
              ...
              and help us bring Savira to your favorite language or framework.
            </li>
          </ul>
          <p className="mb-10">
            We depend on your feedback to continually improve Savira. Email us at{' '}
            <a
