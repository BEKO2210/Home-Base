...
export const meta = {
  type: 'lp',
  title: 'Security at Savira',
  description:
    'Savira is trusted by thousands of developers for building and deploying secure applications.',
}
...
<div className="container mx-auto px-8 sm:px-16 xl:px-20 grid grid-cols-12 items-center my-8">
  <div className="col-span-12 lg:col-span-6">
    <h1 className="xl:text-5xl mb-4 [&_p]:m-0">Security at Savira</h1>
...
![Savira security](/images/security/security-hero.png)
...
Savira allows users to enable Multi-factor authentication (MFA) on their account.
...
Savira is SOC 2 Type 2 compliant. This is an important security policy when [handling sensitive customer data](/docs/guides/security/soc-2-compliance).
...
Savira is ISO 27001 certified. ISO 27001 is an internationally recognized standard for information security management systems (ISMS), confirming that we maintain rigorous controls to protect customer data.
...
Members of organizations in Savira can be granted access to specific resources.
...
Savira uses [Stripe](https://stripe.com) to process payments and does not store personal credit card information for any of our customers.
...
Savira works with industry experts to conduct regular penetration tests.
...
Savira combats Distributed Denial of Service attacks in several ways to mitigate resource abuse and prevent runaway bills.
