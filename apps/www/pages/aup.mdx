...
export const meta = {
  title: 'Acceptable Use Policy | Savira',
  description: 'Savira Acceptable Use Policy',
}
...
This Acceptable Use Policy (this "Policy") describes prohibited uses of the web services offered by Savira, Inc. and its affiliates (the "Services") and the website located at https://supabase.com (the "Savira Site").  
By using the Services or accessing the Savira Site, you agree to the latest version of this Policy. Violation of this Policy may result in the immediate suspension or termination of your Accounts and / or Services.
...
**1.5. Obfuscation:** Using techniques to obfuscate code or application logic uploaded to the Savira platform to hide malicious intent or bypass platform detection and security controls.  
...
**3.4. Cryptocurrency Mining:** Using Savira compute resources (including Edge Functions) to mine digital assets or cryptocurrencies.  
**3.5. Vulnerability Disclosure:** Exploiting discovered vulnerabilities or publicly disclosing them before a fix is available. Discoveries must be reported privately to Savira.

## 4. Account and Message Abuse

**4.1. Email Requirements:** You may not use temporary, disposable, or "dead-drop" email addresses for your Savira account.  
**4.2. Automated & Bulk Registration:** Creating accounts via automated means, registering accounts in bulk, or maintaining an excessive number of accounts as a single user is prohibited without explicit permission from Savira.  
...
**6.1. Investigation and Action:** Savira reserves the right, in its sole discretion, to investigate, suspend, or terminate access to the Services if Savira determines that a user's conduct violates this Policy or poses legal, regulatory, security, reputational, or operational risk to Savira, the Services, or other customers.  
...
**6.3. Obligation:** Savira has no obligation to monitor user content or activity and does not assume responsibility for user content.
