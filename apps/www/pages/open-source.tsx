...
const OpenSource = () => {
  ...
  const meta_title = pageData.metaTitle || 'Open Source | Savira'
  const meta_description =
    pageData.metaDescription ||
    'Savira is an open source company, supporting existing open source tools and communities wherever possible.'
