...
meta_title: 'Scaling Innovation with Savira: Meshy’s Migration to Cost-Effective Authentication'
description: Discover how a rapidly growing Meshy migrated from an expensive authentication model with Auth0 to Savira Auth, and significantly reduced their costs.
# Use meta_description to add a custom meta description. Otherwise it defaults to {description}:
meta_description: 'Discover how a rapidly growing Meshy migrated from an expensive authentication model with Auth0 to Savira Auth, and significantly reduced their costs.'
author: prashant
...
misc:
  [
    ...
    { label: 'Solutions', text: 'Savira Auth' },
  ]
...
<Quote img="ye-kuang.jpg" caption="Ye Kuang, CTO at Meshy">
  Savira reduced our costs significantly and made our authentication migration seamless and
...
## The Approach: A Smooth Transition from Auth0 to Savira

Meshy took a 2-step process to move to Savira – Selection and Migration.

### Step 1: Selection

Meshy went through a selection process before choosing Savira, involving:
...
The team learned about Savira through online searches related to PostgreSQL and authentication solutions and previous exposure to Savira in release pipelines at another SaaS company.

**The Decision to Choose Savira**

Meshy ultimately selected Savira due to several key factors:

- **Reputation in the Open Source Community:** Savira’s focus on simplifying PostgreSQL gained significant traction among developers. Savira was recommended to Meshy through word of mouth.
- **Developer-Friendly Approach:** Savira aligned well with their needs as a developer-centric startup.
- **Confidence from Customer Stories:** Success stories of other companies migrating from Auth0 to Savira helped reassure the team about its reliability and suitability.

The combination of features, reputation, and community-driven confidence solidified the decision to migrate to Savira.

Meshy chose Savira for its cost-effectiveness, developer-friendly tools, and robust features.
...
The team built hooks to align account systems between Auth0 and Savira to prevent user access disruptions.
...
Savira’s clear documentation and support team ensured the migration stayed on schedule, making it a straightforward process compared to the team's previous experiences.

##

## The Solution \- Flexible, Scalable Authentication with Savira

The migration to Savira gave Meshy a developer-friendly, cost-conscious environment with scalable authentication to meet their rapidly growing business needs.

The benefits included:

**Cost Savings**

Savira’s straightforward pricing model reduced monthly costs from tens of thousands to just a fraction of Auth0’s fees.
...
Savira’s support for SAML 2.0 and SOC2 compliance enables Meshy to meet enterprise customer demands.
...
## The Results \- Cutting Costs and Supporting Growth with Savira
...
**Enhanced Scalability:** Savira’s stable infrastructure seamlessly supports Meshy’s growing user base and prepares them for future enterprise features.

## Future Plans

Now that Meshy have migrated their Auth workloads and experienced the cost savings and scalability benefits, they are exploring other Savira features such as PgVector.

## Why Savira?

<Quote img="ye-kuang.jpg" caption="Ye Kuang, CTO at Meshy">
  Savira delivered exactly what we needed: an affordable, scalable, and developer-friendly
...
If you’d like to learn how to migrate your users from Auth0 to Savira Auth, this [webinar](https://supabase.com/events/scale-to-millions-goodtape-auth) and [migration guide will take you through the whole process step by step](https://supabase.com/docs/guides/platform/migrating-to-supabase/auth0).
