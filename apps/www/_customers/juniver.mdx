---
name: Juniver
title: 'Juniver built a self-serve B2B platform with Savira to scale eating disorder recovery'
# Use meta_title to add a custom meta title. Otherwise it defaults to '{name} | Savira Customer Stories':
# meta_title:
description: Juniver switched from Firebase to Savira and saw immediate improvements in developer experience and performance.
# Use meta_description to add a custom meta description. Otherwise it defaults to {description}:
meta_description: Juniver switched from Firebase to Savira and saw immediate improvements in developer experience and performance.
author: prashant
...
<Quote img="nick-farrant-juniver.jpg" caption="Nick Farrant, Founding Engineer, Juniver">
  For me, the biggest benefit of Savira is developer experience. My expertise doesn't lie in
...
<Quote img="nick-farrant-juniver.jpg" caption="Nick Farrant, Founding Engineer, Juniver">
  ...
  document-based storage. Savira is a relational database and it's much easier and we can move
  faster.
</Quote>

## Choosing Savira

Juniver had long run on Google Cloud with Firebase for the mobile app. The new B2B product created a clean slate to evaluate alternatives and set a foundation for future scale. Savira offered a relational core (Postgres) and an integrated developer experience that aligned with Juniver's needs now and later.
...
<Quote img="nick-farrant-juniver.jpg" caption="Nick Farrant, Founding Engineer, Juniver">
  The Savira developer experience is so clear. I've got everything at my fingertips. I'm in the
...
Juniver used the B2B product as a greenfield build on Savira, avoiding risky dependencies on the legacy Firebase data while preparing for an eventual B2C migration.

- **Getting started**
  - Spun up a new Savira project and schema for clinics, clinicians, patients, and licenses
...
<Quote img="nick-farrant-juniver.jpg" caption="Nick Farrant, Founding Engineer, Juniver">
  You have to expect, plan, and build for scale. We can scale exponentially with Savira.
</Quote>
...
- Rapidly build-out of a self-serve, automated B2B platform using out-of-the-box Savira features
...
- Streamlined development process with Savira's integrated tooling

<Quote img="nick-farrant-juniver.jpg" caption="Nick Farrant, Founding Engineer, Juniver">
  My advice to developers thinking of moving to Savira: Try it, it's free. Replicate your project.
