---
title: Koodos scales its social discovery app Shelf on Savira
meta_title: Koodos scales its social discovery app Shelf on Savira
name: Koodos
description: Koodos built its app Shelf from day one on Savira, growing to support millions of users and billions of data points without dedicated database staff.
author: prashant
...
<Quote img="apurva-chitnis.jpg" caption="Apurva Chitnis, Co-Founder & CTO, Koodos">
  We grew from zero to a million users in a short period and Savira has kept up every step of the
...
With billions of data points flowing through the system and millions of users, Koodos needed a backend that could scale without requiring a dedicated database team. Savira has been that foundation since day zero.
...
Koodos chose Savira from day one. The team evaluated alternatives like PlanetScale and Amazon RDS, but found they lacked the complete picture that Savira offered.

<Quote img="apurva-chitnis.jpg" caption="Apurva Chitnis, Co-Founder & CTO, Koodos">
  We started from day zero with Savira. Savira helped us get started really quickly, helped us
...
Key reasons for choosing Savira:
...
- Enterprise support with direct access to Savira engineers
...
<Quote img="apurva-chitnis.jpg" caption="Apurva Chitnis, Co-Founder & CTO, Koodos">
  ...
  solutions to answer those for us. Savira handles a lot of these core features out of the box.
</Quote>

Savira's combination of observability and hands-on support set it apart from the competition.

<Quote img="apurva-chitnis.jpg" caption="Apurva Chitnis, Co-Founder & CTO, Koodos">
  We looked at other hosted databases, but Savira gave us full visibility. We can inspect queries,
  benchmark IOPS, and actually talk to the engineers helping us optimize. That's rare.
</Quote>

## The approach

Koodos uses Savira as the backbone of Shelf's entire backend, powering authentication, user management, and critical transactional data.

<Quote img="apurva-chitnis.jpg" caption="Apurva Chitnis, Co-Founder & CTO, Koodos">
  Savira is really the brains of our operation here at Koodos.
</Quote>

- **Authentication and user management.** Savira Auth handles thousands of users signing up from around the world. One-time passwords and login flows are managed through Savira.
- **Source of truth for presentation data.** All critical transactional data that users see when they open the app lives in Savira. Usernames, profiles, and other high-read data are stored in Postgres.
- **Performance optimization.** Working with Savira's solutions team, the team reduced CPU load from 80 percent to 30 percent through query optimization, better indexing, and partitioning plans for their largest tables.
...
- **Observability.** Using Savira's Performance Advisor, Grafana metrics, and direct SQL inspection, the team tracks slow queries, vacuum activity, and connection spikes in real time.

<Quote img="apurva-chitnis.jpg" caption="Apurva Chitnis, Co-Founder & CTO, Koodos">
  Savira's database reviews feel like health check-ups for our app. Their engineers spot issues
  before they become production problems.
</Quote>

The team is also evolving their architecture to optimize how data flows through the system. They plan to send event data directly to Snowflake for heavy computation, then push aggregated results back into Postgres for fast reads. This lets Savira do what it does best: fast, reliable reads with strong data integrity.

## The results

Savira enabled Koodos to scale Shelf's backend in lockstep with explosive user growth, all without adding DevOps overhead.
...
Koodos is preparing for its next phase of growth. The team is excited about Savira's new [analytics and Iceberg capabilities](https://supabase.com/blog/introducing-analytics-buckets) for handling their large-scale data needs. They are also optimizing their architecture to leverage Postgres for what it does best while offloading heavy computation to Snowflake.

<Quote img="apurva-chitnis.jpg" caption="Apurva Chitnis, Co-Founder & CTO, Koodos">
  We know Savira can take us from one million to ten million users. The roadmap, from Iceberg to
