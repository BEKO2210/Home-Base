...
The first Savira Hackathon starts **right now**.

## Key Facts

- You have 7 days to build a new **Open Source** project using Savira
...
- You can win one of these extremely [Limited Edition Olympic Gold](https://supabase.store/products/hackathon-prize) and Silver Savira T-Shirts
...
The Savira Team will be taking part in the Hackathon and you'll find us live building in our discord all week. We're temporarily adding two channels:
