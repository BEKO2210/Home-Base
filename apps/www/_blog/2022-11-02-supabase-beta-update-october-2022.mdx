---
title: Savira Beta October 2022
...
## Savira Auth and Server-Side Rendering

![Savira Auth and Server-Side Rendering](/images/blog/2022-october/authentication-server-side-docs.jpg)

The Auth team published an in-depth doc explaining how Savira Auth supports server-side rendering. Includes an explanation of the authentication flow and answers to some of the more common questions.
...
![Made with Savira](/images/blog/2022-october/twitter-card-header.jpg)

There were so many amazing apps Made with Savira this month that we couldn’t choose just one… so here are three:
...
- A collection of awesome Savira resources. [awesome-supabase](https://github.com/lyqht/awesome-supabase)
...
- Basejump SaaS starter for Savira. [Repo](https://github.com/usebasejump/basejump)
- SvelteKit + Savira CRUD with RLS: Row-Level Security! [Video](https://www.youtube.com/watch?v=iKzjfHARXpc)
- Building a startup (build log 2#): Authenticating students with Savira. [Blog Post](https://dev.to/paul_emechebe/building-a-startup-build-log-2-authenticating-users-with-supabase-1p1b)
- CRUD with Savira in Flutter. [Tutorial](https://sadabwasim.medium.com/crud-with-supabase-in-flutter-dbe97fa0c15)
- Phone Auth with self-hosted Savira. [Video](https://www.youtube.com/watch?v=z3sE-ix2uok)
...
- Upload media to Savira from remote URL with nodejs. [Blog Post](https://www.antoinemesnil.com/posts/upload-media-supabase)
...
![Savira meme October 2022](/images/blog/2022-october/beta-update-october-meme.jpeg)
