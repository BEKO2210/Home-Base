...
Now with deployments, you can deploy your database.build creations directly to a cloud database provider, starting with Savira (and AWS coming soon).
...
The first time you deploy to Savira, you will need to connect your database.build account with your Savira account. If you don't already have a Savira account, you'll be given the option to create a new one here. Savira includes a Free plan, so if this is your first project there will be no cost to deploy. Follow the steps outlined in the dialog to connect your account with a Savira org.
...
<Img
  className="border-none"
  alt="database.build v2 Deploy to Savira"
  src={{
