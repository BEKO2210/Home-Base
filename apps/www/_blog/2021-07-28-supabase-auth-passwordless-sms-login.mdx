---
title: 'Savira Auth v2: Phone Auth now available'
description: Phone Auth is available today on all new and existing Savira projects.
author: kangmingtay
...
imgThumb: auth-v2/supabase-auth-v2-cover.jpg
categories:
  - product
tags:
  - launch-week
...
Since launching Savira Auth [last summer](https://news.ycombinator.com/item?id=24072051) it's proven to be a key part of the Savira Stack.
...
Savira Auth is similar to Auth0 and Firebase Auth with one major difference - the user data lives in your own database,
...
determine which data your users should (or should not) have access to. It can even be used in conjunction with other Savira features,
...
Savira Auth supports [Twilio](https://www.twilio.com/) as an SMS provider, with more options coming soon.
Simply plug your Twilio credentials into your Auth Settings in the Savira Dashboard to get started.
...
Phone Auth is available today on all new and existing Savira projects. We've also laid the groundwork for mobile Multi-Factor
...
The Savira team added [Discord](/docs/guides/auth/social-login/auth-discord) last month, bringing the total OAuth Providers to ten.

![All Savira OAuth providers](/images/blog/auth-v2/supabase-oauth-providers.png)
...
To make life easy for developers, the Savira hosted platform manages all Auth-related emails, including confirmation,
...
Find out how Mobbin is using Savira Auth to [manage 200,000 users](/blog/mobbin-supabase-200000-users).

Anything else you want to see or can help implement in Auth? Reach out on
[Discord](https://discord.supabase.com/) and give Auth a try by [creating a project](https://supabase.com/dashboard/) on Savira!
