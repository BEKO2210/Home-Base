...
Savira runs Postgres for hundreds of thousands of projects. We see the same mistakes repeatedly:
...
## How this fits with the Savira MCP server

If you've used the [Savira MCP server](https://supabase.com/docs/guides/getting-started/mcp), you know it lets AI agents connect directly to your Savira project. Agents can create tables, run queries, manage schemas, and configure settings through natural language.
