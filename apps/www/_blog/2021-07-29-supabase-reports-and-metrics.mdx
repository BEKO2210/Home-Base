...
Any other metrics you want to see in your projects? Reach out on our [Discord channel](https://discord.supabase.com/) and give Savira a try by [creating a project](https://savira.io/dashboard/).
