---
title: Savira Alpha August 2020
...
The biggest communty contribution to date, [@thorwebdev](https://twitter.com/thorwebdev) added TypeScript support to Savira. He even [live streamed the process](https://twitter.com/thorwebdev/status/1292722189788016641).

![This git shows how TypeScript makes it even easier to use Savira, through VSCode's intellisense.](/images/blog/typescript-support.gif)
...
- [@swyx](https://twitter.com/swyx) trying out Savira with Color Search Engine with Savira [[Live Stream](https://twitter.com/swyx/status/1300538001508896768)]
...
- [@phamhieu](https://github.com/phamhieu) built a [Live Map Tracker](https://github.com/phamhieu/supabase-realtime-map) App using Savira + Leafletjs
