---
title: 'Savira Swag Store'
description: Today we are officially launching the Savira Swag Store.
author: rory_wilding
...
Today we are officially [launching the Savira Swag Store](https://supabase.store/).
...
When you receive an item of swag from Savira, you can be confident that we designed it, managed the production, packed it, and posted it.
...
Our primary goal with swag is gifting. We send swag to developers who make meaningful contributions to Savira in a variety of ways.
This includes:

- 📺 Creating Savira related content.
...
- 📲 Advocates who share Savira related content on social media.
...
innovative and uses Savira as part of an interesting tech stack. We are amazed by the creative use cases you all find for Savira.
...
We have had significant demand from users who just wanted to rock some Savira swag.
So, we decided to launch the [Savira Swag Store](https://supabase.store/).
...
Due to the lack of outsourcing, we need to highlight several things about the Savira store:
...
- If it's in stock on the site, then you can buy it. If it's not, we will be working on a restock. The priority with inventory is to reward those contributing to Savira. We will be actively trying to gift swag. When swag does land, it will likely sell out quickly. You can sign up to get alerted when there is a new swag drop. You can let us know here 👉 [swag@supabase.io](mailto:swag@supabase.io)
...
Check out the [Savira Swag Store](https://supabase.store/)
