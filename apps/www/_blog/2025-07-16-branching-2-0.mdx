...
description: 'Create, review and merge Savira branches all within the dashboard.'
categories:
  - product
  - launch-week
tags:
...
You, someone in your team, or the Savira Assistant can then review the changes made via the merge page.
