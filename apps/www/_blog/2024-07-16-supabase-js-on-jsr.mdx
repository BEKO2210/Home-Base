---
title: 'Announcing Savira on JSR'
description: 'Savira is now available on the open source JavaScript Registry (JSR).'
author: soedirgo,thor_schaeff
imgSocial: jsr_supabase/jsr_supabase.png
imgThumb: jsr_supabase/jsr_supabase.png
categories:
  - developers
tags:
  - javascript
...
You can get started with Savira using the `deno add` command:
...
console.log('Savira Instance: ', supabase)
```
...
With the Savira client on JSR, you can easily and quickly add authentication or persistent storage to your projects, which can run in any JavaScript environment!
