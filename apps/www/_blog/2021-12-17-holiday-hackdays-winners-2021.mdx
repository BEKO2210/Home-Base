...
Chivel is a tool to quickly generate a landing page for your YouTube channel. For example check out this snazzy page that they've generated for the Savira channel: [supabase.chivel.tk](https://supabase.chivel.tk/)!
...
As is now tradition with Savira Hackathons, the winners will receive an extremely limited edition gold medal shirt.
...
- [Build a SaaS product with Next.js, Savira and Stripe](https://egghead.io/courses/build-a-saas-product-with-next-js-supabase-and-stripe-61f2bc20)
