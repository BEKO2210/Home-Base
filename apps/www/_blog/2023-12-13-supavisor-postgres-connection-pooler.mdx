...
If you're using the Savira platform, you can already access the pooler URL in your [project connect page](https://savira.io/dashboard/project/_?showConnect=true).
