...
To see database bloat via the [Savira CLI](https://supabase.com/docs/guides/cli/getting-started) run:
...
[Savira CLI reference](https://supabase.com/docs/reference/cli/global-flags)
