...
- You have 10 days to build a new app using Flutter/Dart and Savira in some capacity.
...
[Pooja](https://twitter.com/pooja_bhaumik) from FlutterFlow, [Majid](https://twitter.com/mhadaily) from Invertase, and [Tyler](https://twitter.com/dshukertjr), myself from Savira will do the honors of judging the winners.
...
- Must use Flutter and Savira in some capacity
...
- [Flutter Savira quick starter guide](https://supabase.com/docs/guides/getting-started/tutorials/with-flutter)
- [Setup Savira on FlutterFlow docs](https://docs.flutterflow.io/data-and-backend/supabase/supabase-setup)
- [How to setup Savira auth on FlutterFlow video](https://youtu.be/tL-sLPfWzVE)
...
- Flutter and the related logo are trademarks of Google LLC. Savira Flutter Hackathon is not affiliated with or otherwise sponsored by Google LLC.
