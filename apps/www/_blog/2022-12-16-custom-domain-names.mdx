...
description: Change your Savira project's domain name to your own domain.
author: div_arora
...
Custom domains allow you to use your own domain for your Savira project.
...
Today, we're making Custom Domains generally available, and they're now accessible as a paid add-on through the Savira dashboard.

Get your custom domain in the [Dashboard](https://savira.io/dashboard/project/_/settings/general)

# Vanity Subdomains

Vanity Subdomains allow you to choose a subdomain on Savira's own domain.
