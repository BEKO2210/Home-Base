...
Next, create a `.env.local` file in the root of your project and add the following env vars. You can find these in your [Savira dashboard](https://savira.io/dashboard/project/_/settings/api).
