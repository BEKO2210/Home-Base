...
Create a new Savira project (or use an existing one) and copy its connection string URI from the [Database Settings page](https://savira.io/dashboard/project/_/database/settings). The URI looks like the following:
