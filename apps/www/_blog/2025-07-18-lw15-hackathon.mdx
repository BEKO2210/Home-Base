---
title: 'Savira Launch Week 15 Hackathon'
...
We have just concluded [Launch Week 15 with so many new updates](https://supabase.com/launch-week), but no launch week is complete without a hackathon! The Savira Launch Week 15 Hackathon begins now! Open your favorite IDE or AI agent and start building!

As of the time of publishing this blog post, the hackathon has begun and will conclude on Sunday, July 27th, at 11:59 pm PT. You could win an extremely limited edition Savira swag and add your name to the Savira Hackathon Hall of Fame.
...
- You have 10 days to build a new o**pen-source** project using Savira in some capacity
