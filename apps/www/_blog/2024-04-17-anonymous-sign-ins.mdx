...
description: 'Sign in as an anonymous user to authenticate with Savira'
author: kangmingtay
...
Savira Auth now supports [anonymous sign-ins](/docs/guides/auth/auth-anonymous), one of our [most-requested features](https://github.com/supabase/auth/issues/68) by the community.
...
<div className="video-container">
  <iframe
    ...
    title="Anonymous sign-ins with Savira Auth"
...
For local development, upgrade your Savira CLI and add the config to the `config.toml` file:
...
Savira Auth provides 2 ways to achieve this:
...
To link an OAuth identity to an anonymous user, you need to [enable manual linking](/dashboard/project/_/auth/providers) for your project. Learn about how [identity linking](/docs/guides/auth/auth-identity-linking) works with Savira Auth.
