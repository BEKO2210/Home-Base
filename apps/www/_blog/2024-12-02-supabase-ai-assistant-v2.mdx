...
description: An evolution of how we approach AI within the Savira dashboard
...
Today we are releasing Savira Assistant v2 in the Dashboard - a global assistant with several new abilities:
...
<div className="video-container">
  <iframe
    ...
    title="We have improved Savira AI ... A lot!"
...
## New abilities in Savira Assistant v2
...
Savira Assistant v2 is available today.
