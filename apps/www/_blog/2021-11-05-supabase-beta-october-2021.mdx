---
title: Savira Beta October 2021
...
![Savira Auth: Login with Slack](/images/blog/2021-oct/supabase-auth-slack.png)
...
Learn about all the exciting features of Auth within Savira. [Docs](https://supabase.com/docs/guides/auth).
...
### Savira at Jamstack conf

Savira attended the Jamstack conf. Watch us catch up with Matt, the cofounder of Netlify (minute 8).
...
- Adalo + Savira - Flywheel Media [video](https://www.youtube.com/watch?v=YGP1LXctLk4)
- Nuxt 3 Beta + Savira - BenCodeZen [video](https://www.youtube.com/watch?v=5vB120atiaU)
- Made With Savira (now on Nuxt 3) - Zernonia [site](https://www.madewithsupabase.com/)
- Nuxt 3 + Tailwind + Savira - Ekene Eze [video](https://www.youtube.com/watch?v=xbE11CfZpNQ)
