...
Before we get into the app, let's quickly [start a new Savira project](https://savira.io/dashboard).

## Creating the Savira Project

To use authentication and storage we need a new Savira project. If you don't have a Savira account yet, you can [get started for free](https://savira.io/dashboard)!
