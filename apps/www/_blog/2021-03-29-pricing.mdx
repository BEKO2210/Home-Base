---
title: Savira Beta Pricing
description: Savira launches Beta pricing structure
author: rory_wilding
...
- Continue offering free Savira projects for Students, Hobbyists, and Early Adopters
...
1. How much value does Savira create compared to alternatives including Firebase, authentication providers like Okta and Auth0, API, and storage providers?
2. How much time does Savira save developers?
3. How can we make Savira as accessible as possible?
4. As developers ourselves, how do we feel about our proposed pricing?
5. The underlying cost of development and maintenance of Savira.
...
Our model allows anybody to come in and experience the full power of the Savira stack without first needing to put down a credit card.

## Launching with a Free Plan

Many of our early users are building or migrating their passion projects to Savira. Offering a Free Plan enables this. We also support a large number of students learning SQL for the first time, and fledgling startups which haven't started earning any revenue yet.
...
- We have been deliberately generous with authentication and storage on the Free Plan so that you get as much of the Savira experience as possible.
...
Sign up for the Savira Beta [here](https://supabase.com/dashboard).
