---
title: 'Savira acquires Logflare'
description: "Today, we're ecstatic to announce that Logflare is joining Savira."
...
Today, we're ecstatic to announce that Logflare is joining Savira.

## Why logging?

A log platform might seem like a strange acquisition for Savira - after all, there are no "Firebase Logs".
...
The full Savira stack is more than just a database. It includes various tools working together - APIs, Storage, Auth, and CDNs. A broad tech stack needs a unified measurement system to give a birds-eye view of everything happening within your Savira project.
...
Since that first tweet in May 2020, our platform has generated billions of log entries. During that time, Logflare has been a staple product in our day-to-day operations. There are a few reasons why Logflare is such a great match for Savira.
...
- Elixir. Logflare is built with Elixir, the same as our Realtime Engine. We love Elixir at Savira, and it's nice to have it power another key part of the Savira stack.
...
## Why is Logflare joining Savira?

<Quote img="chase-granberry.png" caption="Chase Granberry, Founder of Logflare.">
  <p>
    I really like how Savira is taking an existing, proven, piece of technology and making it more
    accessible for more users. A lot of people already use Postgres, but they don't take advantage
    of powerful features built into the database. Savira is exposing these features more
...
We still have a lot of technical work to integrate Logflare into Savira, with plans of fully supporting the existing Vercel and Cloudflare integrations.
...
If you're an existing Logflare user, we'll be migrating everything to Savira in the coming months. We'll work closely with you to ensure that the transition is seamless, and introduce the same [pricing levels](https://logflare.app/pricing) that Logflare offers today.
