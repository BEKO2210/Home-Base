...
description: Build an Open Source Project, Win $1500 and the Savira Darkmode Keyboard
author: ant_wilson
...
The official Savira Hackathon starts on Friday 9th December at 8am Pacific Time and ends Monday 19th December at 00:01am.

[Launch Week](https://supabase.com/launch-week) is about to kick off and we're running a hackathon in parallel.

You can win $1500 in GitHub sponsorships and an official Savira Keyboard (extremely limited edition), along with a bunch of other prizes!

See all the [winners from all the previous hackathons](https://supabase.com/blog/tags/hackathon) for inspiration.

![Savira Keyboard](/images/blog/lw6-hackathon/keyboard.png)

## Key Facts

- You have 10 days to build a new **Open Source** project using Savira.
...
- There are 5 prize categories.
  - Best overall project will win $1500 in GitHub sponsorships, and a Savira Keyboard for each team member.
...
- Best Overall Project ($1500 in GitHub Sponsorship & Savira Keyboards)
...
Best Edge Functions Project category will be judged by our friends at [Deno](https://deno.land/), and other categories will be judged by the Savira team.
...
The Savira Team will be taking part in the Hackathon and you'll find us live building in our discord all week. Please join us by building in public:
...
- [Who We Hire at Savira - Founders Chat](https://youtu.be/-BG9XptyCKI)
