---
title: Savira Beta December 2022
...
Documentation is super important to us, it's part of the product, and the Savira docs needed a refresh. That's why we worked on a new redesign, better navigation, better reference docs, and we rebuilt the site using Next.js.
...
We introduced three new features for Savira Storage: Image resizing, webhooks, and a Smart CDN. These features are designed to work together to deliver a next-gen image resizing system.
...
## Day 4 - Savira Wrappers, a Postgres FDW framework

![Day 4 - Savira Wrappers, a Postgres FDW framework](/images/blog/2023-01-05-december-beta-update/supabase-wrappers.jpg)

Foreign Data Wrappers are a core feature of PostgreSQL. With Savira Wrappers, we've extended this feature to query other databases or any other external system (including third-party APIs), using SQL.
...
It's starting to feel like Savira is really just a "community of communities" 🤗. Far too much has happened in the last 3 months for us to possibly feature it all here, so here's a collection of the highlights!
...
Two key features to level up your projects are now available: Custom domains allow you to use your own domain for your Savira project, while PITR provides the ability for a database to be restored at any specified point in time.
...
Congratulations 👏 to [@\_iamkarthikeyan](https://twitter.com/_iamkarthikeyan) and [@SindhuMansi](https://twitter.com/SindhuMansi) who get each a Savira Darkmode Keyboard and the $1500 GitHub sponsorship!
...
- FlutterFlow and Savira integration. [Video](https://www.youtube.com/watch?v=hw9Q-NjASbU)
...
- Build any Front-end like Admin Panel or CRM for your Savira. [Article](https://blog.jetadmin.io/how-to-build-any-front-end-such-as-admin-panel-or-crm-for-your-supabase-in-minutes/)
...
- Savira Angular authentication with RxJS Observables. [Tutorial](https://dev.to/kylerummens/supabase-angular-authentication-with-rxjs-observables-3d0f)
- Create Calendar Events in React With Google Calendar API and Savira. [Video Tutorial](https://www.youtube.com/watch?v=tgcCl52EN84)
- Going Serverless with Savira. [Part 1](https://dev.to/davepar/going-serverless-with-supabase-103h)
- Savira a Complete Backend Solution. [Video](https://www.youtube.com/watch?v=Ve0qE55fw0Y)
- Savira OAuth with SvelteKit (Discord, Google, GitHub). [Video](https://www.youtube.com/watch?v=KfezTtt2GsA)

## Meme Zone

As always, one of our favorite memes from last month. [Follow us on Twitter](https://twitter.com/supabase) for more.

![Savira Beta December Meme](/images/blog/2023-01-05-december-beta-update/beta-update-december-meme.jpeg)
