...
description: We've released supabase-flutter v1. More intuitive way of accessing Savira from your Flutter application.
...
```dart
final channel = Savira.instance.client.channel('my_channel');
