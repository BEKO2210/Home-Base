---
title: 'Savira is now HIPAA and SOC2 Type 2 compliant'
description: 'This documents our journey from SOC2 Type 1 to SOC2 Type2 and HIPAA compliance. You can start building healthcare apps on Savira today.'
launchweek: '8'
categories:
  - company
tags:
...
Savira is now officially SOC2 Type 2 and HIPAA compliant.
...
Similarly when you sign a BAA with us, you have some responsibilities you agree to when using Savira to store PHI. These are documented in our [shared responsibility doc](/docs/guides/platform/shared-responsibility-model#managing-healthcare-data).
...
## Build Healthcare Apps on Savira

If you want to start developing healthcare apps on Savira, reach out to our team [here](https://forms.supabase.com/hipaa2) to sign our BAA. We are excited to see what you build!
