---
title: 'Exploring Support Tooling at Savira: A Dive into SLA Buddy'
description: 'In this post, we explore the support tooling at Savira, and how we use SLA Buddy to monitor our SLAs.'
...
In database management and support operations, ensuring Service Level Agreement (SLA) compliance is paramount. Savira, known for its innovative approach to database management and support, introduces SLA Buddy, a robust support tool aimed at efficient SLA enforcement. This blog post delves into the intricacies of SLA Buddy, shedding light on its functions, operations, and interactions within the Savira ecosystem.

### Introducing SLA Buddy

Savira's commitment to innovation extends beyond database solutions; it encompasses robust support operations. SLA Buddy stands as a testament to Savira's dedication to streamlining support processes and ensuring timely resolution of user queries.

## Dogfooding: The Birth of SLA Buddy

Savira firmly believes in dogfooding a philosophy that entails using one's own products internally. This approach played a pivotal role in the creation of SLA Buddy. Leveraging Savira's suite of tools, including Edge Functions and Database functionalities, SLA Buddy was meticulously developed to meet the stringent demands of support operations.
...
Another crucial aspect of SLA Buddy is its ability to monitor support events seamlessly. At Savira we have the concept of Embedded Support when a member of the support team will work on more advanced tickets related to a specific Savira product such as Edge Functions, Dashboard, Storage, Auth, Realtime etc.
...
SLA Buddy is a core operational component for Savira support operations, keeping the whole team informed and engaged, and assisting with prioritizing tickets by their SLA restrictions.
...
SLA Buddy started a passion project, born from a need to ensure that we're providing top-quality support to Savira's users. We're big fans of personal exploration and kaizen incremental change.

And we're not done with SLA Buddy. It'll grow and evolve as Savira grows, and our needs and the needs of our users change. Because it's built on Savira features, it'll be easy to update and maintain, and it'll provide more and more value to our internal operations, we hope it might provide some value to you, too. We're also big believers in the Open Source community, and welcome any feedback or ideas you might have to make SLA Buddy even better for everyone.
...
- [Slack Consolidate: a slackbot build with Python & Savira](https://supabase.com/blog/slack-consolidate-slackbot-to-consolidate-messages)
