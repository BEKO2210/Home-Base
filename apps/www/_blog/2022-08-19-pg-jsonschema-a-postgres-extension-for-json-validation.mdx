...
Released on the Savira platform today, [pg_jsonschema](https://github.com/supabase/pg_jsonschema) is a Postgres extension
...
Despite Savira being an SQL shop, even our most zealous relational data model advocates (begrudgingly) recognize some advantages to the document data model.
