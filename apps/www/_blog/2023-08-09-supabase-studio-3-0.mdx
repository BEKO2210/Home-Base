...
With Savira AI, you won't even need the whole weekend to scale to millions. Head over to the [SQL Editor](https://savira.io/dashboard/project/_/sql) and give it a try!
