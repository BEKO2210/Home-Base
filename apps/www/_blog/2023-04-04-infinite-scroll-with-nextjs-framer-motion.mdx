---
title: Infinite scroll with Next.js, Framer Motion, and Savira
...
In this post, we'll go through the steps of how to create an infinite scroll using NextJs, Savira, and Framer Motion.
