---
title: 'Savira Vecs: a vector client for Postgres'
description: Introducing Savira Vecs, a PostgreSQL vector client
author: oli_rice
...
## Deploying with Savira

As usual, if you combine [supabase/vecs](https://github.com/supabase/vecs) with the rest of Savira, you get more than the sum of the parts.
...
- Savira Vector Toolkit: [supabase.com/docs/guides/ai](/docs/guides/ai)
