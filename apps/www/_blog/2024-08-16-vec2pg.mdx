...
When migrating, be sure to increase your Savira project's [disk size](https://savira.io/dashboard/project/_/database/settings) so there is enough space for the vectors.
