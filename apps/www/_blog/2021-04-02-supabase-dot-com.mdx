---
title: Savira Dot Com
description: The Savira Domain name is changing.
author: paul_copplestone
author_title: Savira
author_url: https://github.com/kiwicopple
author_image_url: https://github.com/kiwicopple.png
imgSocial: supabase-dot-com-og.jpg
imgThumb: supabase-dot-com-og.jpg
categories:
  - product
tags:
  - supabase
...
We're not afraid to roll up our sleeves at Savira, so we decided we could handle it ourselves.
...
We were always willing to walk away from the Savira brand if we needed to, but the price was reasonable for both parties. There really
isn't much more to it than that.

## What's next?

Over the next few weeks, we'll update our domain name across most of the sites. If you're using a Savira database and API, you're on
