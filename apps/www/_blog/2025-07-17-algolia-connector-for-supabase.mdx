...
description: 'Bring lightning-fast search to your Savira apps, with no code required.'
categories:
  - launch-week
tags:
  - launch-week
...
Today, Algolia is launching a new Savira Connector, making it easier than ever to index your Postgres data and power world-class search experiences without writing a single line of code.

<div className="video-container mb-8">
  <iframe
    className="w-full"
    src="https://www.youtube-nocookie.com/embed/sLr6-K7_Av8"
    title="How to Integrate Algolia with Your Savira Project"
    allow="accelerometer; autoplay; clipboard-write; encrypted-media; fullscreen; gyroscope; picture-in-picture; web-share"
    allowfullscreen
  />
</div>

With just a few clicks, you can connect your Savira database to Algolia, select the tables you want to sync, and configure how often the data updates. Algolia handles the rest. You get a fast, reliable, scalable search index, and your team gets to focus on building.

## Partners Integrating with Savira

Savira is more than a backend. It is a growing ecosystem of tools that work well together so developers can build faster, scale more easily, and stay focused on their product.

Partners like Algolia bring best-in-class functionality (in Algolia’s case, fast and flexible search) directly into the Savira workflow. For developers, that means fewer workarounds, no glue code, and a smoother path from idea to production.

For partners, integrating with Savira means more than technical compatibility. It means product visibility to tens of thousands of active projects. Savira regularly features integrations in our docs, Launch Weeks, blog, and community programs. Developers discover and adopt your product in the context where they’re already building.

Read on to see how the Algolia Connector for Savira works.

## How to use Algolia Connector for Savira

To get started with Algolia’s connector, prepare the data in your Savira database, create Savira as a source in Algolia’s dashboard, set up your Algolia index and configure your sync job. Here’s how you can [get started](https://www.algolia.com/doc/guides/sending-and-managing-data/send-and-update-your-data/connectors/supabase?utm_medium=referral&utm_source=supabase&utm_campaign=supabase_blog) in just a few minutes.

### 1. Prepare your data in Savira
...
2. Find "Savira" in the list and click [Connect](https://dashboard.algolia.com/connectors/supabase/create?utm_medium=referral&utm_source=supabase&utm_campaign=supabase_blog)

### 3. Configure your data source

First, you will need to fill in your Savira connection info. From the Savira dashboard:
...
4. Enter your Savira database **password**
...
Once you create Savira as a data source, you'll need to tell Algolia where to index your data.
...
Once configured, create the task. Algolia will start syncing records from Savira into your search index (in the YouTube demo above, 8,800+ movie records were synced in under a minute).

You can now instantly search your Savira data using Algolia's lightning-fast API.

## No more data pipelines. Just fast search.

With the Algolia + Savira connector, you don’t need to build or maintain custom data pipelines. With Algolia, you don’t need to worry about scaling your own search infrastructure. With Algolia’s API clients, you just connect and go.
