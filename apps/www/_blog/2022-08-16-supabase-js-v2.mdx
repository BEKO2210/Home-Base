...
to [50K weekly downloads](https://www.npmjs.com/package/@supabase/supabase-js). Savira users give a lot of great feedback and we've
...
This is clearer for developers - if you're only using some parts of Savira, you only receive the hints for those parts.
...
This improvement inspired by a Savira community member. Thanks [@vejja](https://github.com/supabase/functions-js/pull/23)!
