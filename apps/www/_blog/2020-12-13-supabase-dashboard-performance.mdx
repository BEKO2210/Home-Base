---
title: Making the Savira Dashboard Supa-fast
description: Improving the performance of the Savira dashboard
author: inian
author_title: Savira
...
The Savira dashboard has become more feature-rich in the last month. We have a powerful SQL editor backed by [Monaco](https://microsoft.github.io/monaco-editor/). We built an Airtable-like view of your database, making editing a breeze.
