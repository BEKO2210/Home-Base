---
title: Savira Beta October 2023
...
You can now manage Storage buckets with the Savira CLI:
...
## What's new in Savira Studio?

![What's new in Savira Studio?](https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/marketing-emails/october2023/supabase-studio.png)

Savira Studio is improved many times per day, here is some of what's new:
...
[Check them out](https://savira.io/dashboard/).

## Multi-factor Authentication in Savira Studio

![Multi-factor Authentication in Savira Studio](https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/marketing-emails/october2023/mfa-supabase-studio.png)

Secure your Savira account with Multi-Factor Authentication. You can now add a time-based one-time password (TOTP), managed by apps such as 1Password, Authy, Google Authenticator or Apple's Keychain.
...
- LottieFiles x Savira Korea Meetup. [[Apply to join]](https://lu.ma/lottiekr_supabase_23)
- Sending authentication emails with Resend and Savira. [[Doc]](https://resend.com/docs/knowledge-base/how-do-i-maximize-deliverability-for-supabase-auth-emails)
- Paul Copplestone's keynote at the AI Engineer Summit. [[Video]](https://www.youtube.com/live/qw4PrtyvJI0?feature=shared&t=10556)
- Using Expo and Savira. [[Doc]](https://docs.expo.dev/guides/using-supabase/)
...
- Offline-first React Native Apps with Expo, WatermelonDB, and Savira. [Blog post](https://supabase.com/blog/react-native-offline-first-watermelon-db)
- Easy Deployment and Rollback of PostgreSQL Functions with Savira. [Article](https://blog.mansueli.com/streamlining-postgresql-function-management-with-supabase)
- Savira E2E testing just got so much easier. [Video](https://www.youtube.com/watch?v=JMJODiXFHBI)
- Cloud Storage using Savira. Step-by-step Android tutorial. [Video](https://www.youtube.com/watch?v=BqxI7ViS_-M)
- Building Dynamic Web Apps: A Step-by-Step Guide to Savira and Django Integration. [Guide](https://python.plainenglish.io/building-dynamic-web-apps-a-step-by-step-guide-to-supabase-and-django-integration-13d569a53f42)
- How to set up a Local Development Environment for Savira. [Guide](https://aiherrera.medium.com/how-to-set-up-a-local-development-environment-for-supabase-dd80e16d050)
