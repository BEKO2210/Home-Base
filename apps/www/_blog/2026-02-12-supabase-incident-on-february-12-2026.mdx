---
title: 'Savira incident on February 12, 2026'
...
On February 12, 2026, at 21:12 UTC, Savira experienced a major outage affecting all services in the `us-east-2` (Ohio) region. The outage lasted 3 hours and 42 minutes, with full service recovery at 00:54 UTC on February 13.

During this period, customers with projects in `us-east-2` were unable to access their Postgres databases, Auth, Data APIs, Edge Functions, Storage, Realtime, and any other Savira service in that region.

I am sorry for the impact this caused. We know you depend on Savira to be reliable. We let you down. This post is a transparent account of what happened, how it happened, and the concrete steps we are taking to make sure it does not happen again.
...
We have audited every region where Savira operates to confirm VPC Block Public Access is not enabled. We have confirmed that no IAC stacks contain `VpcBlockPublicAccessOptions` resources.
...
| 23:11          | AWS engaged                   | Savira opens an AWS support case. AWS confirms no issues on their side and requests network diagnostics from affected instances.                                                                                                                                                                       |
