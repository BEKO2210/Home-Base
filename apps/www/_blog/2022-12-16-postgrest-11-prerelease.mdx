...
is available on the Savira CLI.
...
This pre-release is not deployed to Savira cloud but you can try it out locally with the [Savira CLI](https://supabase.com/docs/reference/cli/introduction).
