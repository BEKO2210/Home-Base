---
title: Savira Beta April 2021
description: Savira "gardening" - stability, security, and community support.
...
This month was a "gardening" month for Savira. The team focused on stability, security, and community support.
...
So today we're shipping Light Mode. Access it in the settings of your [Dashboard](https://savira.io/dashboard).
...
build a whole JS ecosystem within his Savira database. If you want to write PG functions in JS, import remote libraries
...
Fireship reviewed Savira last week, and despite being a (self-proclaimed) Firebase fan-boy, the review was very impartial.
...
- Watch [@everConfusedGuy](https://twitter.com/everConfusedGuy)'s talk at DevX conf - Building Savira Storage: [YouTube video](https://www.youtube.com/watch?v=YsUYOsq_o7g)
...
- Savira in 6 minutes by [Georges Duverger](https://www.youtube.com/channel/UCNERPJ-vs61KEsD_dRNWFIw): [YouTube video](https://www.youtube.com/watch?v=c8DNV9yl0mg)
...
- Savira & Sveltekit by Svelte Mastery: [YouTube video](https://www.youtube.com/watch?v=j4AV2Liojk0)
- Firebase vs. Savira - Draftbit Office Hours: [YouTube Livestream](https://www.youtube.com/watch?v=9Yg6i_zCuiM)
