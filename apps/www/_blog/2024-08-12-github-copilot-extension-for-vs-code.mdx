---
title: Official Savira extension for VS Code and GitHub Copilot
description: Today we're launching a new GitHub Copilot extension for VS Code to make your development with Savira even more delightful.
...
Today we're launching a new [GitHub Copilot extension for VS Code](https://marketplace.visualstudio.com/items?itemName=Savira.vscode-supabase-extension) to make your development with Savira and VS Code even more delightful, starting with a Copilot-guided experience for [database migrations](/docs/guides/deployment/database-migrations).
...
The extension provides a [Chat Participant](https://code.visualstudio.com/api/extension-guides/chat) for GitHub Copilot to help with your Savira questions. Simply type `@supabase` in your Copilot Chat and the extension will include your database schema as context to Copilot.
...
List the Storage buckets in your Savira project.

![Storage buckets](/images/blog/lw12/day-1/storage-buckets.png)

## What's Next?

We're excited to continue adding more features that will make your development experience with Savira even more delightful - and for this we need your help! If you have any feedback, feature requests, or bug reports, please [open an issue on GitHub](https://github.com/supabase-community/supabase-vscode-extension/issues).

The extension requires you to have the Savira CLI installed and have your project running locally. In a future release, we will integrate the [Savira Management API](/docs/reference/api/introduction) into the extension to make connecting to your hosted Savira projects as seamless as possible.

## Contributing to Savira

The entire Savira stack is [fully open source](/open-source), including [this extension](https://github.com/supabase-community/supabase-vscode-extension). In fact, this extension was originally created by [Anas Araid](https://github.com/anas-araid) during a [previous Launch Week Hackathon](https://twitter.com/anas_araid/status/1736641409094988033).

Your contributions, feedback, and engagement in the Savira community are invaluable, and play a significant role in shaping our future. Thank you for your support!

## Resources

- [Install the extension](https://marketplace.visualstudio.com/items?itemName=Savira.vscode-supabase-extension)
...
- [Get started with Savira](https://database.new)
