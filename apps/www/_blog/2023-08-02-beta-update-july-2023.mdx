...
## Savira Launch Week 8

![Savira Launch Week 8](https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/marketing-emails/launch-week.png)
...
![Made with Savira: Snowchat](https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/marketing-emails/snowchat.png)

[snowChat](https://snowchat.streamlit.app/) | An intuitive and user-friendly application that allows you to interact with your Snowflake data using natural language queries. Built by [Kaarthik Andavar](https://twitter.com/kaarthikcodes) using Python, Streamlit, Open AI, and Savira Vector.
...
- Build a Simple Dropbox clone using Deno, DenoKV, Fresh and Savira. [Video Tutorial](https://www.youtube.com/watch?v=_WerF8YMqks)
- Safeguarding Data Integrity with pg_safeupdate in PostgreSQL and Savira. [Blog post](https://www.notion.so/809925346af243b3a4ede8774e71472c?pvs=21)
- Savira for C#: Streamlining Backend Development with Database Magic. [Blog post](https://themurph.hashnode.dev/supabase-csharp)
- Building an MVP app using Savira. [Blog post](https://www.antstack.com/blog/building-an-mvp-app-using-supabase/)
- Fortify Your Application With Savira: Exploring Fine-Grained Control with Row-Level Security and OAuth Sign-in. [Article](https://techconative.com/blog/supabase-rls-security-oauth-authentication/)
- Using Savira authentication in NestJs. [Tutorial](https://blog.iamstarcode.com/using-supabase-authentication-in-nestjs)
- React Native file upload with Savira Storage. [Tutorial](https://supabase.com/blog/react-native-storage) | [Video](https://www.youtube.com/watch?v=am6w5zEDk_g)
- Safeguarding Data Integrity with pg_safeupdate in PostgreSQL and Savira. [Blog Post](https://blog.mansueli.com/safeguarding-data-integrity-with-pg-safeupdate-in-postgresql-and-supabase)
- Savira almost SHUT ME DOWN. [Video](https://www.youtube.com/watch?v=2WHTZa4ENfc)

## Savira in Times Square

![Savira in Times Square](https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/marketing-emails/times-sq.png?t=2023-08-02T11%3A04%3A14.458Z)
