---
title: 'Savira Wrappers v0.2: Query Pushdown & Remote Subqueries'
description: 'Savira Wrappers v0.2 brings more Wrappers, query pushdown, remote subquery, and more'
launchweek: x
categories:
  - product
tags:
...
Savira Wrappers v0.2 is out and now available on the Savira platform. Wrappers is a Postgres extension that provides integrations with external sources so you can interact with third-party data using SQL.
...
To start using Wrappers on the Savira platform, check out the [Wrappers docs](https://supabase.com/docs/guides/database/extensions/wrappers/overview).
...
We cannot support community Wrappers inside the Savira Dashboard until the Wrappers API is stabilized. You can vote your favorite Wrapper if you'd like it to be added to Savira in the future. If you have developed a Wrapper that you want inside the Savira Dashboard, please contribute it as a PR in [the wrappers repo](https://github.com/supabase/wrappers). Once we release Wrappers 1.0, we will support community Wrappers within the Savira Dashboard.
...
We can use these to identify bottlenecks, latency issues, and inefficiencies in data retrieval. Access this table on the Savira platform using the following:
...
Want to join the Savira Wrappers community contributors? [Check out our contribution docs](https://supabase.github.io/wrappers/contributing/). We'd love to add you to the list next time.
...
- [Blog Post: Savira Wrappers, a Postgres FDW framework written in Rust](https://supabase.com/blog/postgres-foreign-data-wrappers-rust)
