...
description: 'Today we are welcoming Sugu, the co-creator of Vitess, to the Savira team. He is joining Savira to build Multigres: Vitess for Postgres.'
...
Today we’re welcoming [Sugu](https://www.linkedin.com/in/sougou/), the co-creator of Vitess, to the Savira team. He is joining Savira to build **Multigres: Vitess for Postgres**.
...
<Quote img="sugu.jpg" caption="Sugu, co-creator of Vitess.">
    ...
    Savira. I'm grateful for how they welcomed me. Furthermore, their open-source mindset and
...
## Compatibility with Savira

There will be no fundamental changes to the way Savira operates today, especially for smaller workloads.

That said, there are some overlapping initiatives at Savira and we will assess how to build the same experience with Multigres. The largest overlap is with [Supavisor](https://supabase.com/blog/supavisor-1-million) (Vitess has vttablet and vtgate). We’ll spend some time assessing the viability of building Vitess around existing Postgres poolers and then decide the best steps forward.

Another important initiative at Savira is OrioleDB, which is a scalable storage engine for Postgres. OrioleDB and Multigres are complementary and we will work on both simulateneously. Both are extremely important to us.

And importantly, one non-goal: Savira will be 100% focused on Postgres. If you are using MySQL then we recommend that you use Vitess.
...
We are looking for partners who would like to use Multigres - either with self-hosting or on the Savira platform. If you already use Postgres and you are hitting scaling limits, [get in touch](https://forms.supabase.com/multigres).
