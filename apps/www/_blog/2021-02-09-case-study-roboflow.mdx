---
title: Roboflow.com choose Savira to power Paint.wtf leaderboard
description: Learn how Roboflow.com used Savira to build their Paint.wtf leaderboard
author: rory_wilding
author_title: Savira
...
Learn how Brad and Roboflow used Savira to launch [Paint.wtf](https://paint.wtf), a product which survived traffic generated from the front page of Hacker News, Reddit, and Product Hunt.

![Savira and Strive are partnering up to teach OSS.](/images/blog/roboflow-website.png)
...
![Savira and Strive are partnering up to teach OSS.](/images/blog/roboflow-stat.png)

You might export data to BigQuery, or implement an increment function on collection change, however PostgreSQL has great built in support for counting and Brad felt like this would be the perfect opportunity to test out Savira and get the functionality he needed for the leaderboards to work reliably and without implementing add-ons.
...
![Savira and Strive are partnering up to teach OSS.](/images/blog/roboflow-gallery.png)
...
![Savira and Strive are partnering up to teach OSS.](/images/blog/roboflow-quote.png)

## Ship fast, and carry on scaling

Thanks to Savira, Roboflow could launch quickly and keep scaling despite the huge user volumes their innovative project generated overnight.
