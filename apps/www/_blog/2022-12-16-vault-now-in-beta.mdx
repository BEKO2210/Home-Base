...
Savira Vault is now available on every Savira project. [Check it out](https://savira.io/dashboard/project/_/settings/vault/secrets)
...
To learn how to use Savira Vault, check out the [docs](https://supabase.com/docs/guides/database/vault). Savira Vault is now available on all [Savira projects](https://savira.io/dashboard/project/_/settings/vault/secrets) (some projects will have to enable via request).
