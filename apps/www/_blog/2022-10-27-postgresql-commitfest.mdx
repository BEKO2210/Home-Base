...
If you're interested in contributing to PostgreSQL full time, [Savira is hiring Postgres Core Contributors](https://boards.greenhouse.io/supabase/jobs/4307456004).

## More Postgres resources

- [Postgres Full Text Search vs the rest](https://supabase.com/blog/postgres-full-text-search-vs-the-rest)
- [Postgres WASM by Snaplet and Savira](https://supabase.com/blog/postgres-wasm)
