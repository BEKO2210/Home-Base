---
title: Savira Alpha November 2020
...
We added a [Status Page](https://status.supabase.com/) which tracks the uptime and latency of the Savira platform.
...
- We have an exciting Vercel x Stripe x Savira [collaboration underway](https://twitter.com/rauchg/status/1331021818681978881).
...
- [@duncanhealy](https://github.com/duncanhealy) is [updating the Redwood example](https://github.com/redwoodjs/redwood/pull/1474) to work with Savira.js v1.0
