...
<Img
  ...
  alt="Example of Realtime architecture where a customer from CA will connect to the server closest to them and their Savira instance"
/>
...
- [Video - Listening to real-time changes on the database with Flutter and Savira](https://www.youtube.com/watch?v=gboTC2lcgzw)
