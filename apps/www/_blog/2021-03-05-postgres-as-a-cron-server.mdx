...
Is Postgres the best place to put your cron jobs? `¯\_(ツ)_/¯`. Postgres databases are free on Savira and since it takes only one minute to [get started](https://savira.io/dashboard/), why not make your next cron server a Postgres database?
