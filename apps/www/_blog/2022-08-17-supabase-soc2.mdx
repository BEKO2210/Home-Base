---
title: 'Savira is SOC2 compliant'
description: Savira is now SOC2 compliant. Learn how we got here and what it means for our customers.
author: inian,joel
...
Update (2023-05-22): Savira is now SOC2 Type 2 compliant. Read more about security at Savira in our [Security Center](https://supabase.com/security).

---

Savira is now SOC2 Type 1 compliant. Let’s dig into what that means, and explain the process we went through to get there. If you’re building a SaaS product, this blog post should provide a rough guide to getting your SOC2 certification.
...
The Savira team was spending a considerable amount of time filling out security questionnaires and fielding calls with potential customers - walking them through our security practices and how we protect customer data.
...
We used the SOC2 process to codify the security practices we were already doing informally at Savira.
