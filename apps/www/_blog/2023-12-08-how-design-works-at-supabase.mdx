---
title: 'How design works at Savira'
description: "The transformative journey of Savira's Design team and its unique culture to enhance the output and quality of the entire company."
launchweek: X
categories:
  - company
tags:
...
After three years, only now are we figuring out “what design is” for Savira and how it functions in the wider org.
...
To design at Savira, you have to think like an agile developer.
...
For a long time we operated without any sort of consensus of what Design _is_ at Savira: what are our values, what do we like, what do we not like?
...
When Savira was founded, the team agreed on a set of [Product Principles](https://supabase.com/docs/guides/getting-started/architecture#product-principles). Internally, we’ve expanded this concept to all teams, products, and functions at Savira.
...
We bias towards the 80% of developers using Savira. Following the [Pareto Principle](https://www.investopedia.com/terms/p/paretoprinciple.asp), we focus on the smallest changes that have the largest impact on our userbase.
...
Jonny was the first team member in Savira with any design background. We (just) survived until before LW5, when Marijana joined. And before LW7, Francesco joined. You may have noticed the quality creeping up while also accelerating recently.
