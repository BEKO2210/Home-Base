...
By now you probably know the drill. Savira Launch Week: we launch one thing, or sometimes a couple,
...
[GraphQL is now available in Savira!](/blog/graphql-now-available)
...
[Introducing Savira Enterprise](/blog/supabase-enterprise).
...
[Edge Functions are now available in Savira](/blog/supabase-edge-functions)
...
- [Savira Realtime, with Multiplayer Features](/blog/supabase-realtime-with-multiplayer-features)
...
As always, you'll have the chance to win extremely limited Savira Swag,
