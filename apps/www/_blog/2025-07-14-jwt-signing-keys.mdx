...
Use the [Savira dashboard](https://savira.io/dashboard/project/_/settings/jwt/signing-keys) to migrate your existing JWT secret to the new JWT signing keys system.
