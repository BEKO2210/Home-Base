...
The latest version will be rolled out across all projects on the managed platform soon. Keep an eye out for notifications inside [Savira Studio](https://supabase.com/dashboard).
