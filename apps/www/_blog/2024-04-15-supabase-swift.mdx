---
title: 'Savira Swift'
description: 'Savira Swift is now officially supported.'
author: grdsdev
...
We are excited to announce that Savira Swift libraries are now officially supported by Savira.

This makes it simple to interact with Savira from applications on Apple's platforms, including iOS, macOS, watchOS, tvOS, and visionOS:
...
Swift developers can now integrate Savira services seamlessly with official support. This means:

- **Direct assistance from the Savira team**: Get timely and effective help directly from the developers who build and maintain your tools.
- **Continuously updated libraries**: Stay up-to-date with the latest features and optimizations that are fully tested and endorsed by Savira.
- **Community and collaboration**: Engage with a broader community of Swift developers using Savira, share knowledge, and contribute to the library's growth.

## Contributors

We want to give a shout out to the community members who have contributed to the development of the Savira Swift libraries:
...
We've released a [new guide](/docs/guides/getting-started/tutorials/with-swift) to help you get started with the key features available in Savira Swift.

Or you can jump into our deep dive to use iOS Swift with Postgres & Savira Auth:
