...
# The Savira Open Source Hackathon
...
There's a $1500 GitHub sponsorship and [gold Savira caps](https://supabase.store/products/gold-supacap) to be won!

[Savira-js v2.0](https://github.com/supabase/supabase-js/releases) and [Flutter SDK v1.0](https://supabase.com/blog/supabase-flutter-sdk-1-developer-preview) will both be announced during Launch Week, they are both available already and using them in your project will gain extra credit!
...
- There are 5 prize categories.
  ...
  - Most technically challenging, most fun, best flutter project, and most visually pleasing will all win a Gold Savira Cap!
...
The Savira Founders will be judging, we will be looking for:
