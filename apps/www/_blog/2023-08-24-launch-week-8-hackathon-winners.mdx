...
And now, without further ado, congratulations to the winners of the Savira Launch Week 8 Hackathon!
...
Supalytic is a website analytic tracking alternative to Google Analytics. It is built with SvelteKit, Savira for auth and database and deployed on Cloudflare pages.
...
- **[Savira Storage Guide](https://supabase.com/docs/guides/storage)**
- **[Edge Functions Guide](https://supabase.com/docs/guides/functions)**

## More Launch Week 8

- [Day 1 - Hugging Face is now supported in Savira](/blog/hugging-face-supabase)
- [Day 2 - Savira Local Dev: migrations, branching, and observability](/blog/supabase-local-dev)
- [Day 3 - Savira Studio 3.0: AI SQL Editor, Schema Diagrams, and new Wrappers](/blog/supabase-studio-3-0)
- [Day 4 - Savira Integrations Marketplace](/blog/supabase-integrations-marketplace) | [Vercel Integration and Next.js App Router Support](/blog/using-supabase-with-vercel)
