---
title: Savira Beta December 2023
...
## Day 1 - Savira Studio: AI Assistant and User Impersonation

![Day 1 - Savira Studio: AI Assistant and User Impersonation](https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/marketing-emails/dec2023/lw-digest-1.png)

Savira Studio received a major update that reflects our commitment to a SQL-first approach and user-centric development. Awesome features like easy RLS policies with an AI assistant, Postgres Roles, User Impersonation, and much more.
...
## Day 3 - Savira Branching

![Day 3 - Savira Branching](https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/marketing-emails/dec2023/lw-digest-3.png)
...
## Day 4 - Savira Auth: Identity Linking, Hooks, and HaveIBeenPwned integration

![Day 4 - Savira Auth: Identity Linking, Hooks, and HaveIBeenPwned integration](https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/marketing-emails/dec2023/lw-digest-4.png)

We announced several new features for Savira Auth: Identity Linking, Session Control, Leaked Password Protection, and Auth Hooks with Postgres functions.
...
In the end, we chose [Supafork](https://github.com/chroxify/supafork) as the winner of the Best Overall project 👏. Created by [Christo](https://twitter.com/0xChroxify), SupaFork is inspired by Vercel's Deploy button and it allows an easier setup for self-hosted apps using Savira.
...
- [Fly Postgres, managed by Savira](https://supabase.com/blog/postgres-on-fly-by-supabase)
- [Savira Libraries V2: Python, Swift, Kotlin, Flutter, and Typescript](https://supabase.com/blog/client-libraries-v2)
...
- [Savira Grafana](https://github.com/supabase/supabase-grafana)
- [Savira Wrappers v0.2: Query Pushdown & Remote Subqueries](https://supabase.com/blog/supabase-wrappers-v02)
...
- [The Savira Album](https://www.youtube.com/watch?v=r1POD-IdG-I)
- [How design works at Savira](https://supabase.com/blog/how-design-works-at-supabase)
...
- Savira Security with our Head of Product and Engineering. [[Podcast](https://softwareengineeringdaily.com/2023/12/20/supabase-security-with-inian-parameshwaran/)]
- Creating a RAG chatbot with Savira, OpenAI, Python & Langchain. [[Tutorial](https://ayeshasahar.hashnode.dev/creating-a-rag-chatbot-with-supabase-openai-python-langchain)]
- Building an AI powered WebGL experience with Savira and React Three Fiber. [[Tutorial](https://dev.to/laznic/building-an-ai-powered-webgl-experience-with-supabase-and-react-three-fiber-3dfn)]
- Connect your Streamlit apps to Savira. [[Tutorial](https://blog.streamlit.io/connect-your-streamlit-apps-to-supabase/)]
- Your Complete Guide To Next.js Authentication With Savira. [[Video](https://www.youtube.com/watch?v=dhXjHGklaZc)]
- Savira Launch Week X with Jon Meyers. [[Podcast](https://podrocket.logrocket.com/supabase-launch-week-x-jon-meyers)]
- Integrating Comments in a Next.js Blog with Savira and Slack. [[Article](https://prismic.io/blog/nextjs-supabase-tutorial)]
- Exploring Savira Realtime By Building a Game. [[Tutorial](https://www.aleksandra.codes/supabase-game)]
- The Commit Podcast, Ep 3 - Savira, Postgres, AI, and Launch Weeks with Paul Copplestone. [[Podcast](https://www.youtube.com/watch?v=hLaKO1MIhNI)]
- Logging with Python and Savira: A Practical Guide. [[Article](https://medium.com/@goncalo.baiao/logging-with-python-and-supabase-a-practical-guide-6b541c453073)]
- How I build my real-time voting app with Next.js and Savira ⚡️. [[Video](https://www.youtube.com/watch?v=syrjdkU5POo)]
- Multi-User Note App with Savira Realtime. [[Article](https://blog.kirillinoz.com/multi-user-note-app-with-supabase-realtime)]
