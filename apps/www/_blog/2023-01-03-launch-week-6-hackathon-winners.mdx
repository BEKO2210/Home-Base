...
And now, without further ado, congratulations to the winners of Savira Launch Week 6 Hackathon!
...
supabase-js-rs is a rust bindings for Savira JavaScript library via WebAssembly. You can import it in your Rust WASM project to interact with Savira.
...
As promised in the [hackathon announcement article](https://supabase.com/blog/launch-week-6-hackathon) the winners of the Best overall project will be granted the extremely limited edition Savira Darkmode Keyboard!
