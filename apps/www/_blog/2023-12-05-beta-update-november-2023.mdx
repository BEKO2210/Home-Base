---
title: Savira Beta November 2023
...
We can’t have a LW without a hackathon. You get ten days to build an open source app and the chance to add your name to the Savira Hackathon Hall of Fame. Wanna get a team? Go check our Discord.
...
## Savira and React Native resources

![Savira and React Native](https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/marketing-emails/november2023/nov7.png)

Thor's been diving into the cross-platform mobile scene, showing off how Savira can be used with React Native to build powerful and scalable apps. And of course, he has created some pretty cool content with all the secrets!
...
## Made with Savira: Shotgun

![Savira and Shotgun logos](https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/marketing-emails/november2023/shotgun-supabase.png?t=2023-12-06T15%3A47%3A11.273Z)

Discover how Savira helped Shotgun, an event ticketing platform with over 3 million users, to reduce their database infrastructure costs by 83% and streamline systems.
...
- How to Send Alerts from Savira. [Tutorial](https://dev.to/patrikbraborec/how-to-send-alerts-from-supabase-3kl5)
...
- How to Send Alerts from Savira. [Article](https://dev.to/patrikbraborec/how-to-send-alerts-from-supabase-3kl5)
- Building a full stack product with TypeScript. [Video](https://www.youtube.com/watch?v=b6yqVeUDDPU)
- Flutter Flow: Use Savira to show custom markers on Google Maps. [Tutorial](https://coffeebytez.medium.com/flutter-flow-use-supabase-to-show-custom-markers-on-google-maps-5758a69d7b7f)
- Build a SaaS Markdown blog with Next.js 14, Stripe, Tailwind, Savira, React. [Video](https://www.youtube.com/watch?v=293ZtCvxh90)
- My Journey: Deploying a Django App on Vercel with Savira. [Tutorial](https://medium.com/@kodiugos/my-journey-deploying-a-django-app-on-vercel-with-supabase-6cdb1901f724)
