---
title: 'Savira Realtime: Broadcast and Presence Authorization'
...
For context, Savira includes three useful extensions for building real-time applications.
...
<div className="video-container">
  <iframe
    ...
    title="I leaked the data through Savira Realtime - Broadcast and Presence Authorization"
