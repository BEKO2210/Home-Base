...
You can check out these new features within your Savira project without having to perform a local installation.

Explore the [Savira dashboard now](https://supabase.com/dashboard) and get started with your new project.
