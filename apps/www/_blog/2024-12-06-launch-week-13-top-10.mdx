...
Savira Cron is a new Postgres module for creating and managing recurring tasks. It is deeply integrated with the rest of the Savira toolset.

[Read more →](/blog/supabase-cron)

## #2: Savira AI Assistant v2
...
"postgres.new" is now ["database.build"](https://database.build) and you can still run everything in your own browser. We've added 3 major features: Bring-your-own-LLM, Live Share, and they ability to deploy your [pglite](https://pglite.dev/) to Savira.
...
We're running a virtual hackathon starting **now** where you can win prizes for building the best projects using Savira. We'll be announcing the winners on December 15th.
