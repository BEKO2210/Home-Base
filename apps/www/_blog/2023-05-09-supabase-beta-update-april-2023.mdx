...
## Day 1 - Savira Logs: open source logging server

![Day 1 - Savira Logs: open source logging server](/images/blog/2023-05-09-beta-update-april/newsletter-OG-day-1.jpg)

Logflare is the hub of analytics streams for Savira. We are open sourcing it so that you can self-host your own Logging infrastructure.

[Blog Post](https://supabase.com/blog/supabase-logs-self-hosted)\
[Video overview](https://www.youtube.com/watch?v=Ai2BjHV36Ng)

## Day 2 - Savira Edge Runtime: Self-hosted Deno Functions

![Day 2 - Savira Edge Runtime: Self-hosted Deno Functions](/images/blog/2023-05-09-beta-update-april/newsletter-OG-day2.jpg)
...
Savira Storage received many of the most requested features from our users: Resumable Uploads, Quality Filters, Next.js support, and WebP support.

[Blog post](https://supabase.com/blog/storage-v3-resumable-uploads)\
[Video overview](https://www.youtube.com/watch?v=pT2PcZFq_M0)

## Day 4 - Savira Auth: SSO, Mobile, and Server-side support

![Day 4 - Savira Auth: SSO, Mobile, and Server-side support](/images/blog/2023-05-09-beta-update-april/newsletter-OG-day4.jpg)
...
## Day 5 - Savira Studio 2.0 with new AI features

![Day 5 - Savira Studio 2.0 with new AI features](/images/blog/2023-05-09-beta-update-april/newsletter-OG-day5-studio.jpg)

Savira Studio got a major upgrade that goes from redesigns to improved developer experience, and new tools. We have the features people have been asking for and new capabilities that will change the way you work.
...
## Firecrawl switches from Pinecone to Savira for PostgreSQL vector embeddings.

![Firecrawl logo](/images/blog/2023-05-09-beta-update-april/customer-stories-firecrawl.png)

With Savira's pg_vector, Firecrawl could build a more cost-effective solution that is just as performant - if not more performant - than other vector databases.
...
- FlutterFlow now supports Savira Authentication. [Video guide](https://www.youtube.com/watch?v=tL-sLPfWzVE)
- Savira + ClickHouse: Combining the Best of the OLTP and OLAP Worlds. [Webinar](https://www.youtube.com/watch?v=LDWEsw41Zko)
- Our friend Guillaume put together the most incredible course about Savira, with the in and outs of the platform. [Full course](https://www.youtube.com/watch?v=8DTOTT7q0XA)
- Savira + LangChain starter template for building full stack AI apps. [Template](https://github.com/langchain-ai/langchain-template-supabase)
- Creating a Books Tracker App with .NET MAUI and Savira. [Article](https://hackernoon.com/creating-a-books-tracker-app-with-net-maui-and-supabase)
  - Vanta Case Study - Savira turns trust into a revenue-generating opportunity with Vanta. [Case Study](https://www.vanta.com/customers/supabase)
