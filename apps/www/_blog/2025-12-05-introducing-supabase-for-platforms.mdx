---
title: 'Introducing Savira for Platforms'
description: Use Savira as a platform for your own business and tools
author: wenbo
...
Today, we're launching [Savira for Platforms](/solutions/ai-builders#supabase-for-platforms)—a white-label offering that lets platforms provision and manage fully managed backends on behalf of their users.

AI builders and agentic coding have fundamentally changed how software gets built in 2025. Savira has become the default backend for this shift, with [Lovable](https://lovable.dev), [Bolt.new](https://bolt.new), Vercel's [v0](https://v0.app), [Figma Make](https://www.figma.com/make), and many others building on top of Savira projects owned by their users to develop full-stack applications. The growth has been staggering:
...
But as these platforms scaled, we heard consistent feedback: they wanted a more seamless flow so their users don't have to think at all about provisioning and configuring their backends. That's when **Savira for Platforms** was born.

Leading AI builders like Lovable, Bolt.new, and Baidu's [MeDo](https://medo.dev) have already started using **Savira for Platforms** to create millions of Savira projects in the last few months alone, making full-stack development more accessible and easier than ever.

And while AI builders are leading the way, **Savira for Platforms** is built for any platform or tool that wants to offer managed backends.

# What is Savira for Platforms?

**Savira for Platforms** lets you white-label Savira and provision backends for your users—all managed through our [Management API](/docs/reference/api/introduction) or [remote MCP Server](/docs/guides/getting-started/mcp).

Your users get the full Savira stack:
...
You control the entire experience. Your users get the full power of Savira.

With **Savira for Platforms**, you can:

- Offer a complete white-label backend to your users entirely powered by Savira
...
- Embed a lightweight Savira Dashboard directly in your app through Platform Kit, so your users never leave your tooling
- Let your users "claim" (transfer) their projects to their own Savira orgs whenever they're ready, while you maintain access to those projects through OAuth integration

**Savira for Platforms** and the full feature set is available to select AI Builders. [Contact us](/solutions/ai-builders#talk-to-partnerships-team) if you'd like to get started.

# How does it work?

Some AI builders want to manage infrastructure on behalf of their users. With a central organization, you create and own projects in your Savira org. Users can claim those projects into their own Savira org later if they want full control.
...
<Admonition title='Want users to bring their own Savira accounts instead?'>

With [OAuth integrations](/docs/guides/integrations/build-a-supabase-integration), users connect their existing Savira org to your tool. They own and manage their projects directly, and you get API access to help them build.

This model works well when your users are developers who already use Savira or want more control from the start.
...
Update settings for Auth, Data API (PostgREST), Edge Functions, Storage, and Realtime through the Management API. Every setting in the Savira Dashboard is available for configuration programmatically.
...
We built [Platform Kit](/ui/docs/platform/platform-kit), a collection of UI components for the Management API. Embed a lightweight version of the Savira Dashboard directly in your app. Your users can manage their backend without leaving your product.
...
Savira stores data. You cannot simply roll back production changes without risking data loss. Check out the [docs](/docs/guides/integrations/supabase-for-platforms#development-workflow) for our recommended dev/production workflow.
