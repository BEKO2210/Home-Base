---
title: Savira.js 1.0
description: We're releasing a new version of our Savira client with some awesome new improvements.
...
- Better realtime scalability: we only generate one socket connection per Savira client. Previously we would create a connection for every subscription.
