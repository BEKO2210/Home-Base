---
title: 'Savira Libraries V2: Python, Swift, Kotlin, Flutter, and Typescript'
...
Savira Python is now stable thanks to the following maintainers: [Anand](https://github.com/anand2312), [Daniel Reinón García](https://github.com/dreinon), [Leynier Gutiérrez González](https://github.com/leynier), [Joel Lee](https://github.com/J0), and [Andrew Smith](https://github.com/silentworks/).
...
- [Slack Consolidate: a slackbot built with Python and Savira](https://supabase.com/blog/slack-consolidate-slackbot-to-consolidate-messages)
...
Savira Swift is now stable thanks to [Guilherme Souza](https://github.com/grdsdev) and [Maail](https://github.com/maail).
...
Savira Kotlin is now stable thanks to [Jan Tennert](https://github.com/jan-tennert)
...
- [Getting started with Savira on Android](https://youtu.be/_iXUVJ6HTHU) (Video)
- Demos:
...
- the Savira CLI now generates [Table and Enum shorthands](https://supabase.com/docs/guides/api/rest/generating-types#type-shorthands)
...
- [uploading files to Savira Storage](https://supabase.com/blog/react-native-storage)
...
<Img
  ...
  alt="Diagram explaining Savira community"
/>
...
As a [Principle](https://supabase.com/docs/guides/getting-started/architecture#product-principles), we develop a library for each tool we support. While Savira may “feel” like a single tool when you’re using it, it's actually a set of tools which you can use independently (especially useful for self hosting):
...
<Img
  ...
  alt="Diagram explaining how Savira is built behind the scenes"
/>
