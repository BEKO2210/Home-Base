---
title: 'Savira Open Source Hackathon 2024'
...
[To celebrate the Savira Special Announcement on April 15th](https://supabase.com/special-announcement) we're running a special 10 day open source hackathon.

The hackathon starts right now! (Friday 12th April at 09:00 am PT) and ends Sunday 21st April at 11:59 pm PT. You could win a set of Apple AirPods along with extremely limited edition Savira swag and add your name to the Savira Hackathon Hall of Fame.
...
- You have 10 days to build a new **Open Source** project using Savira in some capacity.
...
There will be a winner and a runner-up prize for each category. Every team member on winning/runner-up teams gets a Savira Launch Week swag kit.

![Savira Swag](/images/blog/oss-hackathon/prize.png)
...
The Savira team will judge the winners for each category.
...
### Savira resources to get you started
...
- [Savira Swift Client Library](https://supabase.com/docs/reference/swift/introduction)
- [Row Level Security in Savira](https://supabase.com/docs/guides/database/postgres/row-level-security)

### Community help

The Savira Team will be taking part in the Hackathon and you'll find us live to build in our discord all week. Please join us by building in public:
...
![Savira Discord Channel](/images/blog/lw7-hackathon/discord.png)
