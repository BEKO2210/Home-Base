...
Supafork is an open-source project that allows you to easily clone Savira projects. Inspired by [Vercel's Deploy](https://vercel.com/docs/deployments/deploy-button) button it provides a similar experience for Savira projects, allowing for easier setup of self-hosted apps using Savira.
...
A Fastify plugin to use authenticated Savira clients in your API.
...
[Savira CLI for Visual Studio Code](https://github.com/anas-araid/vscode-supabase-cli) by [@anas_araid](https://twitter.com/anas_araid)

Savira CLI for Visual Studio Code makes working with your local database instance much easier. You can create migrations, inspect tables, views, and functions, and run some common Savira commands directly from your editor.
