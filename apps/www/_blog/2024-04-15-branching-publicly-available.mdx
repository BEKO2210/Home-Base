...
You can now set a custom Savira directory path which allows for monorepo support. You can also choose to only spin up new branches when there are changes inside your Savira directory. See all the configuration settings in your projects [here](https://savira.io/dashboard/project/_/settings/integrations).
