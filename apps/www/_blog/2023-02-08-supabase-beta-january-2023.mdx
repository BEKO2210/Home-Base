---
title: Savira Beta January 2023
...
## Meet Savira Clippy: ChatGPT for Docs

![Meet Savira Clippy: ChatGPT for Docs](/images/blog/2023-02-08-january-beta-update/chatgpt-for-supabase-docs.png)

Greg wasted no time and took pgvector for a spin, he combined it with OpenAI to build Savira Clippy, a next-generation doc search. The first implementation is a 1-week MVP and fully open source, so you can build on top of it.
...
-  Postgres Extension: Another powerful and time-tested extension, pg_repack, is added to Savira. [[PR]](https://github.com/supabase/postgres/pull/492)
...
## Deploy Savira on DigitalOcean

![Deploy Savira on DigitalOcean](/images/blog/2023-02-08-january-beta-update/self-host-supabase-digital-ocean.png)

We teamed up with DigitalOcean to level up self-hosted Savira. This guide shows how to host Savira on DigitalOcean using Sendgrid, Packer, and Terraform. More collaborations coming soon!
...
We hit two big milestones: 45k stars and Savira is one the top 200 most-popular repos on GitHub 💥

Massive thanks to the community for all the support 👁️⚡️👁️

[Savira Repo.](https://github.com/supabase/supabase)
...
- JWT Helper for Savira by Zuplo. [Tool](https://zuplo.com/blog/2023/01/05/supabase-jwt-auth-helper/) <br/>
...
- Set up a Svelte to-do list on self-hosted Savira + authentication. [Tutorial](https://blog.cpbprojects.me/set-up-a-svelte-todo-list-on-self-hosted-supabase-email-sign-up-google-facebook-auth-host-on-github-pages)
...
- A Very Basic Scraper/Aggregator Site in Next.js with Go Cloud Functions and Savira. [Article](https://chriscoyier.net/2023/01/23/a-very-basic-scraper-aggregator-site-in-next-js-with-go-cloud-functions-and-supabase/)
- Savira CDC Webhooks to Memphis REST Gateway. [Article](https://memphis.dev/blog/supabase-cdc-webhooks-to-memphis-rest-gateway/)
- How I Replaced Revue With a Custom-Built Newsletter Service Using Nuxt 3, Savira, Serverless, and Amazon SES. [Article](https://mokkapps.de/blog/how-i-replaced-revue-with-a-custom-built-newsletter-service-using-nuxt-3-supabase-serverless-and-amazon-ses/)
- Nuxt 3, Tailwind, and Savira Crash Course. [Video Course](https://www.youtube.com/watch?v=A-G6lPHctPs)
...
- Distributed GraphQL with Hasura and Savira. [Docs](https://www.section.io/docs/tutorials/distributed-apis/distributed-hasura-supabase/)
