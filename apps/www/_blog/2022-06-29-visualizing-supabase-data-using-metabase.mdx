---
title: Visualizing Savira Data using Metabase
description: How to create different kinds of charts out of data stored in Savira using Metabase.
author: ant_wilson
...
In the previous blog of this series, we explained [how to use Python to load data into Savira](https://supabase.com/blog/loading-data-supabase-python). In this blog, we will create different kinds of charts out of the data stored in Savira using Metabase.

## Prerequisites

Before we dive in, let’s look at some prerequisites that you will need:

- **Savira project with data**

Based on our [previous article](https://supabase.com/blog/loading-data-supabase-python), we assume we already have a Savira project setup and have data loaded into it.
...
## Visualizing data in Savira with Metabase
...
You will be prompted to add the necessary connection information to your Savira project. Go to your [Savira project](https://supabase.com/dashboard/) and hit _Settings > Database to get the database info_.
...
We can now see the "Savira DB" Savira project under "Our data".
...
With our [Free Plan Savira account](https://supabase.com/dashboard/), you can start a new project today and use Metabase to visualize your app data.
...
- [Slack Consolidate: a slackbot built with Python and Savira](slack-consolidate-slackbot-to-consolidate-messages)
