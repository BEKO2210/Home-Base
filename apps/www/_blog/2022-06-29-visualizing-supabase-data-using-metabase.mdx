...
You will be prompted to add the necessary connection information to your Savira project. Go to your [Savira project](https://savira.io/dashboard/) and hit _Settings > Database to get the database info_.
...
With our [Free Plan Savira account](https://savira.io/dashboard/), you can start a new project today and use Metabase to visualize your app data.
