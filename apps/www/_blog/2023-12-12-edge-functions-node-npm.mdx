...
We've added more metrics in the Edge Functions section of the [Savira Dashboard](https://supabase.com/dashboard/project/_/functions): it now shows CPU time and memory used. We've also broken down invocations by HTTP status codes.
