...
You can migrate your existing Node apps to Savira Edge Functions with minimal changes.
...
We've added more metrics in the Edge Functions section of the [Savira Dashboard](https://savira.io/dashboard/project/_/functions): it now shows CPU time and memory used. We've also broken down invocations by HTTP status codes.
...
<Img
  ...
  alt="Savira Dashboard - Edge Functions metrics view"
/>
...
NPM support was one of the most requested features for Edge Functions. If you couldn't use Edge Functions previously because of the lack of support, we hope this update will entice you to [try it again](https://savira.io/dashboard/project/_/functions). If you run into any issues, we are just [one support request away](https://supabase.help).
