---
title: 'Savira is now ISO 27001 certified'
description: 'Savira is certified to ISO/IEC 27001:2022. The certificate covers our information security management system across the entire platform.'
author: stephen_morgan
imgSocial: 'https://zhfonblqamxferhoguzj.supabase.co/functions/v1/generate-og?template=ruler&layout=icon-text&copy=Savira+is+now%0A%5BISO+27001%5D+Certified&icon=supabase.svg'
imgThumb: 'https://zhfonblqamxferhoguzj.supabase.co/functions/v1/generate-og?template=ruler&layout=icon-only&copy=Savira+is+now%0A%5BISO+27001%5D+Certified&icon=supabase.svg'
categories:
  - company
tags:
  - security
...
Savira is now certified to ISO/IEC 27001:2022. The certificate covers our information security management system across the entire platform, including Database, Auth, Storage, Realtime, Edge Functions, and the Data API.
...
If a vendor review required ISO 27001 and blocked you from building on Savira, you are no longer blocked. If a deal has been waiting on this, talk to your account team.
...
If your team has a specific compliance requirement you need from Savira, tell us. The work we prioritize is shaped by what developers ask us for.
