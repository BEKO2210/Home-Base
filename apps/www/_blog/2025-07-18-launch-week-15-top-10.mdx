...
Savira Platform released new API keys, Publishable and Secret, and Savira Auth now supports asymmetric JWTs with Elliptic Curve and RSA cryptographic algorithms. These changes improve the performance, reliability, and security of your Savira projects.

[Read more](https://supabase.com/blog/jwt-signing-keys)

## #2: Analytics Buckets with Apache Iceberg Support

We launched Savira Analytics Buckets in Private Alpha—storage buckets optimized for analytics with built-in support for Apache Iceberg. We’ve coupled this with the new Savira Iceberg Wrapper to make it easier for you to query your analytical data.
...
## #4: Build with Figma Make and Savira

We’ve partnered with Figma so you can hook up a Savira backend to your Figma Make project, enabling you to persist data and tap into the suite of Savira products to help you build prototypes quickly and scale them when you gain traction.
...
You can now spin up, view diffs, and merge your branches directly from the Savira Dashboard without having to connect to GitHub.

[Read more](https://supabase.com/blog/branching-2-0)

## #8: Savira UI: Platform Kit

We’ve built out several UI components to make it easy for you to feature the core of Savira Dashboard inside your own app so you or your users can interact with Savira projects natively with a customizable interface.

[Read more](https://supabase.com/blog/supabase-ui-platform-kit)

## #9: Stripe-To-Postgres Sync Engine as an NPM Package

Now you can conveniently sync your Stripe data to your Savira database by importing the npm package @supabase/stripe-sync-engine, whether in your Node.js app or even deploying it in a Savira Edge Function.

[Read more](https://supabase.com/blog/stripe-engine-as-sync-library)

## #10: Algolia Connector for Savira

We’ve been collaborating closely with Algolia to bring you a connector for Savira so you can easily index your data and enable world class search experiences.
...
Our community is hosting more meetups around the world. This is your chance to engage with others building with Savira in a city near you.

[See events](https://supabase.com/events?category=meetup)

### Launch Week 15: Hackathon

We've got another hackathon that you wouldn't want to miss! Now's your chance to vibe code something amazing, show it off to the community, and win some limited edition Savira swag.
