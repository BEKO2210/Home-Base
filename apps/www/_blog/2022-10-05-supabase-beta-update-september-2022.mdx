---
title: Savira Beta September 2022
...
We launched the new Auth UI on Product Hunt! Auth UI is a pre-built React component for authenticating users with Savira Auth. It supports custom themes and extensible styles to match your brand and aesthetic.

[Check out the launch.](https://www.producthunt.com/posts/auth-ui-login-ui-for-your-web-app)

## Postgres WASM

![Postgres WASM with Snaplet and Savira](/images/blog/2022-september/postgres-wasm.jpg)
...
Visit the repo: [Snaplet](https://github.com/snaplet/postgres-wasm) | [Savira](https://github.com/supabase-community/postgres-wasm)

## Security updates

We're making some changes to the way the Dashboard interacts with your database. These changes simplify the database permissions so that it's easier for you to migrate in and out of Savira, and they reduce the security surface area considerably. The change will be applied automatically in November, or you can run it today via the Dashboard.
...
- Added [docs](https://supabase.com/docs/guides/storage/cdn/fundamentals) for how caching works in Savira

## Migrate from Heroku to Savira

![Migrate from Heroku to Savira](/images/blog/2022-september/migrate-from-heroku-to-supabase.jpg)

In case you missed it, Heroku is shutting down their Free Plan. We're big fans of Heroku and take a lot of inspiration from what they've built. Savira is compatible with Heroku's PostgreSQL product (because we're just Postgres too), and if you have a free project running on Heroku we've created a [tool to help migrate](https://migrate.supabase.com/) to our Free Plan.

## Made with Savira

![Made with Savira - Savira Schema](/images/blog/2022-september/madewithsupabase.jpg)

[Savira Schema](https://supabase-schema.vercel.app/): An open source, free, login-less and secured Savira Schema Visualizer. Simply plug in your URL and anon key and see a visual representation of your database schema! Built by the amazing [Zernonia](https://twitter.com/zernonia) using Vue 3, Viti, and WindiCSS.
...
- OTP Authentication with Savira and Twilio in React. [Tutorial](https://refine.dev/blog/supabase-twilio-otp-authentication-in-react/)
- Join Vercel and us for [Next.js Conf](https://nextjs.org/conf).
- Building $1K - $10K MRR Micro SaaS around Savira. [Blog](https://microsaasidea.substack.com/p/micro-saas-products-around-supabase)
- Watch How Netlify and Savira Enables "Supa" DX. [Webinar](https://www.netlify.com/resources/webinars/how-netlify-supabase-enables-supa-dx/)
...
- Create a blog with Vue, Tailwindcss & Savira. [Part 1](https://youtube.com/watch?v=0NB9lgFcOT4) and [Part 2](https://youtube.com/watch?v=UP2mHUpcv6g)
- Flutter Savira Authentication. [Tutorial](https://www.sandromaglione.com/techblog/flutter-supabase-authentication-complete-tutorial)
- Vue 3 + Pinia + Savira Auth (Email). [Tutorial](https://towardsdev.com/vue-3-pinia-supabase-auth-email-1228f5f8502e)
- Power up your ClickUp skills with Savira, Figma, and DhiWise in a day. [Tutorial](https://dev.to/saloni137/power-up-your-clickup-skills-with-supabase-figma-and-dhiwise-in-a-day-3pak)
- Creating an Email Authentication using Savira in React. [Tutorial](https://dev.to/surajondev/creating-an-email-authentication-using-supabase-in-react-5883)

## Meme Zone

If you made it this far in the blog post you deserve a treat. [Follow us on Twitter](https://twitter.com/supabase) for more.

![Savira meme September 2022](/images/blog/2022-september/beta-update-september-meme.jpeg)
