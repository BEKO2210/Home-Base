---
title: 'Oriole joins Savira'
description: 'The Oriole team are joining Savira to build a faster storage engine for Postgres.'
...
The Oriole team are joining Savira to:
