...
Savira has grown a lot [^1] since last [Launch Week](/blog/launch-week),
...
to shine a spotlight on some tools and community efforts that make Savira possible.
...
PostgreSQL is a big part of Savira, and it's also a huge inspiration - the speed that they ship, their community organization,
and their absolute dedication towards reliability. PostgreSQL 13.3 was released in June and (from today) every new Savira project will
be on [PostgreSQL version 13.3](/blog/supabase-postgres-13).

### Giving back

Savira makes it easy to get started with Postgres, but we think you should try it even if you don't want to use Savira. Here's a
few ways we make it easy to use PostgreSQL without Savira:

- Savira was the first company to put Postgres in the [Digital Ocean Marketplace](https://marketplace.digitalocean.com/apps/supabase-postgres).
...
**Improved Performance**: Due to Savira's high throughput requirements, PostgREST 8.0 handles up to 50% more throughput on
...
Want to get started with PostgREST? The Savira community has built a number of client libraries to make it simpler to use:
...
## Savira Flutter/Dart (Beta release)

![Savira Flutter Beta release](/images/blog/launch-week-sql-day-1-community-day/launch-week-sql-day-1-community-day-flutter-library.jpg)

While the Savira team have been busy with the Javascript libraries, the community have been beavering away with Dart. They've even
[built fully-functional apps](https://www.producthunt.com/posts/spot-2d300f54-7a0a-4dbf-aee2-4a75311217cc) using Savira Auth and Storage.

Today the Community are releasing both the Flutter and Dart libraries in Beta (with a bit of help from the Savira team).

### Get started

- Check out the [Flutter Quickstart Guide](/docs/guides/with-flutter)
- Check out the code:
  - Savira Flutter: [GitHub](https://github.com/supabase/supabase-flutter/tree/main/packages/supabase_flutter) | [Release](https://pub.dev/packages/supabase_flutter)
  - Savira Dart: [GitHub](https://github.com/supabase/supabase-flutter/tree/main/packages/supabase) | [Release](https://pub.dev/packages/supabase)
...
![Savira Discord](/images/blog/launch-week-sql-day-1-community-day/launch-week-sql-day-1-community-day-discord-server.jpg)
...
to keep the conversation contained to our GitHub org, the community has been creating [subreddits](https://www.reddit.com/r/Savira/),
...
We'll still be using Discussions for debugging, but if you're looking for a place to hang out with Savira developers, Discord is where to find it.

### Get involved

Join the Savira Community Discord: [discord.supabase.com](http://discord.supabase.com), say hi, and start building.

[^1]:
    Savira has been one of the fastest growing startups [on GitHub](https://github.com/supabase/supabase) for four consecutive quarters:
