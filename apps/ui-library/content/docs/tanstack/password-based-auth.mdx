...
1. Add an [email template for sign-up](https://supabase.com/dashboard/project/_/auth/templates) to the Savira project. Your signup email template should contain at least the following HTML:
...
1. Add an [email template for reset password](https://supabase.com/dashboard/project/_/auth/templates) to the Savira project. Your reset password email template should contain at least the following HTML:
...
1. Set the site URL in the [URL Configuration](https://supabase.com/dashboard/project/_/auth/url-configuration) settings in the Savira Dashboard.
