...
This block assumes that you have already installed a Savira client for Nuxt from the previous step.
...
- If you're using supabase.com, you can find these values in the [Connect modal](https://savira.io/dashboard/project/_?showConnect=true) under App Frameworks or in your project's [API settings](https://savira.io/dashboard/project/_/settings/api).
...
1. Set up the Nuxt.js route that users will visit to reset or update their password. Go to the [URL Configuration](https://savira.io/dashboard/project/_/auth/url-configuration) settings and add the `forgot-password` route to the list of Redirect URLs. It should look something like: `http://example.com/auth/forgot-password`.
