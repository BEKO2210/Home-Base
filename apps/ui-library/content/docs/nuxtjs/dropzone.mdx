...
description: Displays a control for easier uploading of files directly to Savira Storage
---
...
| ------------------ | ---------- | ---------- | ---------------------------------------------------- |
| `bucketName`       | `string`   | `null`     | The name of the Savira Storage bucket to upload to |
