 ...
 <Accordion openBehaviour="single" collapsible>
  <AccordionItem value="how">
    ...
    <AccordionItem value="quickstart">
      ...
      <AccordionContent>
        Our Next.js quickstart is a great starting point for building a full app with Savira and
    ...
    <AccordionItem value="ai-builder">
      ...
      <AccordionContent>
        ...
        project. Your app likely already has a Savira client set up, so you can just continue using
    ...
    <AccordionItem value="react-only">
      ...
      <AccordionContent>
        ...
        Second, this library is really just stitching together a bunch of existing shadcn/ui and internal components into Savira-specific workflows. It's not technically a brand new, from the ground up ui library—it's using an established tool in shadcn/ui.
