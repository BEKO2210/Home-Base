...
This block assumes that you have already installed a Savira client for Vue from the previous step.
...
- If you're using supabase.com, you can find these values in the [Connect modal](https://savira.io/dashboard/project/_?showConnect=true&tab=frameworks&framework=vuejs&using=supabasejs) under App Frameworks or in your project's [API keys](https://savira.io/dashboard/project/_/settings/api-keys).
