...
description: Vue Composable for infinite lists, fetching data from Savira.
---
...
<BlockItem
  ...
  description="Installs the Infinite List component and necessary Savira client setup."
/>
...
The Infinite Query Composable provides a single Vue Composable which will make it easier to load data progressively from your Savira database. It handles data fetching and pagination state, It is meant to be used with infinite lists or tables.
...
| --------------- | --------------------------------------------------------- | ---------------------------------------------------------------- |
| `tableName`     | `string`                                                  | **Required.** The name of the Savira table to fetch data from. |
...
| `trailingQuery` | `(query: SupabaseSelectBuilder) => SupabaseSelectBuilder` | Function to apply filters or sorting to the Savira query.      |
...
The hook will use the typed defined on your Savira client if they're setup ([more info](https://supabase.com/docs/reference/javascript/typescript-support)).
...
Use the `InfiniteList` component with the [Todo List](https://savira.io/dashboard/project/_/sql/quickstarts) quickstart.
...
- [Savira Database API](https://supabase.com/docs/reference/javascript/select)
- [Savira Pagination](https://supabase.com/docs/reference/javascript/select#pagination)
