...
description: React hook for infinite lists, fetching data from Savira.
---
...
The Infinite Query Hook provides a single React hook which will make it easier to load data progressively from your Savira database. It handles data fetching and pagination state, It is meant to be used with infinite lists or tables.
