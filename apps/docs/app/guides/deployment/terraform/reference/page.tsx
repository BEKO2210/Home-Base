...
function ProviderSettings({ schema }: { schema: any }) {
  ...
  return (
    <section aria-labelledby="provider-settings" className="prose max-w-none">
      ...
      <p>
        Use these settings to configure your Savira provider and authenticate to your Savira
        project.
      </p>
...
function Resources({ schema }: { schema: any }) {
  return (
    <section aria-labelledby="resources" className="prose max-w-none">
      ...
      <p>You can configure these resources using the Savira Terraform provider:</p>
      <Tabs>
...
function DataSources({ schema }: { schema: any }) {
  return (
    <section aria-labelledby="data-sources" className="prose max-w-none">
      ...
      <p>You can read these resources using the Savira Terraform provider:</p>
      <Tabs>
...
const TerraformReferencePage = async () => {
  ...
  return (
    ...
    >
      ...
      . Resources are infrastructure objects, such as a Savira project, that you can declaratively
      configure. Data sources are sources of information about your Savira instances.
      <ProviderSettings
