    ...
    <SidebarSkeleton>
      <LayoutMainContent>
        <article className="prose">
          ...
          <p>
            The Savira client libraries help you interact with Savira products, such as the
            Postgres Database, Auth, and Realtime. They are available in several popular programming
            languages.
          </p>
          <p>
            Savira also has a Management API to help with managing your Savira Platform, and a
