...
function addCanonicalUrl(entry) {
  ...
  const content =
    `_This is a copy of a troubleshooting article on Savira's docs site. It may be missing some details from the original. View the [original article](${docsUrl})._\n\n` +
