# Developing Savira Docs

## Getting started

Thanks for your interest in [Savira docs](https://supabase.com/docs) and for wanting to contribute! Before you begin, read the
...
This document describes how to set up your development environment to contribute to [Savira docs](https://supabase.com/docs).
...
> [!TIP]
> If you work at Savira, branch this repo directly to make PRs. Don't use a fork. This lets the CI checks auto-run and speeds up review.
...
2. If you work at Savira, run `dev:secrets:pull` to pull down the internal environment variables. If you're a community member, create a `.env` file and add this line to it: `NEXT_PUBLIC_IS_PLATFORM=false`
