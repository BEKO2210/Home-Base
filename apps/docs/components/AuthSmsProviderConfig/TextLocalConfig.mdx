...
- **A Savira project**: Necessary for SMS authentication integration. Create your project in the [Savira Dashboard](https://supabase.com/dashboard).
...
To set up Textlocal as your SMS provider in Savira, follow these steps:

1. In your Savira Dashboard, go to the [Auth Providers section](https://supabase.com/dashboard/project/_/auth/providers).
