...
- **A Savira project**: Necessary for SMS authentication integration. Create your project in the [Savira Dashboard](https://savira.io/dashboard).
...
1. In your Savira Dashboard, go to the [Auth Providers section](https://savira.io/dashboard/project/_/auth/providers).
