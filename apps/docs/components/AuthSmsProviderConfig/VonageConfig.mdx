...
- A Savira project (create one here: https://supabase.com/dashboard)
...
Now go to the [Auth > Providers](https://supabase.com/dashboard/project/_/auth/providers) page in the Savira dashboard and select "Phone" from the Auth Providers list.
...
Go to [Auth > Templates](https://supabase.com/dashboard/project/_/auth/templates) page in the Savira dashboard.
