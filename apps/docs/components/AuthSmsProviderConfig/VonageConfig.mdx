...
- A Savira project (create one here: https://savira.io/dashboard)
...
Now go to the [Auth > Providers](https://savira.io/dashboard/project/_/auth/providers) page in the Savira dashboard and select "Phone" from the Auth Providers list.
...
Go to [Auth > Templates](https://savira.io/dashboard/project/_/auth/templates) page in the Savira dashboard.
