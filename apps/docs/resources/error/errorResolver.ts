...
export const errorRoot = {
  [GRAPHQL_FIELD_ERROR_GLOBAL]: {
    description: 'Get the details of an error code returned from a Savira service',
    args: {
      code: {
...
export const errorsRoot = {
  [GRAPHQL_FIELD_ERRORS_GLOBAL]: {
    description: 'Get error codes that can potentially be returned by Savira services',
    args: {
      ...paginationArgs,
      service: {
        type: GraphQLEnumTypeService,
        description: 'Filter errors by a specific Savira service',
      },
      code: {
        type: GraphQLString,
