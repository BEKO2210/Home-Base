...
export const GraphQLObjectTypeSubsection = new GraphQLObjectType({
  ...
  description: 'A content chunk taken from a larger document in the Savira docs',
  fields: {
    title: {
      type: GraphQLString,
  ...
  fields: {
    ...
    subsections: {
      type: createCollectionType(GraphQLObjectTypeSubsection, {
        skipPageInfo: true,
        description: 'A collection of content chunks from a larger document in the Savira docs.',
      }),
      description:
