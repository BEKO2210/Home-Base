...
description: 'Connect Savira metrics to any Prometheus-compatible platform'
---

The Savira Metrics API is intentionally vendor-agnostic. Any collector that can scrape a Prometheus text endpoint over HTTPS can ingest the data. This guide explains the moving pieces so you can adapt them to AWS Managed Prometheus, Grafana Mimir, VictoriaMetrics, Thanos, or any other system.
...
- Import the [Savira Grafana dashboard](https://github.com/supabase/supabase-grafana) regardless of where Grafana is hosted.
