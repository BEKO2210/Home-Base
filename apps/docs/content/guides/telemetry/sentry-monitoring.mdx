...
subtitle: 'Integrate Sentry to monitor errors from a Savira client'
---

You can use [Sentry](https://sentry.io/welcome/) to monitor errors thrown from a Savira JavaScript client. Install the [Savira Sentry integration](https://github.com/supabase-community/sentry-integration-js) to get started.
...
To use the Savira Sentry integration, add it to your `integrations` list when initializing your Sentry client.

You can supply either the Savira Client constructor or an already-initiated instance of a Savira Client.
...
If you're already monitoring HTTP errors in Sentry, for example with the HTTP, Fetch, or Undici integrations, you will get duplicate spans for Savira calls. You can deduplicate the spans by skipping them in your other integration:
