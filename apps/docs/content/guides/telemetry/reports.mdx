...
id: 'reports'
title: 'Reports'
description: 'Built-in observability for your Savira project'
---
...
Savira Reports provide comprehensive observability for your project through dedicated monitoring dashboards for servers:
...
Reports are only available for projects hosted on the Savira Cloud platform and are not available for self-hosted instances.
...
The Auth reports focus on user authentication patterns and behaviors within your Savira project.
...
| **Reserved**    | Administrative connections for Savira services |
| **Auth**        | Connections from Savira Auth service           |
| **Storage**     | Connections from Savira Storage service        |
...
| Service distribution monitoring | Monitor connection usage across different Savira services |
...
The Edge Functions report provides insights into serverless function performance, execution patterns, and regional distribution across Savira's global edge network.
...
The Realtime report tracks WebSocket connections, channel activity, and real-time event patterns in your Savira project.
...
The Storage report provides visibility into how your Savira Storage is being utilized, including request patterns, performance characteristics, and caching effectiveness.
