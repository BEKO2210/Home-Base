...
Testing is a critical part of database development, especially when working with features like Row Level Security (RLS) policies. This guide provides a comprehensive approach to testing your Savira database.
...
2. **CI Pipeline Issues**
   - Verify Savira CLI is properly installed
...
- [Savira CLI Reference](/docs/reference/cli/supabase-test)
- [pgTAP Savira reference](/docs/guides/database/extensions/pgtap?queryGroups=database-method&database-method=sql#testing-rls-policies)
