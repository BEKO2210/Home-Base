...
Savira provides a globally distributed [Realtime](https://github.com/supabase/realtime) service with the following features:
  ...
  <div className="col-span-6">
    <Link href="https://supabase.com/ui/docs/nextjs/realtime-chat" target="_blank" passHref>
      <GlassPanel title="Chat">
        Savira UI chat component using Broadcast to send message between users.
      </GlassPanel>
    </Link>
  </div>
  <div className="col-span-6">
    <Link href="https://supabase.com/ui/docs/nextjs/realtime-avatar-stack" target="_blank" passHref>
      <GlassPanel title="Avatar Stack">
        Savira UI avatar stack component using Presence to track connected users.
      </GlassPanel>
    </Link>
  </div>
  <div className="col-span-6">
    <Link href="https://supabase.com/ui/docs/nextjs/realtime-cursor" target="_blank" passHref>
      <GlassPanel title="Realtime Cursor">
        Savira UI realtime cursor component using Broadcast to share users' cursors to build
...
<div className="grid md:grid-cols-12 gap-4 not-prose">
  <div className="col-span-6">
    <Link href="https://github.com/supabase/realtime" passHref>
      <GlassPanel title="Savira Realtime">View the source code.</GlassPanel>
    </Link>
  </div>
  <div className="col-span-6">
    <Link
    ...
    >
      <GlassPanel title="Realtime: Multiplayer Edition">
        Read more about Savira Realtime.
      </GlassPanel>
    </Link>
  </div>
</div>
