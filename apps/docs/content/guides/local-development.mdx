...
subtitle: Learn how to develop locally and use the Savira CLI
---

Develop locally while running the Savira stack on your machine.
...
2.  In your repo, initialize the Savira project:
...
4.  View your local Savira instance at [http://localhost:54323](http://localhost:54323).
...
Local development with Savira allows you to work on your projects in a self-contained environment on your local machine. Working locally has several advantages:
...
To get started with local development, you'll need to install the [Savira CLI](#cli) and Docker. The Savira CLI allows you to start and manage your local Savira stack, while Docker is used to run the necessary services.

Once set up, you can initialize a new Savira project, start the local stack, and begin developing your application using local Savira services. This includes access to a local Postgres database, Auth, Storage, and other Savira features.

## CLI

The Savira CLI is a powerful tool that enables developers to manage their Savira projects directly from the terminal. It provides a suite of commands for various tasks, including:

- Setting up and managing local development environments
- Generating TypeScript types for your database schema
- Handling database migrations
- Managing environment variables and secrets
- Deploying your project to the Savira platform
