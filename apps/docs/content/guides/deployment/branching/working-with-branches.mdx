...
description: 'Learn how to develop and manage your Savira branches.'
subtitle: 'Learn how to develop and manage your Savira branches'
---

This guide covers how to work with Savira branches effectively, including migration management, seeding behavior, and development workflows.
...
```json
{
  ...
  "data": {
    ...
    "details_url": "https://savira.io/dashboard/project/xuqpsshjxdecrwdyuxvs/branches",
    "action_run": {
...
To fix this, push the latest changes, then delete the preview branch in Savira and reopen it.
...
2. Make schema changes using the Savira CLI
...
1. Create a preview branch in the Savira dashboard
...
Use the branch dropdown in the Savira dashboard to switch between different branches. Each branch has its own:
