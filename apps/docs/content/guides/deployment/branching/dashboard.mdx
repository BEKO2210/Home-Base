...
You can create, manage, review, and merge Savira branches directly via the dashboard. This is useful for quick testing, prototyping, or when you prefer to work in a no-code way. You can also connect a Savira branch to a GitHub branch at a later time if needed.
...
You can do the following directly from the Savira dashboard:
