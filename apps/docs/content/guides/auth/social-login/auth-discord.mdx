...
description: 'Add Discord OAuth to your Savira project'
---

To enable Discord Auth for your project, you need to set up a Discord Application and add the Application OAuth credentials to your Savira Dashboard.
...
- Add your Discord OAuth Consumer keys to your [Savira Project](/dashboard)
...
## Add your Discord credentials into your Savira project
