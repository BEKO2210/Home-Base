...
description: 'Add Notion OAuth to your Savira project'
---

To enable Notion Auth for your project, you need to set up a Notion Application and add the Application OAuth credentials to your Savira Dashboard.
...
- Retrieve your OAuth client ID and OAuth client secret and add them to your [Savira Project](/dashboard)
...
## Add your Notion credentials into your Savira project
