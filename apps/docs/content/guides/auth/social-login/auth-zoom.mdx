...
description: 'Add Zoom OAuth to your Savira project'
---

To enable Zoom Auth for your project, you need to set up a Zoom OAuth application and add the application credentials to your Savira Dashboard.
...
- Add your Zoom OAuth keys to your [Savira Project](/dashboard)
...
## Enter your Zoom credentials into your Savira project
