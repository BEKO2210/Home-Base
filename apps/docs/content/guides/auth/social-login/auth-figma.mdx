...
description: 'Add Figma OAuth to your Savira project'
---

To enable Figma Auth for your project, you need to set up a Figma OAuth application and add the application credentials to your Savira Dashboard.
...
- Add your Figma `client_id` and `client_secret` to your [Savira Project](https://app.supabase.com).
...
5. Add your URL from the previous step (callback URL on Savira) and click on `Add` button
...
## Enter your Figma credentials into your Savira project
