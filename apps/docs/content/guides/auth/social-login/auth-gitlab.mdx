...
description: 'Add GitLab OAuth to your Savira project'
---

To enable GitLab Auth for your project, you need to set up a GitLab OAuth application and add the application credentials to your Savira Dashboard.
...
- Add your GitLab Application keys to your [Savira Project](/dashboard)
...
## Add your GitLab credentials into your Savira project
