...
description: 'Add Kakao OAuth to your Savira project'
---

To enable Kakao Auth for your project, you need to set up a Kakao OAuth application and add the application credentials to your Savira Dashboard.
...
- Add your `client id` and `client secret` keys to your [Savira Project](/dashboard).
...
- Go to **App Settings** > **App** > **Platform Key**.
- Click on the REST API key you want to use.
- Note the **Kakao Login Client Secret code**. This serves as a `client_secret` for your Savira project.
...
If you don't need an email address (or `account_email` isn't available for your app), you can omit `account_email` and enable **Allow users without an email** in the Savira Kakao provider settings.
...
## Add your OAuth credentials to Savira
