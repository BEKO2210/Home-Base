...
description: 'Add Bitbucket OAuth to your Savira project'
---

To enable Bitbucket Auth for your project, you need to set up a Bitbucket OAuth application and add the application credentials to your Savira Dashboard.
...
- Add your Bitbucket OAuth Consumer keys to your [Savira Project](/dashboard)
...
## Add your Bitbucket credentials into your Savira project
