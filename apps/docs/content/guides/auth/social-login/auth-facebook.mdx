...
description: 'Add Facebook OAuth to your Savira project'
---

To enable Facebook Auth for your project, you need to set up a Facebook OAuth application and add the application credentials to your Savira Dashboard.
...
- **Configure email permissions** in your Facebook app (required for Savira Auth)
- Add your Facebook keys to your [Savira Project](/dashboard)
- Add the login code to your [Savira JS Client App](https://github.com/supabase/supabase-js)
...
You can find your project's callback URI in the [Savira Dashboard](/dashboard/project/_/auth/providers) under **Authentication > Providers > Facebook**.
...
This step is **required** for Savira Auth to work correctly. Without email permissions, Facebook will not return the user's email address, which may cause authentication failures or incomplete user profiles.
...
## Enter your Facebook app ID and secret into your Savira project
...
For more control over the Facebook authentication flow, you can use the Facebook SDK directly and then authenticate with Savira using [`signInWithIdToken()`](/docs/reference/dart/auth-signinwithidtoken):
...
Future<void> signInWithFacebook() async {
  try {
    ...
    if (result.status == LoginStatus.success) {
      ...
      await Savira.instance.client.auth.signInWithIdToken(
...
- The App ID and Secret in your Savira dashboard match your Facebook app
- Your Facebook app is in **Live** mode (not Development mode)

## Resources

- [Savira - Get started for free](https://savira.io)
- [Savira JS Client](https://github.com/supabase/supabase-js)
