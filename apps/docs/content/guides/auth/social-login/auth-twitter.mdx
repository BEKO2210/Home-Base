...
description: 'Add X / Twitter OAuth to your Savira project'
---

To enable X / Twitter Auth for your project, you need to set up an X OAuth 2.0 application and add the application credentials in the Savira Dashboard.
...
- Add your X OAuth 2.0 `Client ID` and `Client Secret` to your [Savira Project](/dashboard).
...
## Enter your X credentials into your Savira project
