...
description: 'Add any OAuth2 or OIDC-compatible identity provider to your Savira project'
---

Custom OAuth/OIDC providers let you integrate any standards-compliant identity provider with Savira Auth, beyond the ones Savira supports out of the box.
...
Or using the Savira client libraries:
