...
description: 'Add CAPTCHA Protection to your Savira project'
tocVideo: 'em1cpOAXknM'
---

Savira provides you with the option of adding CAPTCHA to your sign-in, sign-up, and password reset forms. This keeps your website safe from bots and malicious scripts. Savira authentication has support for [hCaptcha](https://www.hcaptcha.com/) and [Cloudflare Turnstile](https://www.cloudflare.com/application-services/products/turnstile/).
...
## Enable CAPTCHA protection for your Savira project

Navigate to the **[Auth](/dashboard/project/_/auth/protection)** section of your Project Settings in the Savira Dashboard and find the **Enable CAPTCHA protection** toggle under Settings > Authentication > Bot and Abuse Protection > Enable CAPTCHA protection.
...
Now lets use the CAPTCHA token we receive in our Savira signUp function.
...
We can now use the `captchaToken` we receive in our Savira `signUp` function.
