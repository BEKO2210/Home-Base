...
Auth audit logs provide comprehensive tracking of authentication events in your Savira project. Audit logs are automatically captured for all authentication events and help you monitor user authentication activities, detect suspicious behavior, and maintain compliance with security requirements.

## What gets logged

Savira auth audit logs automatically capture all authentication events including:
