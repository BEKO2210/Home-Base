---
title: 'Use Savira Auth with React Native'
subtitle: 'Learn how to use Savira Auth with React Native'
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={4}>
    ...
    Create a helper file `lib/supabase.ts` that exports a Savira client using your Project URL and key.

    Rename `.env.example` to `.env` and populate with your Savira connection variables:
