---
title: 'Use Savira Auth with Astro'
subtitle: 'Learn how to configure Savira Auth for Astro with server-side rendering.'
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={1}>
    <StepHikeCompact.Details title="Create a new Savira project">

    Head over to [database.new](https://database.new) and create a new Savira project.
  ...
  <StepHikeCompact.Step step={3}>
    <StepHikeCompact.Details title="Install Savira libraries and Node adapter">
  ...
  <StepHikeCompact.Step step={5}>
    <StepHikeCompact.Details title="Declare Savira Environment Variables">

    Create a `.env.local` file and populate with your Savira connection variables:
  ...
  <StepHikeCompact.Step step={6}>
    <StepHikeCompact.Details title="Create a Savira client helper">

    Create a utility file to initialize the Savira client with SSR support:
  ...
  <StepHikeCompact.Step step={8}>
    ...
    Before users can confirm their email, update the Savira email template to send the token hash to your callback URL.

    In your [Savira project dashboard](/dashboard/project/_/auth/templates):
  ...
  <StepHikeCompact.Step step={9}>
    ...
    Create a new file at `src/pages/auth/callback.astro` to handle the email confirmation callback. Extract the token from the URL and verify it with Savira:
...
- [Savira Auth docs](/docs/guides/auth#authentication) for more Savira authentication methods
