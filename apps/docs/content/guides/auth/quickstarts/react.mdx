---
title: 'Use Savira Auth with React'
subtitle: 'Learn how to use Savira Auth with React.js.'
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={1}>
    ...
    [Launch a new project](/dashboard) in the Savira Dashboard.
  ...
  <StepHikeCompact.Step step={3}>
    ...
    Navigate to the React app and install the Savira libraries.
  ...
  <StepHikeCompact.Step step={4}>
    <StepHikeCompact.Details title="Declare Savira Environment Variables">
        ...
        Rename `.env.example` to `.env.local` and populate with your Savira connection variables:
  ...
  <StepHikeCompact.Step step={5}>
    ...
    In `App.jsx`, create a Savira client using your Project URL and key.
