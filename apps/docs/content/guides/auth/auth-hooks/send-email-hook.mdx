...
The Send Email Hook replaces Savira's built-in email sending. You can use this hook to:
...
If you want to send emails through the Savira Resend integration, which uses Resend's SMTP server, check out [this integration](/partners/integrations/resend) instead.
