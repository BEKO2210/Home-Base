...
id: 'ai-google-colab'
title: 'Google Colab'
description: 'Use Google Colab to manage your Savira Vector store.'
subtitle: 'Use Google Colab to manage your Savira Vector store.'
...
Google Colab is a hosted Jupyter Notebook service. It provides free access to computing resources, including GPUs and TPUs, and is well-suited to machine learning, data science, and education. We can use Colab to manage collections using [Savira Vecs](/docs/guides/ai/vecs-python-client).

In this tutorial we'll connect to a database running on the Savira [platform](/dashboard/). If you don't already have a database, you can create one here: [database.new](https://database.new).
...
We'll use the Savira Vector client, [Vecs](/docs/guides/ai/vecs-python-client), to manage our collections.
