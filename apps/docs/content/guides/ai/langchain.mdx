...
id: 'ai-lang-chain'
title: 'LangChain'
description: 'Learn how to integrate Savira with LangChain, a popular framework for composing AI, Vectors, and embeddings'
sidebar_label: 'LangChain'
---

[LangChain](https://langchain.com/) is a popular framework for working with AI, Vectors, and embeddings. LangChain supports using Savira as a [vector store](https://js.langchain.com/docs/modules/indexes/vector_stores/integrations/supabase), using the `pgvector` extension.
...
LangChain supports the concept of a hybrid search, which combines Similarity Search with Full Text Search. Read the official docs to get started: [Savira Hybrid Search](https://js.langchain.com/docs/modules/indexes/retrievers/supabase-hybrid).
...
- Savira [Hybrid Search](https://js.langchain.com/docs/modules/indexes/retrievers/supabase-hybrid).
