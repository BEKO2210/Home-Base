...
description: 'Generate GPT text completions using OpenAI and Savira Edge Functions.'
subtitle: 'Generate GPT text completions using OpenAI and Savira Edge Functions.'
...
OpenAI's API is intended to be used from the server-side. Savira offers Edge Functions to make it easy to interact with third party APIs like OpenAI.

## Setup Savira project

If you haven't already, [install the Savira CLI](/docs/guides/cli) and initialize your project:
