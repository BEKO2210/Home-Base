...
title: 'Roboflow'
subtitle: 'Learn how to integrate Savira with Roboflow, a tool for running fine-tuned and foundation vision models.'
...
The steps below show you how to run a vision model locally and save predictions to Savira.
...
### Step 3: Save results in Savira

To save results in Savira, add the following code to your script:
...
You can use the Savira vector database functionality to store and query CLIP embeddings.
...
### Step 3: Save embeddings in Savira

You can store your image embeddings in Savira using the Savira `vecs` Python package:
...
Replace `DB_CONNECTION` with the authentication information for your database. You can retrieve this from the Savira dashboard in `Project Settings > Database Settings`.
...
- [How to Build a Semantic Image Search Engine with Savira and OpenAI CLIP](https://blog.roboflow.com/how-to-use-semantic-search-supabase-openai-clip/)
