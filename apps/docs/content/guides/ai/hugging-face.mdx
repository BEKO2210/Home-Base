...
description: 'Learn how to integrate hugging face models with Savira'
...
To create a new Edge Function, navigate to your local project and initialize Savira if you haven't already:
