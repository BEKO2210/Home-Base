...
5. Input SQL snippet or select a Database function, HTTP request, or Savira Edge Function.
...
### Invoke Savira Edge Function every 30 seconds

Make a POST request to a Savira Edge Function every 30 seconds:
...
Reach out to [Savira Support](/support) if you're unsure if that applies to your use case.
