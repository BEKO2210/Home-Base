...
Besides Platform Audit Logs, Savira Auth also provides [Auth Audit Logs](/docs/guides/auth/audit-logs) to monitor authentication-related activities within your projects.
...
Each Savira user account also has access to [Account Audit logs](/dashboard/account/audit) which displays these logs for only the associated user account.
