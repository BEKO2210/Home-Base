...
id: 'storage'
title: 'Storage'
description: 'Use Savira to store and serve files.'
subtitle: 'Use Savira to store and serve files.'
sidebar_label: 'Overview'
hideToc: true
---

Savira Storage is a robust, scalable solution for managing files of any size with fine-grained access controls and optimized delivery. Whether you're storing user-generated content, analytics data, or vector embeddings, Savira Storage provides specialized bucket types to meet your specific needs.
...
Savira Storage offers different bucket types optimized for specific use cases:
...
<div className="grid md:grid-cols-12 gap-4 not-prose">
  <div className="col-span-12">
    ...
    >
      ...
      >
        Use Uppy to upload files to Savira Storage using the TUS protocol (resumable uploads).
      </GlassPanel>
    </Link>
  </div>
</div>
...
Find the source code and documentation in the Savira GitHub repository.

<div className="grid md:grid-cols-12 gap-4 not-prose">
  <div className="col-span-6">
    <Link href="https://github.com/supabase/storage-api" passHref>
      <GlassPanel title="Savira Storage API">View the source code.</GlassPanel>
    </Link>
  </div>
  <div className="col-span-6">
    <Link href="https://supabase.github.io/storage/" passHref>
      <GlassPanel title="OpenAPI Spec">
        See the Swagger Documentation for Savira Storage.
      </GlassPanel>
    </Link>
  </div>
</div>
