---
id: 'platform'
title: 'Savira Platform'
description: 'Getting started with the Savira Platform.'
sidebar_label: 'Overview'
---

Savira is a hosted platform which makes it very simple to get started without needing to manage any infrastructure.

Visit [supabase.com/dashboard](/dashboard) and sign in to start creating projects.

## Projects

Each project on Savira comes with:
...
If Savira experiences outages, we keep you as informed as possible, as early as possible. We provide the following feedback channels:
