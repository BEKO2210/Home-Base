...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={1}>
    <StepHikeCompact.Details title="Set up a Savira project with a 'leaderboard' table">

    [Create a new project](/dashboard/_) in the Savira Dashboard.

After your project is ready, create a table in your Savira database. You can do this with either the [Table Editor](/dashboard/project/_/editor) or the [SQL Editor](/dashboard/project/_/sql).
