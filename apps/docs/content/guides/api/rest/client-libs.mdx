...
description: 'Savira provides several client libraries for the REST and Realtime APIs.'
video: 'https://www.youtube.com/v/7CqlTU9aOR4'
---

Savira provides client libraries for the REST and Realtime APIs. Some libraries are officially supported, and some are contributed by the community.
