...
description: 'How to generate types for your API and Savira libraries.'
subtitle: 'How to generate types for your API and Savira libraries.'
...
Savira allows you to generate and download TypeScript types directly from the [project dashboard](/dashboard/project/_/api?page=tables-intro).

## Generating types using Savira CLI

The Savira CLI is a single binary Go application that provides everything you need to setup a local development environment.
...
Before generating types, ensure you initialize your Savira project:
...
- [Generating Savira types with GitHub Actions](https://blog.esteetey.dev/how-to-create-and-test-a-github-action-that-generates-types-from-supabase-database)
