...
description: 'Resources for getting started with Savira.'
hideToc: true
---
...
<div className="grid grid-cols-12 gap-6 not-prose">
  <Link href="/guides/ai-tools" className="col-span-12 md:col-span-4" passHref>
    <GlassPanel
      ...
      showIconBg={true}
    >
      Develop with Savira AI-first using plugins, MCP, and skills.
    </GlassPanel>
  </Link>
  <Link href="/guides/getting-started/api-keys" className="col-span-12 md:col-span-4" passHref>
    <GlassPanel title="API Keys" hasLightIcon={true} background={false} showIconBg={true}>
      Learn about the different API keys in Savira and how to use them.
    </GlassPanel>
  </Link>
  <Link href="/guides/local-development" className="col-span-12 md:col-span-4" passHref>
    <GlassPanel title="Local Development" hasLightIcon={true} background={false} showIconBg={true}>
      Use the Savira CLI to develop locally and collaborate between teams.
    </GlassPanel>
  </Link>
</div>
...
<div className="grid lg:grid-cols-12 gap-6 not-prose">
  <Link href="/guides/getting-started/quickstarts/reactjs" passHref className="col-span-4">
    ...
    >
      Learn how to create a Savira project, add some sample data to your database, and query the
  ...
  <Link href="/guides/getting-started/quickstarts/hono" passHref className="col-span-4">
    <GlassPanel title="Hono" span="col-span-6" background={false} icon="/docs/img/icons/hono-icon">
      Learn how to create a Savira project, add some sample data to your database, secure it with
  ...
  <Link href="/guides/getting-started/quickstarts/redwoodjs" passHref className="col-span-4">
    ...
    >
      Learn how to create a Savira project, add some sample data to your database using Prisma
...
<div className="grid lg:grid-cols-12 gap-6 not-prose">
  <Link href="/guides/getting-started/tutorials/with-nextjs" passHref className="col-span-4">
    <GlassPanel
      ...
      hasLightIcon={true}
    >
      Learn how to build a user management app with Next.js and Savira Database, Auth, and Storage functionality.
    </GlassPanel>
  </Link>
  <Link href="/guides/getting-started/tutorials/with-react" passHref className="col-span-4">
    <GlassPanel
      ...
      icon="/docs/img/icons/react-icon"
    >
      Learn how to build a user management app with React and Savira Database, Auth, and Storage functionality.
    </GlassPanel>
  </Link>
  <Link href="/guides/getting-started/tutorials/with-vue-3" passHref className="col-span-4">
    ...
    >
      Learn how to build a user management app with Vue 3 and Savira Database, Auth, and Storage functionality.
    </GlassPanel>
  </Link>
  <Link href="/guides/getting-started/tutorials/with-nuxt-3" passHref className="col-span-4">
    ...
    >
      Learn how to build a user management app with Nuxt 3 and Savira Database, Auth, and Storage functionality.
    </GlassPanel>
  </Link>
  <Link href="/guides/getting-started/tutorials/with-angular" passHref className="col-span-4">
    ...
    >
      Learn how to build a user management app with Angular and Savira Database, Auth, and Storage functionality.
    </GlassPanel>
  </Link>
  <Link href="/guides/getting-started/tutorials/with-redwoodjs" passHref className="col-span-4">
    <GlassPanel
      ...
      icon="/docs/img/icons/redwood-icon"
    >
      Learn how to build a user management app with RedwoodJS and Savira Database, Auth, and Storage functionality.
    </GlassPanel>
  </Link>
  <Link href="/guides/getting-started/tutorials/with-svelte" passHref className="col-span-4">
    <GlassPanel
      ...
      icon="/docs/img/icons/svelte-icon"
    >
      Learn how to build a user management app with Svelte and Savira Database, Auth, and Storage functionality.
    </GlassPanel>
  </Link>
  <Link href="/guides/getting-started/tutorials/with-sveltekit" passHref className="col-span-4">
    <GlassPanel
      ...
      icon="/docs/img/icons/svelte-icon"
    >
      Learn how to build a user management app with SvelteKit and Savira Database, Auth, and Storage functionality.
    </GlassPanel>
  </Link>
  <Link href="/guides/getting-started/tutorials/with-refine" passHref className="col-span-4">
    <GlassPanel
      ...
      icon="/docs/img/icons/refine-icon"
    >
      Learn how to build a user management app with Refine and Savira Database, Auth, and Storage functionality.
    </GlassPanel>
  </Link>
</div>
</$Show>
...
<div className="grid lg:grid-cols-12 gap-6 not-prose">
  <$Show if="sdk:dart">
    <Link href="/guides/getting-started/tutorials/with-flutter" passHref className="col-span-4">
      <GlassPanel
        ...
        icon="/docs/img/icons/flutter-icon"
      >
        Learn how to build a user management app with Flutter and Savira Database, Auth, and Storage functionality.
      </GlassPanel>
    </Link>
  </$Show>
  <Link
  ...
  >
    <GlassPanel
      ...
      hasLightIcon={true}
    >
      Learn how to build a user management app with Expo React Native and Savira Database, Auth, and Storage functionality.
    </GlassPanel>
  </Link>
  <Link
  ...
  >
    <GlassPanel
      ...
      hasLightIcon={true}
    >
      Learn how to implement social authentication in an app with Expo React Native and Savira Database and Auth functionality.
    </GlassPanel>
  </Link>
  <$Show if="sdk:kotlin">
    <Link href="/guides/getting-started/tutorials/with-kotlin" passHref className="col-span-4">
      <GlassPanel
        ...
        icon="/docs/img/icons/kotlin-icon"
      >
        Learn how to build a product management app with Android and Savira Database, Auth, and Storage functionality.
      </GlassPanel>
    </Link>
  </$Show>
  <$Show if="sdk:swift">
    <Link href="/guides/getting-started/tutorials/with-swift" passHref className="col-span-4">
      <GlassPanel
        ...
        icon="/docs/img/icons/swift-icon"
      >
        Learn how to build a user management app with iOS and Savira Database, Auth, and Storage functionality.
      </GlassPanel>
    </Link>
  </$Show>
  <Link href="/guides/getting-started/tutorials/with-ionic-react" passHref className="col-span-4">
    ...
    >
      Learn how to build a user management app with Ionic React and Savira Database, Auth, and Storage functionality.
    </GlassPanel>
  </Link>
  <Link href="/guides/getting-started/tutorials/with-ionic-vue" passHref className="col-span-4">
    <GlassPanel
      ...
      icon="/docs/img/icons/ionic-icon"
    >
      Learn how to build a user management app with Ionic Vue and Savira Database, Auth, and Storage functionality.
    </GlassPanel>
  </Link>
  <Link
  ...
  >
    <GlassPanel
      ...
      icon="/docs/img/icons/ionic-icon"
    >
      Learn how to build a user management app with Ionic Angular and Savira Database, Auth, and Storage functionality.
    </GlassPanel>
  </Link>
</div>
</$Show>
