...
The `inspect` command in the [Savira CLI](/docs/reference/cli/supabase-inspect-db-index-stats) can help you identify unused indexes:
...
The [Savira CLI](/docs/reference/cli/supabase-inspect-db-locks) provides commands to view these metrics:
