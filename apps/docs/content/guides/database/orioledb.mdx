...
You can get started with OrioleDB by enabling the extension in your Savira dashboard.
To get started with OrioleDB you need to [create a new Savira project](/dashboard/new/_) and choose `OrioleDB Public Alpha` Postgres version.
