...
description: 'How to use arrays in Postgres and the Savira API.'
---

Postgres supports flexible [array types](https://www.postgresql.org/docs/12/arrays.html). These arrays are also supported in the Savira Dashboard and in the JavaScript API.
