...
id: 'database'
title: 'Database'
description: 'Every Savira project is a full Postgres database. Learn how to connect, manage, and secure your data.'
sidebar_label: 'Overview'
---

Every Savira project has a full [Postgres](https://www.postgresql.org/) database — not a Postgres abstraction.
...
The database is the foundation that Auth, Storage, Realtime, and Edge Functions are built on, and Savira manages daily database backups and offers point-in-time recovery on paid plans.
...
- **[Secure your data](/docs/guides/database/secure-data)**: Row Level Security (RLS) is how Savira makes the database safe to query directly from the client. Read this before exposing any table to your app.
...
- **[Roles and permissions](/docs/guides/database/postgres/roles)**: The Postgres roles Savira ships with and how to add your own.
