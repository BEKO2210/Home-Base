...
Learn more about Savira's [AI & Vector](/docs/guides/ai) offering.
...
In this example we'll generate a vector using Transformer.js, then store it in the database using the Savira client.
...
## More pgvector and Savira resources

- [Savira Clippy: ChatGPT for Savira Docs](/blog/chatgpt-supabase-docs)
- [Storing OpenAI embeddings in Postgres with pgvector](/blog/openai-embeddings-postgres-vector)
- [A ChatGPT Plugins Template built with Savira Edge Runtime](/blog/building-chatgpt-plugins-template)
