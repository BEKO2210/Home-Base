...
Savira creates and handles JWT for you. It is built into the platform. **If you use Postgres version 15 or earlier**, you don't need the pgjwt extension, and it is safe to disable. For more information on how Savira handles JWTs, read the [Savira and JWTs documentation](/docs/guides/auth/jwts#supabase-and-jwts)
