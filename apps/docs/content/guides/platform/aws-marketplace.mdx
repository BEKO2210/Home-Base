...
- Implications of managing your Savira organization through the AWS Marketplace. Refer to the [Account Setup guide](./aws-marketplace/account-setup#implications-of-linking-a-supabase-organization-to-a-marketplace-subscription).
...
- Purchase Savira through the AWS Marketplace. Refer to the [Getting Started guide](./aws-marketplace/getting-started).
