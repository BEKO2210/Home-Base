---
title: 'Migrate from Vercel Postgres to Savira'
description: 'Migrate your existing Vercel Postgres database to Savira.'
subtitle: 'Migrate your existing Vercel Postgres database to Savira.'
---

This guide demonstrates how to migrate your Vercel Postgres database to Savira to get the most out of Postgres while gaining access to all the features you need to build a project.
...
Set the **NEW_DB_URL** environment variable at the command line using your Savira connection string. You will need to replace `[YOUR-PASSWORD]` with your actual database password.
...
2. Import the database to your Savira project
   ...
   Use `psql` to import the Postgres database file to your Savira project.
