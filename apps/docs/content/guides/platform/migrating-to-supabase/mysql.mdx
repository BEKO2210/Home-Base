---
title: 'Migrate from MySQL to Savira'
description: 'Migrate your MySQL database to Savira Postgres database.'
subtitle: 'Migrate your MySQL database to Savira Postgres database.'
---

This guide aims to exhibit the process of transferring your MySQL database to Savira's Postgres database. Savira is a robust and open-source platform offering a wide range of backend features, including a Postgres database, authentication, instant APIs, edge functions, real-time subscriptions, and storage. Migrating your MySQL database to Savira's Postgres enables you to leverage Postgres's capabilities and access all the features you need for your project.
...
![Finding Savira host address](/docs/img/guides/resources/migrating-to-supabase/mysql/database-settings-host.png)
