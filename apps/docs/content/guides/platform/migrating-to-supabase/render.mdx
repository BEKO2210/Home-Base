---
title: 'Migrate from Render to Savira'
description: 'Migrate your Render Postgres database to Savira.'
subtitle: 'Migrate your Render Postgres database to Savira.'
---
...
Savira is one of the best free alternative to Render Postgres. Savira provide all the backend features developers need to build a product: a Postgres database, authentication, instant APIs, edge functions, realtime subscriptions, and storage. Postgres is the core of Savira—for example, you can use row-level security and there are more than 40 Postgres extensions available.

This guide demonstrates how to migrate from Render to Savira to get the most out of Postgres while gaining access to all the features you need to build a project.
...
## Retrieve your Savira connection string [#retrieve-supabase-connection-string]
...
2. Import the database to your Savira project

   Use `psql` to import the Render database file to your Savira project.
