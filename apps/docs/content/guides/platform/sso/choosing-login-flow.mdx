...
- You need separate Savira organizations for Dev, Staging, and Production
...
- Users click "Savira Dev", "Savira Staging", or "Savira Prod" tiles
- No domain conflicts

**How to configure:**

1. In your IdP, create three SAML apps:
   - "Savira Dev" → Points to dev org ACS URL
   - "Savira Staging" → Points to staging org ACS URL
   - "Savira Production" → Points to prod org ACS URL
2. In each Savira organization:
   - Enable SSO
...
- One Savira organization for your entire company
...
- Users access Savira with one click from IdP
- Fewer potential failure points

**How to configure:**

1. Enable SSO in your Savira organization
2. Leave "Enable SP-initiated login" **OFF**
3. Configure identity provider metadata
4. Create Savira app tile in your IdP
...
- You want to support starting login from Savira
...
5. Create Savira app tile in your IdP (optional but recommended)

**Result:** Users can start login from either Savira or IdP.
...
- All use the same Savira organization
...
5. Create Savira app tiles in IdP (IdP-initiated also works)
...
1. **IdP-initiated:** Click app tile in IdP → Verify redirect to Savira
...
If you need help choosing the right configuration for your organization, contact Savira support with details about your use case. We're happy to provide personalized recommendations.
