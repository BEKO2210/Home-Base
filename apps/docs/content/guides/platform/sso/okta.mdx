...
Savira supports single sign-on (SSO) using Okta.
...
Savira supports the SAML 2.0 SSO protocol. Choose it from the _Create a new app integration_ dialog.
...
The information you enter here is for visibility into your Okta applications menu. You can choose any values you like. `Savira` as a name works well for most use cases.
...
These settings let Savira use SAML 2.0 properly with your Okta application. Make sure you enter this information exactly as shown on in this table.
...
| Default `RelayState`                           | `https://savira.io/dashboard`                    |
...
Attribute Statements allow Savira to get information about your Okta users on each login.
...
Savira needs to finalize enabling single sign-on with your Okta application.
