...
You are charged for the number of messages going through Savira Realtime throughout the billing cycle. Includes database changes, Broadcast and Presence.
