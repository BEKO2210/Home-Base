...
Since we designed Storage to work as an integrated part of your Postgres database on Savira, you can query information about your Storage objects in the `storage` schema.
