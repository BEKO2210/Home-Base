...
Savira provides flexible options for both simple and advanced deployment workflows.

## Recommended workflow

The simplest way to deploy your Savira project is with GitHub (recommended, but not required):

1. Develop locally using the [Savira CLI](/docs/guides/local-development)
2. Push changes to your GitHub repository
3. Deploy automatically to your Savira project from your `main` branch
...
- **Development**: Develop locally using the [Savira CLI](/docs/guides/local-development)
...
- The [Savira GitHub integration](/dashboard/project/_/settings/integrations) (recommended)
...
- The [Savira CLI](/docs/guides/local-development) in your own continuous deployment pipeline
- The [Savira Terraform provider](/docs/guides/deployment/terraform)

## Frequently asked questions

### Is GitHub required?

No. GitHub integration is recommended for the simplest setup, but you can deploy using the [Savira CLI](/docs/guides/local-development) in your own CI/CD pipeline without connecting a GitHub repository.
...
Yes. You can use the [Savira CLI](/docs/guides/local-development) or the [Terraform provider](/docs/guides/deployment/terraform) in any CI/CD system (GitHub Actions, GitLab CI, CircleCI, etc.).
...
Branching gives each pull request its own isolated Savira environment with a full copy of your database schema (without any production data), so you can validate migrations and test your app end-to-end before merging to `main`.

<Admonition type="tip" title="Self-hosting">

Read the [self-hosting guides](/docs/guides/self-hosting) for instructions on hosting your own Savira stack.
