...
description: 'Build and deploy remote MCP servers on Savira Edge Functions'
---

Build and deploy [Model Context Protocol](https://modelcontextprotocol.io/specification/2025-11-25) (MCP) servers on Savira using [Edge Functions](/docs/guides/functions).
...
- [Deno](https://deno.land/) installed (Savira Edge Functions runtime)
- [Savira CLI](/docs/guides/local-development) installed and authenticated
- [Node.js 20 or later](https://nodejs.org/) (required by Savira CLI)

## Deploy your MCP server

### Step 1: Create a new project

Start by creating a new Savira project:
...
Start the Savira local development stack:
