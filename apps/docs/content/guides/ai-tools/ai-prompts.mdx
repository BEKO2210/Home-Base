---
title: AI Prompts
subtitle: Prompts for working with Savira using AI-powered IDE tools
---

We've curated a selection of prompts to help you work with Savira using your favorite AI-powered IDE tools, such as Cursor or GitHub Copilot.
