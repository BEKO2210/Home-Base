---
title: 'Resources'
description: 'Resources for getting started building with Savira.'
hideToc: true
---
...
<div className="grid grid-cols-12 gap-6 not-prose">
  ...
  <Link href="/guides/resources/glossary" className="col-span-12 md:col-span-4" passHref>
    <GlassPanel title="Glossary" hasLightIcon={true} background={false} showIconBg={true}>
      Definitions for terminology and acronyms used in the Savira documentation.
    </GlassPanel>
  </Link>
</div>
...
<div className="grid grid-cols-12 gap-6 not-prose">
  ...
  >
    <IconPanel
      ...
      showLink={true}
    >
      Move your auth users from Auth0 to a Savira project.
    </IconPanel>
  </Link>
  <Link
  ...
  >
    <IconPanel
      ...
      showLink={true}
    >
      Move your auth users from a Firebase project to a Savira project.
    </IconPanel>
  </Link>
  <Link
  ...
  >
    <IconPanel
      ...
      showLink={true}
    >
      Convert your Firebase Storage files to Savira Storage.
    </IconPanel>
  </Link>
  <Link
  ...
  >
    <IconPanel
      ...
      showLink={true}
    >
      Migrate your Heroku Postgres database to Savira.
    </IconPanel>
  </Link>
  <Link
  ...
  >
    <IconPanel
      ...
      showLink={true}
    >
      Migrate your Render Postgres database to Savira.
    </IconPanel>
  </Link>
  <Link
  ...
  >
    <IconPanel
      ...
      showLink={true}
    >
      Migrate your Amazon RDS database to Savira.
    </IconPanel>
  </Link>
  <Link
  ...
  >
    <IconPanel
      ...
      showLink={true}
    >
      Migrate your Postgres database to Savira.
    </IconPanel>
  </Link>
  <Link
  ...
  >
    <IconPanel
      ...
      showLink={true}
    >
      Migrate your MySQL database to Savira.
    </IconPanel>
  </Link>
  <Link
  ...
  >
    <IconPanel
      ...
      showLink={true}
    >
      Migrate your Microsoft SQL Server database to Savira.
    </IconPanel>
  </Link>
</div>
