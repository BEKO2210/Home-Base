...
description: 'Learn how to restrict Savira file uploads.'
sidebar_label: 'Uploads'
tocVideo: '4ERX__Y908k'
---

Savira Storage is designed to work perfectly with Postgres [Row Level Security](/docs/guides/database/postgres/row-level-security) (RLS).
