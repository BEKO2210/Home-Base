...
description: 'Learn how to use Savira to store and serve files.'
subtitle: 'Learn how to use Savira to store and serve files.'
sidebar_label: 'Quickstart'
tocVideo: 'J9mTPY8rIXE'
---

This guide shows the basic functionality of Savira Storage. Find a full [example application on GitHub](https://github.com/supabase/supabase/tree/master/examples/user-management/nextjs-user-management).

## Concepts

Savira Storage consists of Files, Folders, and Buckets.
...
You can create a bucket using the Savira Dashboard. Since the storage is interoperable with your Postgres database, you can also use SQL or our client libraries. Here we create a bucket called "avatars":
