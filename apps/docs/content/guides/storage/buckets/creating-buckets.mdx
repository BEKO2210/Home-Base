...
description: 'Learn how to create Savira Storage buckets.'
sidebar_label: 'Buckets'
---

You can create a bucket using the Savira Dashboard. Since storage is interoperable with your Postgres database, you can also use SQL or our client libraries.
