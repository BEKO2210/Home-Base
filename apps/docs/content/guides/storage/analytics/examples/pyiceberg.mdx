...
Here's a complete example showing how to connect to your Savira analytics bucket and perform operations:
...
# Configuration - Update with your Savira credentials
