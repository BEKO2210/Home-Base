...
Managed replication into Analytics Buckets through Savira ETL is no longer supported. This guide assumes your Analytics Bucket is being populated by your own ingestion pipeline.
...
1. **Dashboard UI** (recommended) - Streamlined setup through the Savira Dashboard
...
1. Navigate to your **Analytics Bucket** page in the Savira Dashboard.
