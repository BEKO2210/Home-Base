...
subtitle: 'Develop and test vector bucket integrations in your local environment with the Savira CLI.'
---
...
You can now develop and test Vector Bucket integrations in your local environment using the Savira CLI.

This allows you to build and iterate on your vector search applications without needing to deploy to a live environment.
Make sure you have the latest version of the Savira CLI installed to access this feature.
