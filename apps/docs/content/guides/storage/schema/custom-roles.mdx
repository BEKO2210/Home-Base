...
In this guide, you will learn how to create and use custom roles with Storage to manage role-based access to objects and buckets. The same approach can be used to use custom roles with any other Savira service.

Savira Storage uses the same role-based access control system as any other Savira service using RLS (Row Level Security).
...
const JWT_SECRET = 'your-jwt-secret' // You can find this in your Savira project settings under API. Store this securely.
