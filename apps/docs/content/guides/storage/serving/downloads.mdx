...
You can also use the Savira SDK `getPublicUrl` to generate this URL for you
...
If you need to revoke signed URLs, [contact Savira support](/dashboard/support/new?projectRef=).
