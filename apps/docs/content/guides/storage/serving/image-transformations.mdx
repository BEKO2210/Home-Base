...
Savira Storage offers the functionality to optimize and resize images on the fly. Any image stored in your buckets can be transformed and optimized for fast delivery.
...
You can use Savira Image Transformation to optimize your Next.js images using a custom [Loader](https://nextjs.org/docs/api-reference/next/image#loader-configuration).
...
Our solution to image resizing and optimization can be self-hosted as with any other Savira product. Under the hood we use [imgproxy](https://imgproxy.net/).
