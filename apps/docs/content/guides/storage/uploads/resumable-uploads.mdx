...
description: 'Learn how to upload files to Savira Storage.'
subtitle: 'Learn how to upload files to Savira Storage.'
...
>
    ...
    async function uploadFile(bucketName, fileName, file) {
        ...
        return new Promise((resolve, reject) => {
            var upload = new tus.Upload(file, {
                // Savira TUS endpoint (with direct storage hostname)
  ...
  <TabPanel id="react" label="React">
    ...
    /**
     * Custom hook for configuring Uppy with Savira authentication and TUS resumable uploads
     * @param {Object} options - Configuration options for the Uppy instance.
     * @param {string} options.bucketName - The bucket name in Savira where files are stored.
    ...
    export const useUppyWithSupabase = ({ bucketName }: { bucketName: string }) => {
        ...
        // Initialize Savira client with project URL and publishable key
        ...
        useEffect(() => {
            ...
            uppy.use(Tus, {
                    ...
                    headers: {
                        ...
                        apikey: anonKey, // API key for Savira
                    },
            ...
            // Initialize Uppy with Savira settings
            initializeUppy();
        }, [uppy, bucketName]);
