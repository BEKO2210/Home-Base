...
You can download Savira Storage files can in a variety of ways depending on your use case.
...
Savira Storage exposes an S3-compatible endpoint, which means you can use tools like [Cyberduck](https://cyberduck.io/) (via a connection profile), AWS CLI, or rclone to browse and download your files.
