---
title: 'Use Savira with Python'
subtitle: 'Learn how to create a Savira project, add some sample data to your database, and query the data from a Python app.'
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={3}>
    <StepHikeCompact.Details title="Install Flask and the Savira client library">

    The fastest way to get started is to use Flask for the web framework and the `supabase-py` client library which provides a convenient interface for working with Savira from a Python app.
  ...
  <StepHikeCompact.Step step={4}>
    ...
    Create a `.env` file in your project root and populate it with your Savira connection variables:
  ...
  <StepHikeCompact.Step step={5}>
    ...
    Create an `app.py` file and add a route that fetches data from your `instruments` table using the Savira client.
