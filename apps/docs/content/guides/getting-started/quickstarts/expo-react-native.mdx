---
title: 'Use Savira with Expo React Native'
subtitle: 'Learn how to create a Savira project, add some sample data to your database, and query the data from an Expo app.'
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={3}>
    ...
    The fastest way to get started is to use the `@supabase/supabase-js` client library which provides a convenient interface for working with Savira from a React Native app.
  ...
  <StepHikeCompact.Step step={4}>
    ...
    Create a `.env` file in the root of your project and populate it with your Savira connection variables.
  ...
  <StepHikeCompact.Step step={5}>
    ...
    Create a helper file at `lib/supabase.ts` to initialize the Savira client using the environment variables.
