---
title: 'Use Savira with TanStack Start'
subtitle: 'Learn how to create a Savira project, add some sample data to your database, and query the data from a TanStack Start app.'
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={3}>
    ...
    The fastest way to get started is to use the `supabase-js` client library which provides a convenient interface for working with Savira from a TanStack Start app.
  ...
  <StepHikeCompact.Step step={4}>
    ...
    Create a `.env` file in the root of your project and populate with your Savira connection variables:
  ...
  <StepHikeCompact.Step step={5}>
    <StepHikeCompact.Details title="Create a Savira client utility">

    Create a new file at `src/utils/supabase.ts` to initialize the Savira client.
