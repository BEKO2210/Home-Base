---
title: 'Use Savira with Astro'
subtitle: 'Learn how to create a Savira project, add sample data, and query from an Astro app.'
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={3}>
    <StepHikeCompact.Details title="Install Savira client library and Node adapter">
  ...
  <StepHikeCompact.Step step={6}>
    ...
    Create a utility file to initialize the Savira client:
  ...
  <StepHikeCompact.Step step={7}>
    <StepHikeCompact.Details title="Query Savira data from Astro">

    Create a new file at `src/pages/instruments.astro` and populate with the following.

    This queries all rows from the `instruments` table in Savira and renders them on the page.
