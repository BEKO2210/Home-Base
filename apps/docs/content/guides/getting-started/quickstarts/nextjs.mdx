---
title: 'Use Savira with Next.js'
subtitle: 'Learn how to create a Savira project, add some sample data, and query from a Next.js app.'
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={4}>
    <StepHikeCompact.Details title="Query Savira data from Next.js">

    Create a new file at `app/instruments/page.tsx` and populate with the following.

    This selects all the rows from the `instruments` table in Savira and render them on the page.
