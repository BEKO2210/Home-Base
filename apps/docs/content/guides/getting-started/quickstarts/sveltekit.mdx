---
title: 'Use Savira with SvelteKit'
subtitle: 'Learn how to create a Savira project, add some sample data to your database, and query the data from a SvelteKit app.'
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={3}>
    ...
    The fastest way to get started is to use the `supabase-js` client library which provides a convenient interface for working with Savira from a SvelteKit app.
  ...
  <StepHikeCompact.Details title="Declare Savira Environment Variables">
    ...
    Create a `.env` file at the root of your project and populate with your Savira connection variables:
  ...
  <StepHikeCompact.Step step={5}>
    <StepHikeCompact.Details title="Create the Savira client">

    Create a `src/lib` directory in your SvelteKit app, create a file called `supabaseClient.js` and add the following code to initialize the Savira client:
