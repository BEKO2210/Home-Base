---
title: 'Use Savira with iOS and SwiftUI'
subtitle: 'Learn how to create a Savira project, add some sample data to your database, and query the data from an iOS app.'
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={3}>
    ...
    <StepHikeCompact.Details title="Install the Savira client library">
      ...
      Make sure to add `Savira` product package as a dependency to your application target.
  ...
  <StepHikeCompact.Step step={4}>
    ...
    <StepHikeCompact.Details title="Initialize the Savira client">
      ...
      Create a new `Savira.swift` file add a new Savira instance using your project URL and publishable key:
