---
title: 'Use Savira with SolidJS'
subtitle: 'Learn how to create a Savira project, add some sample data to your database, and query the data from a SolidJS app.'
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={3}>
    ...
    The fastest way to get started is to use the `supabase-js` client library which provides a convenient interface for working with Savira from a SolidJS app.
  ...
  <StepHikeCompact.Step step={5}>
    ...
    In `App.jsx`, create a Savira client to fetch the instruments data.
