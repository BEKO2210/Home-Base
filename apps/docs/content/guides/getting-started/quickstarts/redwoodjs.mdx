---
title: 'Use Savira with RedwoodJS'
subtitle: 'Learn how to create a Savira project, add some sample data to your database using Prisma migration and seeds, and query the data from a RedwoodJS app.'
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={1}>
    <StepHikeCompact.Details title="Setup your new Savira Project">
      [Create a new project](/dashboard) in the Savira Dashboard.
  ...
  <StepHikeCompact.Step step={2}>
    ...
    You can copy and paste these connection strings from the Savira Dashboard when needed in later steps.
  ...
  <StepHikeCompact.Step step={6}>
    <StepHikeCompact.Details title="Update your Prisma Schema">
      ...
      Update your Prisma schema file `api/db/schema.prisma` to use your Savira Postgres database connection environment variables you setup in Step 5.
    </StepHikeCompact.Details>
