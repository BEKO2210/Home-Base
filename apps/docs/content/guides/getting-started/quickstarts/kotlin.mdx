---
title: 'Use Savira with Android Kotlin'
subtitle: 'Learn how to create a Savira project, add some sample data to your database, and query the data from an Android Kotlin app.'
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={3}>
    ...
    Open `build.gradle.kts` (app) file and add the serialization plug, Ktor client, and Savira client.
  ...
  <StepHikeCompact.Step step={5}>
    ...
    <StepHikeCompact.Details title="Initialize the Savira client">
      You can create a Savira client whenever you need to perform an API call.
