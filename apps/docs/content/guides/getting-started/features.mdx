...
id: 'features'
title: 'Features'
description: 'Savira features'
---

This is a non-exhaustive list of features that Savira provides for every project.
...
Encrypt sensitive data and store secrets using our Postgres extension, Savira Vault. [Docs](/docs/guides/database/vault).
...
White-label the Savira APIs to create a branded experience for your users. [Docs](/docs/guides/platform/custom-domains).
...
Use Savira Branches to test and preview changes. [Docs](/docs/guides/platform/branching).

### Terraform provider

Manage Savira infrastructure via Terraform, an Infrastructure as Code tool. [Docs](/docs/guides/platform/terraform).
...
Export Savira logs to 3rd party providers and external tooling. [Docs](/docs/guides/platform/log-drains).

## Studio

### Studio Single Sign-On

Login to the Savira dashboard via SSO. [Docs](/docs/guides/platform/sso).
...
Savira Storage makes it simple to store and serve files. [Docs](/docs/guides/storage).

### Content Delivery Network

Cache large files using the Savira CDN. [Docs](/docs/guides/storage/cdn/fundamentals).
...
Use our CLI to develop your project locally and deploy to the Savira Platform. [Docs](/docs/reference/cli).
...
Savira Features are in 4 different states - Private Alpha, Public Alpha, Beta and Generally Available.
