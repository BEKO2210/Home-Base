...
description: 'Learn how to use Savira in your Vue 3 App.'
---
...
With the API credentials in place, create an `src/supabase.js` helper file to initialize the Savira client. These variables are exposed
...
![Savira Vue 3](/docs/img/supabase-vue-3-demo.png)
