...
description: 'Learn how to use Savira in your Ionic Angular App.'
---

<$Partial path="quickstart_intro.mdx" />

![Savira User Management example](/docs/img/ionic-demos/ionic-angular-account.png)
...
Now that you have the API credentials in place, create a `SupabaseService` with `ionic g s supabase` to initialize the Savira client and implement functions to communicate with the Savira API.
...
![Savira Angular](/docs/img/ionic-demos/ionic-angular.png)

## Bonus: Profile photos

Every Savira project is configured with [Storage](/docs/guides/storage) for managing large files like photos and videos.
...
- [Authentication in Ionic Angular with Savira](/blog/authentication-in-ionic-angular)
