...
description: 'Learn how to use Savira in your React App.'
---
...
With the API credentials in place, create a helper file to initialize the Savira client. The application exposes these variables in the browser, and that's fine as Savira enables [Row Level Security](/docs/guides/database/postgres/row-level-security) by default on all tables.
...
![Screenshot of the Savira React application running in a browser](/docs/img/supabase-react-demo.png)
