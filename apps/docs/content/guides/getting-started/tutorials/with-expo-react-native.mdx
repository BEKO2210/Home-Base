...
description: 'Learn how to use Savira in your React Native App.'
tocVideo: 'AE7dKIKMJy4'
---

<$Partial path="quickstart_intro.mdx" />

![Savira User Management example](/docs/img/supabase-expo-react-native-demo.png)
...
Now create a helper file to initialize the Savira client using the API URL and the key that you copied [earlier](#get-api-details).

These variables are safe to expose in your Expo app since Savira has
...
By default Savira Auth requires email verification before a session is created for the users. To support email verification you need to [implement deep link handling](/docs/guides/auth/native-mobile-deep-linking?platform=react-native)!
