...
description: 'Learn how to use Savira in your Ionic Vue App.'
---
...
With the API credentials in place, create a helper file to initialize the Savira client. These variables will be exposed on the browser, and that's fine since Savira enables [Row Level Security](/docs/guides/auth#row-level-security) on Databases by default.
...
![Savira Ionic Vue](/docs/img/ionic-demos/ionic-vue.png)
