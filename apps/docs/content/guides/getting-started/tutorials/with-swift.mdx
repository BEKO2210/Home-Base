...
description: 'Learn how to use Savira in your SwiftUI App.'
---

<$Partial path="quickstart_intro.mdx" />

![Savira User Management example](/docs/img/supabase-swift-demo.png)
...
Create a helper file to initialize the Savira client.
...
The example uses a custom `redirectTo` URL. For this to work, add a custom redirect URL to Savira and a custom URL scheme to your SwiftUI application. Follow the guide on [implementing deep link handling](/docs/guides/auth/native-mobile-deep-linking?platform=swift).
...
In `ProfileView.swift`, you used 2 model types for deserializing the response and serializing the request to Savira. Add those in a new `Models.swift` file.
