...
description: 'Learn how to use Savira in your Ionic React App.'
---
...
With the API credentials in place, create a helper file to initialize the Savira client. These variables will be exposed
...
![Savira Ionic React](/docs/img/ionic-demos/ionic-react.png)
