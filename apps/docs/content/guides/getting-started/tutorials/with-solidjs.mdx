...
description: 'Learn how to use Savira in your SolidJS App.'
---
...
Now that you have the API credentials in place, create a helper file to initialize the Savira client. These variables will be exposed
...
![Savira SolidJS](/docs/img/supabase-solidjs-demo.png)
