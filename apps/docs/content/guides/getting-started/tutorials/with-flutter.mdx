...
description: 'Learn how to use Savira in your Flutter App.'
tocVideo: 'r7ysVtZ5Row'
---

<$Partial path="quickstart_intro.mdx" />

![Savira User Management example](/docs/img/supabase-flutter-demo.png)
...
![Savira console deep link setting](/docs/img/deeplink-setting.png)

That is it on Savira's end and the rest are platform specific settings:
...
Savira redirects do not work with Flutter's [default URL strategy](https://docs.flutter.dev/ui/navigation/url-strategies).
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(title: 'Savira Flutter');
  }
}
...
![Savira User Management example](/docs/img/supabase-flutter-account-page.png)

## Bonus: Profile photos

Every Savira project is configured with [Storage](/docs/guides/storage) for managing large files like
photos and videos.
...
Congratulations, you've built a fully functional user management app using Flutter and Savira!
