...
description: 'Learn how to use Savira in your Nuxt 3 App.'
---
...
Then let's install the only additional dependency: [Nuxt Savira](https://supabase.nuxtjs.org/). We only need to import Nuxt Savira as a dev dependency.
...
Amazing thing about [Nuxt Savira](https://supabase.nuxtjs.org/) is that setting environment variables is all we need to do in order to start using Savira.
No need to initialize Savira. The library will take care of it automatically.
...
<template>
  <form class="row flex-center flex" @submit.prevent="handleLogin">
    <div class="col-6 form-widget">
      <h1 class="header">Savira + Nuxt 3</h1>
...
To access the user information, use the composable [`useSupabaseUser`](https://supabase.nuxtjs.org/composables/usesupabaseuser) provided by the Savira Nuxt module.
...
![Savira Nuxt 3](/docs/img/supabase-vue-3-demo.png)
