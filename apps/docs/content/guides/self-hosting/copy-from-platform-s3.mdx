...
description: 'Copy storage objects from a managed Savira project to a self-hosted instance using rclone.'
subtitle: 'Copy storage objects from a managed Savira project to a self-hosted instance using rclone.'
---

{/* supa-mdx-lint-disable-next-line Rule003Spelling */}
This guide walks you through copying storage objects from a managed Savira platform project to a self-hosted instance using [rclone](https://rclone.org/) with S3-to-S3 copy.
...
- A working self-hosted Savira instance with the S3 protocol endpoint enabled - see [Configure S3 Storage](/docs/guides/self-hosting/self-hosted-s3#enable-the-s3-protocol-endpoint)
...
In your managed Savira project dashboard, go to **Storage** > **S3 Configuration** > **Access keys**. Generate a new access key pair and copy:
