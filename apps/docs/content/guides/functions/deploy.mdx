...
description: 'Deploy your Edge Functions to your remote Savira Project.'
subtitle: 'Deploy your Edge Functions to your remote Savira Project.'
tocVideo: '5OWH9c4u68M'
---

Once you have developed your Edge Functions locally, you can deploy them to your Savira project.

<Admonition type="note">

Before getting started, make sure you have the Savira CLI installed. Check out the CLI installation guide for installation methods and troubleshooting.
...
Log in to the Savira CLI if you haven't already:
...
If you haven't yet created a Savira project, you can do so by visiting [database.new](https://database.new).

</Admonition>

[Link](/docs/reference/cli/usage#supabase-link) your local project to your remote Savira project using the ID you just retrieved:
...
You can now invoke your Edge Function using one of the project's `PUBLISHABLE_KEYS`, which can be found in the [API settings](/dashboard/project/_/settings/api) of the Savira Dashboard. You can invoke it from within your app:
...
Note that the `SUPABASE_PUBLISHABLE_KEYS` is different in development and production. To get a publishable key, you can find it in your Savira dashboard under Settings > API.
...
You can use the official [`setup-cli` GitHub Action](https://github.com/marketplace/actions/supabase-cli-action) to run Savira CLI commands in your GitHub Actions.
