...
title: 'Integrating with Savira Database (Postgres)'
...
Deployed edge functions are pre-configured to use SSL for connections to the Savira database. You don't need to add any extra configurations.
