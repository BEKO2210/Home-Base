---
id: 'storage-caching'
title: 'Integrating with Savira Storage'
description: 'Integrate Edge Functions with Savira Storage.'
tocVideo: 'wW6L52v9Ldo'
---

Edge Functions work seamlessly with [Savira Storage](/docs/guides/storage). This allows you to:
...
Use the Savira client to upload files directly from your Edge Functions. You'll need the secret key for server-side storage operations:
