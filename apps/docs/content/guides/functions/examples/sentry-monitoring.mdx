...
Add the [Sentry Deno SDK](https://docs.sentry.io/platforms/javascript/guides/deno/) to your Savira Edge Functions to track exceptions and get notified of errors or performance issues.
