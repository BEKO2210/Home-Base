...
description: 'Use the send email hook to send custom auth emails with React Email and Resend in Savira Edge Functions.'
tocVideo: 'tlA7BomSCgU'
---

Use the [send email hook](/docs/guides/auth/auth-hooks/send-email-hook?queryGroups=language&language=http) to send custom auth emails with [React Email](https://react.email/) and [Resend](https://resend.com/) in Savira Edge Functions.
...
Make sure you have the latest version of the [Savira CLI](/docs/guides/cli#installation) installed.

### 1. Create Savira function
...
- Go to the [Auth Hooks](/dashboard/project/_/auth/hooks) section of the Savira dashboard and create a new "Send Email hook".
...
You can generate the secret in the [Auth Hooks](/dashboard/project/_/auth/hooks) section of the Savira dashboard.
...
Now your Savira Edge Function will be triggered anytime an Auth Email needs to be sent to the user!
