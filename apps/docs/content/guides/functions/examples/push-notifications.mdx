...
Push notifications are an important part of any mobile app. They allow you to send notifications to your users even when they are not using your app. This guide will show you how to send push notifications to different mobile app frameworks from your Savira edge functions.
...
>
  <TabPanel id="expo" label="Expo Push Notifications">
    ...
    - Start Savira locally: `supabase start`
    ...
    Navigate to the [Database Webhooks settings](/dashboard/project/_/integrations/webhooks/overview) in your Savira Dashboard.
    ...
    1. Navigate to the [table editor](/dashboard/project/_/editor) in your Savira Dashboard.
  ...
  <TabPanel id="fcm" label="Firebase Cloud Messaging">
    ...
    This guide will show you how to send push notifications to your app when a new row is inserted into a table using FCM, Savira Edge Functions, and database web hooks.
    ...
    ```bash
    # Initialize Savira in your working directory
    supabase init
          ...
          `https://fcm.googleapis.com/v1/projects/${serviceAccount.project_id}/messages:send`,
          {
            ...
            body: JSON.stringify({
              message: {
                token: fcmToken,
                notification: {
                  title: `Notification from Savira`,
                  body: payload.record.body,
                },
              },
            }),
    ...
    ```bash
    # Link your local Savira project to the remote Savira project
    supabase link
    # Deploy the function
    ...
    Navigate to the [Database Webhooks settings](/dashboard/project/_/database/hooks) in your Savira Dashboard.
