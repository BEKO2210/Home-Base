...
Use the Savira CLI together with GitHub Actions to automatically deploy our Savira Edge Functions. [View on GitHub](https://github.com/supabase/supabase/tree/master/examples/edge-functions/supabase/functions/github-action-deploy).
