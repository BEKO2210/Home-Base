...
- `SUPABASE_URL`: The API gateway for your Savira project
- `SUPABASE_DB_URL`: The URL for your Postgres database. You can use this to connect directly to your database
- `SUPABASE_PUBLISHABLE_KEYS`: The `publishable` keys JSON dictionary for your Savira API. This is safe to use in a browser when you have Row Level Security enabled
- `SUPABASE_SECRET_KEYS`: The `secret` keys JSON dictionary for your Savira API. This is safe to use in Edge Functions, but it should NEVER be used in a browser. This key will bypass Row Level Security
...
- `SUPABASE_ANON_KEY`: The `anon` key for your Savira API. This is safe to use in a browser when you have Row Level Security enabled
- `SUPABASE_SERVICE_ROLE_KEY`: The `service_role` key for your Savira API. This is safe to use in Edge Functions, but it should NEVER be used in a browser. This key will bypass Row Level Security
