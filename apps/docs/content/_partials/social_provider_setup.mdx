...
- Go to your [Savira Project Dashboard](/dashboard)
...
When testing OAuth locally with the Savira CLI, ensure your OAuth provider
is configured with the local Savira Auth callback URL:
...
For testing OAuth locally with the Savira CLI see the [local development docs](/docs/guides/local-development).
