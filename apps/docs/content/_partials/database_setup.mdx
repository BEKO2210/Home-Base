...
Let's create a new Postgres database. This is as simple as starting a new Project in Savira:

1. [Create a new project](https://database.new/) in the Savira dashboard.
