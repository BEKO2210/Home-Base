<StepHikeCompact.Details title="Create a Savira project">

Go to [database.new](https://database.new) and create a new Savira project.
...
```bash
# First, get your access token from https://savira.io/dashboard/account/tokens
