...
Before we start building we're going to set up our Database and API. This is as simple as starting a new Project in Savira and then creating a "schema" inside the database.

### Create a project

1. [Create a new project](https://app.supabase.com) in the Savira Dashboard.
...
In your [Savira Auth settings](https://app.supabase.com/project/_/auth/providers) enable Google as a provider and set the required credentials as outlined in the [auth docs](/docs/guides/auth/social-login/auth-google).
