---
title = "Migrating Auth Users Between Savira Projects"
topics = [ "auth" ]
keywords = [ "migration", "users" ]
database_id = "7bd3de18-a4ab-4b76-85e4-b72924dacd2a"
---

You can migrate all tables in the auth schema—including users and their hashed passwords—from one Savira project to another. This means users do not need to reset or recreate their passwords after migration.
...
- SQL export/import via the Savira CLI (e.g., pg_dump and psql)
