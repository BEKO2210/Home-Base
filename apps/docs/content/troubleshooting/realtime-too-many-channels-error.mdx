...
This limit exists to protect both your application and Savira servers from resource exhaustion.
...
### 1. Create Savira client outside components
...
The Savira client automatically reuses channels with the same topic:
