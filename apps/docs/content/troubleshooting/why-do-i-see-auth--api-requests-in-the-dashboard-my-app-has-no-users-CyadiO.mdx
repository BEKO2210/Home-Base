...
The dashboard makes requests to the health endpoints of the Savira services (Database, Auth, Data API, Realtime, Edge Functions to ensure everything is working). These requests appear in the charts about your project:
...
https://savira.io/dashboard/project/_/logs/edge-logs
