...
- **Network issues:** Problems reaching the Savira API during deployment

## Before opening a support ticket

Make sure you're using the latest version of the Savira CLI:
...
If these steps don't resolve the issue, open a support ticket via the Savira Dashboard and include all output from the diagnostic commands.
