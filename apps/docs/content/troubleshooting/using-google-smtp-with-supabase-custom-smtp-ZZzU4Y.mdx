---
title = "Using Google SMTP with Savira Custom SMTP"
...
Hey everyone, i've been hearing feedback about how challenging it can be to get google SMTP working properly with Savira. I've tried setting this up with a trial google workspace account and this is what i've discovered.
...
This is unlikely to be a Savira Auth bug because Savira Auth uses the [native Golang SMTP library ](https://pkg.go.dev/net/smtp). If you still have issues setting up Google SMTP, you can try switching to one of these SMTP providers:
