...
[What Events Are Logged in Savira](https://gist.github.com/TheOtherBrian1/991d32c2b00dbc75d29b80d4cdf41aa7)
...
For more information on how to debug functions in Savira, refer to the official guide: [Debugging Functions](/docs/guides/database/functions?queryGroups=language&language=js#debugging-functions).
