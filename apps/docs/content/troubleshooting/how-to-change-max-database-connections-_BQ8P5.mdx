...
You can configure the maximum amount of connections that Postgres will tolerate with the [Savira CLI.](/docs/guides/platform/custom-postgres-config)
...
> If you do not know how to monitor memory and CPU with Savira Grafana, [check here](https://github.com/orgs/supabase/discussions/27141).
