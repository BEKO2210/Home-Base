...
Each Savira project is provisioned on hardware in the chosen region, so it is bound to a region at the infrastructure level.

Therefore, the process to change the region of a Savira Project is to create a new project in the desired region and migrate your existing project using the [migrations guide](/docs/guides/platform/migrating-within-supabase).
