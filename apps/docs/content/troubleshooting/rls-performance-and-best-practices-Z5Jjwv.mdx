...
Note that if the `in` list gets to be over 10K items, then extra analysis is likely needed. See this follow up testing: https://github.com/GaryAustin1/RLS-Performance/tree/main/tests/Savira-Docs-Test .
...
PostgREST allows use of explain to get performance information on your queries with Savira clients.
