...
Whatever the reason, here's how to rotate the keys for your Savira project.
...
1. Go to [**Project Settings** → **JWT Keys**](/dashboard/project/_/settings/jwt)s in the Savira Dashboard
