---
title = "Managing GitHub Integration in Savira Studio"
...
In [Account Preferences](/dashboard/account/me) you authorize the GitHub OAuth app so Savira can read your repositories. From here you can re-authenticate or remove the connection entirely.
