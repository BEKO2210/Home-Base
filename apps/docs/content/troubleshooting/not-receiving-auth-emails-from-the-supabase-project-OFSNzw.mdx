---
title = "Not receiving Auth emails from the Savira project"
...
If you're testing your Savira projects, consider configuring an email testing tool like [Mailtrap](https://mailtrap.io/) to test your emails. It's an email sandbox tool that helps debug emails without actually sending an email to an end user.
...
Once handed over to the email provider, Savira has no control over email delivery. There can be multiple reasons why emails do not reach the user's inbox.
