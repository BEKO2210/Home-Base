---
title = "Transferring from platform to self-hosted Savira"
...
For a detailed, step-by-step guide on restoring your database from the Savira platform to a [self-hosted Savira](/docs/guides/self-hosting) instance, see [Restore a Platform Project to Self-Hosted](/docs/guides/self-hosting/restore-from-platform).
