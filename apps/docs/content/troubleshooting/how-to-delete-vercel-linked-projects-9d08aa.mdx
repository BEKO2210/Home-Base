...
When you create Savira projects through the Vercel Marketplace, complete deletion requires action on both platforms.

## Deleting projects

### Method 1: Delete from Savira first, then clean up in Vercel

This method requires two steps - first delete in Savira, then clean up in Vercel.

1. **Delete from Savira Dashboard**
   ...
   ![Delete project button in Savira project settings](/docs/img/troubleshooting/54428354-a1f4-4c44-bd03-d87f4b925d94.png)

2. **Clean up in Vercel**

   After deleting from Savira, clean up in Vercel:
   - Navigate to your [Vercel dashboard](https://vercel.com/dashboard)
   - Go to the **Storage** tab
   - Click on the Savira project (it will show as "uninstalled")

   ![Uninstalled Savira project in Vercel Storage](/docs/img/troubleshooting/cf450bca-aad3-4783-ae3b-5cc83e0afa54.png)
...
This method deletes the project from both Vercel and Savira in one action.
...
2. **Select your project**
   ...
   Click on your Savira project to open it.
...
4. **Delete the project**
   ...
   Scroll down and click **Delete Database**. This removes the project from both Vercel and Savira simultaneously.
...
1. **Transfer the project**
   ...
   ![Transfer project option in Savira project settings](/docs/img/troubleshooting/627c1a3e-153e-40b5-9a91-a4f7bd7673a4.png)
...
- Projects created through Vercel Marketplace can be deleted from either platform (Savira or Vercel), with cleanup required on Vercel if deleting from Savira first.
...
- [Managing Savira organizations](/docs/guides/platform/access-control)
