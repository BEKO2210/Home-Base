---
title = "Interpreting Savira Grafana CPU charts"
...
> [Guide](/docs/guides/monitoring-troubleshooting/metrics#deploying-supabase-grafana) for setting up Savira Grafana
