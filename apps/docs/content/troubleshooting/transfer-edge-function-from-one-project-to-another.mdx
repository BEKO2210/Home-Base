...
This guide shows how you can transfer your Edge Functions from one project to another using the Savira CLI or the Savira Dashboard.
...
- You must have installed the [Savira CLI tool](/docs/guides/local-development/cli/getting-started#installing-the-supabase-cli)
- Both source and target projects must be active

## Steps (using the Savira CLI):

1. Login to your Savira account (the account with the functions) using your terminal
...
With this, you can transfer your edge functions between your Savira projects.
