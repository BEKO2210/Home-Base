---
title = "Savira & Your Network: IPv4 and IPv6 compatibility"
...
# Network compatibility with your Savira database
...
All Savira databases provide a direct connection string that maps to an IPv6 address.
...
- Use the [Savira Client libraries](/docs/guides/api/rest/client-libs), which are IPv4 compatible.
