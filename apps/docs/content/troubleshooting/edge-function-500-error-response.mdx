...
- If the error references a JavaScript internal, make sure it is compatible with the Savira Runtime. If not, consider refactoring or updating the library's version
