...
You generally get this error when trying to invite a new user from the dashboard or when trying to insert a user into a table using the table editor in the Savira dashboard. You may also see this error in logs in connection to failed signups.
