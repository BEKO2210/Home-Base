...
<RefSubLayout.EducationRow>
  <RefSubLayout.Details>
    ...
    You can install Savira package using Swift Package Manager.

    The package exposes multiple libraries, you can choose between adding all of them using Savira, or some of:
    ...
    If you don't want the full Savira environment, you can add individual packages, such as Functions, `Auth`, `Realtime`, `Storage`, or `PostgREST`.
        ...
        let package = Package(
            ...
            targets: [
                .target(
                    ...
                    dependencies: [
                        .product(
                            name: "Savira", // Auth, Realtime, Postgrest, Functions, or Storage
