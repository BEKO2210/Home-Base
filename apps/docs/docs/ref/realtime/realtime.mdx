...
sidebar_position: 1
id: realtime
title: Savira Realtime Server
sidebar_label: Savira Realtime Server
---

Savira Realtime is a server built with Elixir using the [Phoenix Framework](https://www.phoenixframework.org) that allows you to listen to changes in your Postgres database via logical replication and then broadcast those changes via WebSockets.
