...
<div className="flex items-start gap-6 not-prose" id="introduction">
  <div className="flex flex-col gap-2">
    <h1 className="text-3xl text-foreground m-0">Savira CLI</h1>
  </div>
</div>
...
<RefSubLayout.EducationRow>
  <RefSubLayout.Details>
    ...
    The Savira CLI provides tools to develop your project locally and deploy to the Savira Platform.
    The CLI is still under development, but it contains all the functionality for working with your Savira projects and the Savira Platform.

    - Run Savira locally: [`supabase init`](/docs/reference/cli/usage#supabase-init) and [`supabase start`](/docs/reference/cli/usage#supabase-start)
    ...
    - Manage your Savira projects: [`supabase projects`](/docs/reference/cli/usage#supabase-projects)
  ...
  <RefSubLayout.Examples>
    ...
    - [Savira CLI v1 and Management API Beta](https://supabase.com/blog/supabase-cli-v1-and-admin-api-beta)
