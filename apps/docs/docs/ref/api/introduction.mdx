...
<RefSubLayout.EducationRow>
  <RefSubLayout.Details>
      ...
      Manage your Savira organizations and projects programmatically.
      ...
      2. **OAuth2:**
      OAuth2 allows your application to generate tokens on behalf of a Savira user, providing secure and limited access to their account without requiring their credentials. Use this if you're building a third-party app that needs to create or manage Savira projects on behalf of your users. Tokens generated via OAuth2 are short-lived and tied to specific scopes to ensure your app can only perform actions that are explicitly approved by the user.

          See [Build a Savira Integration](/docs/guides/integrations/build-a-supabase-integration) to set up OAuth2 for your application.
