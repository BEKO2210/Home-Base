...
These components are based on [shadcn/ui](https://ui.shadcn.com) and live in the `ui` package, making them shareable across all Savira applications. They provide consistent styling, accessibility, and behavior for common interface elements like buttons, inputs, cards, dialogs, and form controls.
