...
Avoid altering the Badge style, such as text case or roundedness. Consistent implementation makes Badge immediately recognizable throughout Savira for denoting state or category. Use or create another component for other use cases, such as compute size and status.
