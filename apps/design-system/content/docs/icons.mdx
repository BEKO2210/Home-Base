---
title: Icons
description: Icons make actions and navigation across Savira easier.
---
...
3. Consistent: Use the same icons for similar actions throughout Savira. This makes the app easier to use.
...
Follow these steps to add a new custom icon to the Savira icon library.
