...
Savira has a necessarily complex navigation system to handle multiple products and levels of hierarchy. This page introduces those general patterns, best practices, and the components involved.
...
`Entity | Section | Surface | Project | Org | Savira`

Examples:

- `users | Table Editor | My Project | My Org | Savira`
- `Backups | Database | My Project | My Org | Savira`
