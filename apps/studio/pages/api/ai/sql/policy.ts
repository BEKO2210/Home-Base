  ...
  try {
    ...
    const { experimental_output } = await generateText({
      ...
      prompt: source`
        ...
        Determine the most appropriate policies for the "${schema}"."${tableName}" table within a Savira project.
        ...
        - Avoid duplicating existing policies and reference the public schema and typical Savira best practices when deciding the coverage.
