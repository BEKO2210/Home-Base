...
export const ToggleLegacyApiKeysPanel = () => {
  ...
  const appsWarning = isAuthorizedAppsError
    ? {
        ...
        description: (
          <>
            Disabling legacy API keys can break apps that integrate with Savira. Before
    ...
    : {
        title: 'Apps using Savira may break',
        description: (
          <>
            Your project uses apps that integrate with Savira. Disabling the legacy API keys is a
