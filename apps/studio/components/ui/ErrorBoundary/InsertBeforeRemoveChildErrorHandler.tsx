      ...
      <div className="flex flex-col gap-y-4 text-left py-2 w-full">
        ...
        <div className="flex flex-col gap-y-2">
          <p className="text-sm text-foreground-light">
            ...
            extensions are known to cause errors when using the Savira Dashboard.
          </p>
          ...
          <p className="text-sm text-foreground-light">
            ...
            while using the Savira Dashboard to avoid running into this error. Try to refresh the
