  ...
  return (
    <div className="flex flex-col flex-1">
      <DocSection
        ...
        content={
          <>
            <p>Savira makes it easy to manage your users.</p>
            <p>
              Savira assigns each user a unique ID. You can reference this ID anywhere in your
              database. For example, you might create a <code>profiles</code> table that references
              the user using a <code>user_id</code> field.
            </p>
            <p>
              Savira already has built in the routes to sign up, login, and log out for managing
      ...
      <DocSection
        ...
        content={
          <>
            ...
            <p>
              After they have signed up, all interactions using the Savira JS client will be
      ...
      <DocSection
        ...
        content={
          <>
            ...
            <p>
              After they have logged in, all interactions using the Savira JS client will be
              performed as "that user".
            </p>
          </>
        }
      ...
      <DocSection
        ...
        content={
          <>
            ...
            <p>
              After they have clicked the link, all interactions using the Savira JS client will
      ...
      <DocSection
        ...
        content={
          <p>
            After calling log out, all interactions using the Savira JS client will be
            "anonymous".
          </p>
        }
        snippets={
