  ...
  return (
    <div className="flex flex-col flex-1">
      ...
      <DocSection
        title={
          <>
            GraphQL <span className="lowercase font-normal">vs</span> Savira
          </>
        }
        content={
          <>
            ...
            <p>
              ...
              with Apollo GraphQL and Savira.
            </p>
            <h4 className="text-foreground-light mt-8 font-medium">Still want GraphQL?</h4>
            <p>
              If you still want to use GraphQL, you can. Savira provides you with a full Postgres
