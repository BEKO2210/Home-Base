      ...
      <ScaffoldSection isFullWidth>
        {isLoadingEntitlement || (hasAccessToSso && isLoadingSSOConfig) ? (
          ...
          <UpgradeToPro
            ...
            secondaryText="SSO as a login option provides additional account security for your team by enforcing the use of an identity provider when logging into Savira. Upgrade to Team or above to set up SSO for your organization."
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItemLayout
                              ...
                              description="Allow users to start the login flow from the Savira dashboard by entering their email address. Requires configuring email domains below."
                            >
                              <FormControl>
                                <Switch checked={field.value} onCheckedChange={field.onChange} />
                              </FormControl>
                          ...
                          >
                            <div className="space-y-3 text-sm">
                              ...
                              <div>
                                ...
                                directly authenticated into Savira. Works automatically without
