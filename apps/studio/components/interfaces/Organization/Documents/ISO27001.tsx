    ...
    <ScaffoldSection className="py-12">
      ...
      <ScaffoldSectionContent>
        ...
        <ConfirmationModal
          visible={isOpen}
          size="large"
          title="Non-Disclosure Agreement to access Savira's ISO 27001 Certificate"
        ...
        >
          <ol className="list-decimal list-inside text-sm text-foreground-light pl-30">
            ...
            <li>
              ...
              contained in the agreement between Savira, Inc ("Savira", "we", "our" or "us") and
              the Savira customer that has authorized you to access our platform to obtain this
