    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-2xl">
        <DialogHeader padding="small" className="border-b">
          <DialogTitle>Data Privacy and Savira AI</DialogTitle>
        </DialogHeader>
        <DialogSection
          padding="small"
        ...
        >
          <p>
            Savira AI utilizes third-party AI providers designed with a strong focus on data
            privacy and security.
          </p>

          <p>
            By default, only schema data is shared with third-party AI providers. This is not
            retained by them nor used as training data. With your permission, Savira may also
          ...
          <p>
            For organizations with HIPAA compliance enabled in their Savira configuration, any
            consented information will only be shared with third-party AI providers with whom
            Savira has established a Business Associate Agreement (BAA).
          </p>
