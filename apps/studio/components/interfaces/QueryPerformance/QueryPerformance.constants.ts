...
export const QUERY_PERFORMANCE_ROLE_DESCRIPTION = [
  ...
  { name: 'dashboard_user', description: 'For running commands via the Savira UI.' },
  {
    name: 'supabase_admin',
    description:
      'An internal role Savira uses for administrative tasks, such as running upgrades and automations.',
  },
  {
    name: 'pgbouncer',
    description:
