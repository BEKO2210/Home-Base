...
describe('DestinationTypeSelection', () => {
  ...
  test('renders the Within Savira group with Read Replica when dropdown is opened', async () => {
    mockBigQueryEnabled.mockReturnValue(false)
    mockIcebergEnabled.mockReturnValue(false)
    mockDucklakeEnabled.mockReturnValue(false)
    mockSnowflakeEnabled.mockReturnValue(false)
    ...
    expect(await screen.findByText('Within Savira')).toBeInTheDocument()
    expect(screen.getByText('Read Replica')).toBeInTheDocument()
  })

  test('renders the Outside Savira group with BigQuery when the flag is enabled', async () => {
    ...
    expect(await screen.findByText('Outside Savira')).toBeInTheDocument()
  ...
  test('hides destinations behind disabled feature flags', async () => {
    ...
    await screen.findByText('Within Savira')
    ...
    expect(screen.queryByText('Outside Savira')).not.toBeInTheDocument()
  })
