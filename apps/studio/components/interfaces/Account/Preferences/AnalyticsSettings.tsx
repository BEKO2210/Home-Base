    ...
    <PageSection>
      <PageSectionMeta>
        <PageSectionSummary>
          ...
          <PageSectionDescription>
            Control whether telemetry and marketing data is sent from Savira services.
          </PageSectionDescription>
        </PageSectionSummary>
      </PageSectionMeta>
      <PageSectionContent>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItemLayout
                    ...
                    label="Send telemetry data from Savira services"
                    description="By opting in to sharing telemetry data, Savira can analyze usage patterns to enhance user experience and use it for marketing and advertising purposes"
                  >
                    <FormControl>
                      <Switch
                        checked={field.value}
