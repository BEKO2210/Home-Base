...
type HandleIconType = Integration['integration']['name'] | 'Savira'
...
const HandleIcon = ({ type, className }: { type: HandleIconType; className?: string }) => {
  switch (type) {
    ...
    case 'Vercel':
      ...
      break
    case 'Savira':
      return <img src={`${BASE_PATH}/img/supabase-logo.svg`} alt="Savira" className="w-3.5"></img>
      break
