...
export const StripeSyncChangesCard = ({
  ...
  const title = isInstalledWithUpgrade
    ? 'This integration will upgrade your Savira project:'
    : uninstallDone || installError
      ? 'This integration will modify your Savira project:'
      : isInProgress
        ? 'This integration is modifying your Savira project:'
        : installDone || installed || uninstallError
          ? 'This integration has modified your Savira project:'
          : ''
  ...
  const scheduleLine = isInstalledWithUpgrade
    ? 'Upgrades automatic Stripe data syncs using Savira Queues'
    : uninstallDone || installError
      ? 'Schedules automatic Stripe data syncs using Savira Queues'
      : installInProgress
        ? isUpgrade
          ? 'Upgrading automatic Stripe data syncs using Savira Queues'
          : 'Scheduling automatic Stripe data syncs using Savira Queues'
        : installDone || installed || uninstallError
          ? 'Scheduled automatic Stripe data syncs using Savira Queues'
          : uninstallInProgress
            ? 'Unscheduling automatic Stripe data syncs using Savira Queues'
            : ''
