                        ...
                        description={
                          <>
                            <p className="max-w-2xl">
                              ...
                              manage your queues via any Savira client library or PostgREST
                              endpoints:
                            </p>
                            <p className="mt-2">
                            ...
                            {!IS_PLATFORM ? (
                              <div className="mt-6 max-w-2xl">
                                When running Savira locally with the CLI or self-hosting using
                      ...
                      {formState.dirtyFields.enable && field.value === true && (
                        <Admonition type="warning" className="mt-2">
                          ...
                          <p className="text-foreground-light">
                            ...
                            enabling. Call these functions via any Savira client library or
