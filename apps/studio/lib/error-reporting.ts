...
const WHITELIST_ERRORS = [
  ...
  'Project creation in the Savira dashboard is disabled for this Vercel-managed organization.',
  'Your account, which is handled by the Fly Savira extension, cannot access this endpoint.',
