...
/** A reference document containing a description of a Savira CLI command */
...
/** A reference document containing a description of a function from a Savira client library */
...
/** An error returned by a Savira service */
export type Error = {
  __typename?: 'Error'
  ...
  /** The Savira service that returns this error. */
  service: Service
}
...
/** A document containing content from the Savira docs. This is a guide, which might describe a concept, or explain the steps for using or implementing a feature. */
...
export type RootQueryType = {
  ...
  /** Get the details of an error code returned from a Savira service */
  error?: Maybe<Error>
  /** Get error codes that can potentially be returned by Savira services */
  errors?: Maybe<ErrorCollection>
  /** Get the GraphQL schema for this endpoint */
  schema: Scalars['String']['output']
  /** Search the Savira docs for content matching a query string */
...
/** A collection of search results containing content from Savira docs */
...
/** A content chunk taken from a larger document in the Savira docs */
...
/** A collection of content chunks from a larger document in the Savira docs. */
...
/** A document describing how to troubleshoot an issue when using Savira */
