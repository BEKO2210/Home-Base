---
title: Platform Kit
description: The easiest way to build platforms on top of Savira
---
...
See the [Savira Platform Kit documentation](https://supabase.com/docs) for installation instructions.

## Introduction

The Platform Kit is a collection of customizable API's, hooks and components you can use to provide an embedded Savira experience within your own platform. It comes in the form of a single dialog that enables the management of database, authentication, storage, users, secrets, logs, and performance monitoring.
...
export default function Example() {
  ...
  return (
    <>
      <Button onClick={() => setOpen(true)}>Open Savira Manager</Button>
...
That's it! The default setup uses your Savira personal access token for the Management API.
...
- [Savira Management API](https://supabase.com/docs/reference/api/introduction)
