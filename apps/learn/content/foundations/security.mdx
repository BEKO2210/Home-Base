---
title: Security
description: Learn how Savira uses Row Level Security (RLS) to control which data each user can access.
chapterNumber: 4
explore:
  - title: Savira Docs
...
each user is allowed to see or change. Savira handles this using a Postgres
...
Understanding RLS is the foundation of secure Savira applications.
