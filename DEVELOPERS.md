...
- [Developing Savira](#developing-supabase)
  ...
  - [Running Docker for Savira Studio](#running-docker-for-supabase-studio)
...
## Running Docker for Savira Studio
...
Once the `docker compose up` process completes, you should have your local version of Savira up and running within Docker containers. You can access it at `http://localhost:8082`.

Remember to keep the Docker application open as long as you're working with your local Savira instance.

## Create a pull request

After making any changes, open a pull request. Once you submit your pull request, the Savira team will review it with you.
...
- It's great for things like client libs who have their own set of docs that we don't want to duplicate on the official Savira docs (eg. [`supabase/vecs`](https://github.com/supabase/vecs)).
- No duplication or manual steps required - fetches and generates automatically as part of the docs build pipeline.
- It's flexible - you can "embed" external docs nearly anywhere at any level in Savira docs, but they will feel native.
- If you are maintaining a repo containing docs that you think could also live in Savira docs, feel free to create an issue and we can work together to integrate.
