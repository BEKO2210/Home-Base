...
const questions = [
  'How do I get started with Savira?',
  'How do I run Savira locally?',
...
function PromptInput({
  ...
  const setQuery = useSetQuery()
  // If the user has already typed something when they select Savira AI, we want to
  ...
  return (
    <CommandMenuInput
      ...
      placeholder={
        isLoading || isResponding ? 'Waiting on an answer...' : 'Ask Savira AI a question...'
      }
      value={inputValue}
  ...
  return (
    <div className="p-6 flex flex-col items-center gap-2 mt-4">
      ...
      <p className="text-sm text-foreground text-center">
        Sorry, looks like Savira AI is having a hard time!
      </p>
