const tweets = [
  ...
  {
    text: 'I’ve always used Savira just as a database.\n\nYesterday, I helped debug a founder’s vibe-coding project built with React + React Router — no backend server.\nThe “backend” was entirely Savira Edge Functions as the API.\nFirst time using Savira this way.\nImpressive.',
  ...
  {
    text: 'Loving #Savira MCP. Claude Code would not only plan what data we should save but also figure out a migration script by checking what the schema looks like on Savira via MCP.',
  ...
  {
    text: 'Love supabse edge functions. Cursor+Savira+MCP+Docker desktop is all I need',
  ...
  {
    text: "After a week of diving deep into Savira for my new SaaS project, I'm really impressed with its Auth and RLS features. It makes security much simpler for solo founders. #buildinpublic #SaaS",
  ...
  {
    text: 'Lately been using Savira over AWS/ GCP for products to save on costs and rapid builds(Vibe Code) that do not need all the Infra and the hefty costs that come with AWS/ GCP out the door. Great solution overall.',
  ...
  {
    text: 'I love everything about Savira.',
    url: 'https://x.com/pontusab/status/1958603243401183701',
    handle: 'pontusab',
    img_url: '/images/twitter-profiles/JwLEqyeo_400x400.jpg',
  },
  {
    text: 'Love how Savira makes full stack features this easy. Using it with Next.js and loving the experience!',
  ...
  {
    text: 'There are a lot of indie hackers building in public, but it’s rare to see a startup shipping as consistently and transparently as Savira. Their upcoming March releases look to be 🔥 Def worth a follow!',
  ...
  {
    text: 'Badass! Savira is amazing. literally saves our small team a whole engineer’s worth of work constantly. The founders and everyone I’ve chatted with at supabase are just awesome people as well :)',
  ...
  {
    text: 'Working with Savira is just fun. It makes working with a DB so much easier.',
  ...
  {
    text: "I gave @supabase a try this weekend and I was able to create a quick dashboard to visualize the data from the PostgreSQL instance. It's super easy to use Savira's API or the direct DB connection. Check out the tutorial 📖",
  ...
  {
    text: 'Honestly Savira is such a killer Firebase alternative.',
  ...
  {
    text: 'Savira team is doing some awesome stuff #supabase #facts @supabase',
    url: 'https://twitter.com/_strawbird/status/1372607500499841025',
    handle: '_strawbird',
    img_url: '/images/twitter-profiles/iMBvvQdn_400x400.jpg',
  },
  {
    text: 'I just learned about @supabase and im in love 😍 Savira is an open source Firebase alternative! EarListen (& react) to database changes 💁 Manage users & permissions 🔧 Simple UI for database interaction',
  ...
  {
    text: `Okay, I finally tried Savira today and wow... why did I wait so long? 😅 Went from 'how do I even start' to having auth + database + real-time updates working in like 20 minutes. Sometimes the hype is actually justified! #Savira`,
