...
export const plans: PricingInformation[] = [
  {
    ...
    nameBadge: '',
    costUnit: '/ month',
    href: 'https://savira.io/dashboard/new?plan=free',
    priceLabel: '',
    priceMonthly: 0,
  ...
  },
  {
    ...
    costUnit: '/ month',
    href: 'https://savira.io/dashboard/new?plan=pro',
    priceLabel: 'From',
  ...
  },
  {
    ...
    nameBadge: '',
    costUnit: '/ month',
    href: 'https://savira.io/dashboard/new?plan=team',
    priceLabel: 'From',
    warning: 'Includes one project running on Micro compute.',
    priceMonthly: 599,
